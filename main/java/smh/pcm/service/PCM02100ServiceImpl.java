...
/**
 * @file: PCM02100ServiceImpl.java
* @Package: smh.bas.service
 * @Project name: IFC MES시스템 구축
 * @Type name: PCM02100ServiceImpl
 * @Company: Built1
 ...
 *
 *       수정일 수정자 수정내용 ------------ ------ ---------- 2021. 3. 30. 이용국 최초 생성
 */
@Service
public class PCM02100ServiceImpl extends AbstractNbdfService implements PCM02100Service {

	public static final String NAMESAPCE = "smh.pcm.dao.PCM02100Dao";
	 ...
	 * @brief : 입고검사 / 자주검사 리스트
	 * @remark
* @see smh.pcm.service.PCM02100Service#getLotProductTypePathType(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	public void getUomDefinitionList(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".getUomDefinitionList", param));
	}
...
* @see smh.pcm.service.PCM02100Service#getLotProductTypePathType(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void getLotProductTypePathType(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".getLotProductTypePathType", param));
	}
...
* @see smh.pcm.service.PCM02100Service#getLotProductTypePathType(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void getAreaList(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".getAreaList", param));
	}
	 ...
	 * @brief : 입고검사 / 자주검사 리스트
	 * @remark
* @see smh.pcm.service.PCM02100Service#getTransitAreaList(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	public void getTransitAreaList(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".getTransitAreaList", param));
	}
	 ...
	 * @brief : 
	 * @remark
* @see smh.pcm.service.PCM02100Service#selectAreaResourceByLot(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	public void selectAreaResourceByLot(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectAreaResourceByLot", param));
	}
...
* @see smh.pcm.service.PCM02100Service#selectAreaResourceByLot(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void selectEquipmentByArea(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectEquipmentByArea", param));
	}
...
* @see smh.pcm.service.PCM02100Service#selectAreaResourceByLot(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void selectLotHistoryMessage(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectLotHistoryMessage", param));
	}
...
* @see smh.pcm.service.PCM02100Service#selectAreaResourceByLot(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void getDefectCodeByProcess(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".getDefectCodeByProcess", param));
	}
	 ...
	 * @brief : NCR 리스트
	 * @remark
* @see smh.pcm.service.PCM02100Service#SelectNcrStandardOfSelfInspection(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	 ...
	 * @brief : 불량 팝업 리스트
	 * @remark
* @see smh.pcm.service.PCM02100Service#SelectDefectCodeByProcess(com.nbdf.commons.ui.vo.UiMapDto)
	 */
...
* @see smh.pcm.service.PCM02100Service#SelectDefectCodeByProcess(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void selectProcessDefTypeByProcess(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectProcessDefTypeByProcess", param));
	}
...
* @see smh.pcm.service.PCM02100Service#SelectDefectCodeByProcess(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void getEquipmentState(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".getEquipmentState", param));
	}
	 ...
	 * @brief : 
	 * @remark
* @see smh.pcm.service.PCM02100Service#selectLotMessage(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	public void selectLotMessage(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectLotMessage", param));
	}
	 ...
	 * @brief : 
	 * @remark
* @see smh.pcm.service.PCM02100Service#getLotMessageList(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	public void getLotMessageList(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".getLotMessageList", param));
	}
...
* @see smh.pcm.service.PCM02100Service#getLotMessageList(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void getReasonConsumableList(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".getReasonConsumableList", param));
	}
...
//		Map<String, Object> param = getParametersMap(dto);
//		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectLotInfoByProcess", param));
//	}
	...
	public void selectLotInfoByProcess(UiMapDto dto) throws Exception {
		...
		//공정별 라우팅정보 
		List<Map<String, Object>> list = generalDao.addSelect(NAMESAPCE + ".selectProcessDefTypeByProcess", param);
		if(list.size()>0) {
		...
		//공정별 LOT정보
		List<Map<String, Object>> lotInfo = generalDao.addSelect(NAMESAPCE + ".selectLotInfoByProcess", param);
		putDataSetMap(dto, lotInfo, "ds_lotInfo");		
		//processDefType 조회(Main,Rework,Sample)==> 출하검사이동, 계측검사에 이용
...
//			putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".getTransitAreaList", param), "ds_transitArea");
			
			//후공정 설비재공
//			param.put("PROCESSSEGMENTVERSION", lotInfo.get(0).get("PROCESSSEGMENTVERSION"));
			putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectPostProcessEquipmentWipByArea", param), "ds_postProcessEquipmentWipInfo");

			param.put("PROCESSSEGMENTID", lotInfo.get(0).get("PROCESSSEGMENTID"));
			param.put("PROCESSSEGMENTVERSION", lotInfo.get(0).get("PROCESSSEGMENTVERSION"));
			//자재정보
			putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectConsumableListByProcessWorkComplete", param), "ds_consumableList");

			//특기사항
//			param.put("PROCESSSEGMENTID", lotInfo.get(0).get("PROCESSSEGMENTID"));
//			param.put("PROCESSSEGMENTID", lotInfo.get(0).get("PROCESSSEGMENTID"));
			param.put("VERSION", queryVersion);
			putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectCommentByProcess", param), "ds_comment");
			
			//공정SPEC
			param.put("CONTROLTYPE", "XBARR");
			param.put("SPECCLASSID", "OperationSpec");
			putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectProcessSpecByProcess", param), "ds_processSpec");
...
//			param.put("PROCESSSEGMENTID", lotInfo.get(0).get("PROCESSSEGMENTID"));
//			param.put("PROCESSSEGMENTVERSION", lotInfo.get(0).get("PROCESSSEGMENTVERSION"));
			putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectLotHistoryMessage", param), "ds_message");
			
			if("AOIInspection".equals(lotInfo.get(0).get("PROCESSSEGMENTTYPE"))) {
				
				param.put("LOTID", lotInfo.get(0).get("LOTID"));
				param.put("ISREWORK", "Y");
//				param.put("PROCESSSEGMENTID", lotInfo.get(0).get("PROCESSSEGMENTID"));
//				param.put("PROCESSSEGMENTVERSION", lotInfo.get(0).get("PROCESSSEGMENTVERSION"));
				putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectDefectMapDataForSend", param), "ds_defectList");
			}
		}
...
* @see smh.pcm.service.PCM02100Service#SelectDefectCodeByProcess(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void selectCodeList(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectCodeList", param));
	}
...
* @see smh.pcm.service.PCM02100Service#SelectDefectCodeByProcess(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void selectCheckStaying(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectCheckStaying", param));
	}
...
* @see smh.pcm.service.PCM02100Service#SelectDefectCodeByProcess(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void getReasonCodeByProcess(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".getReasonCodeByProcess", param));
	}
...
* @see smh.pcm.service.PCM02100Service#SelectDefectCodeByProcess(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void selectPlantIsWipSurvey(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectPlantIsWipSurvey", param));
	}
...
* @see smh.pcm.service.PCM02100Service#SelectDefectCodeByProcess(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void selectProcessSpecByProcess(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectProcessSpecByProcess", param));
	}
...
* @see smh.pcm.service.PCM02100Service#SelectDefectCodeByProcess(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void selectLotCancelWorkResultByRollCutting(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectLotCancelWorkResultByRollCutting", param));
	}
...
* @see smh.pcm.service.PCM02100Service#SelectDefectCodeByProcess(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void selectDefectMapDataForSend(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectDefectMapDataForSend", param));
	}
...
* @see smh.pcm.service.PCM02100Service#SelectDefectCodeByProcess(com.nbdf.commons.ui.vo.UiMapDto)
	...
	public void selectPostProcessEquipmentWipByArea(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectPostProcessEquipmentWipByArea", param));
	}
	 ...
	 * @brief : 
	 * @remark
* @see smh.pcm.service.PCM02100Service#getCodeList(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	public void getCodeList(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".getCodeList", param));
	}
	 ...
	 * @brief : 
	 * @remark
* @see smh.pcm.service.PCM02100Service#selectConsumableListByProcessWorkComplete(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	public void selectConsumableListByProcessWorkComplete(UiMapDto dto) throws Exception {
		Map<String, Object> param = getParametersMap(dto);
		putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectConsumableListByProcessWorkComplete", param));
	}
	 ...
	 * @brief : 
	 * @remark : 
* @see smh.pcm.service.PCM02100Service#abnormalOccurenceByDelayLot(com.nbdf.commons.ui.vo.UiMapDto)
	 */
...
* @see smh.pcm.service.PCM02100Service#saveLotIncommingInspection(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	 ...
	 * @remark :
* @see smh.pcm.service.PCM02100Service#getInspectionResultUpdateData(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	private int getInspectionResultUpdateData(Map<String, Object> paramLotList, String inspectionResult,
		...
		insResultMap.put("TXNID", "PCM02100Service");
	 ...
	 * @remark :
* @see smh.pcm.service.PCM02100Service#getInspectionWokerUpdateData(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	 ...
	 * @remark :
* @see smh.pcm.service.PCM02100Service#getInspectionDefectUpateData(com.nbdf.commons.ui.vo.UiMapDto)
	 */
	private int getInspectionDefectUpateData(UiMapDto dto, Map<String, Object> paramInspection, Map<String, Object> lot,
		...
		defectMap.put("TXNID", "PCM02100Service");
	...
	public Boolean selectLotInfoByProcess(String enterpriseId,String plantId,String areaId, String lotId) throws Exception {
		...
		List<Map<String, Object>> processDefList = generalDao.addSelect(NAMESAPCE + ".selectProcessDefTypeByProcess", param);
		
		param.put("VERSION", "10031");
	    if(processDefList.size() > 0) {
	    	String processDefType = (String)processDefList.get(0).get("PROCESSDEFTYPE");
	    	if("Rework".equals(processDefType)) {
	    		param.put("VERSION", "10032");
	    	}
	    }	
		List<Map<String, Object>> lotInfoList = generalDao.addSelect(NAMESAPCE + ".selectLotInfoByProcess", param);

	    if(lotInfoList.size() > 0) {
//	    	String OSPINSPRESULT = (String)lotInfoList.get(0).get("OSPINSPRESULT");
	    	String OSPINSPYN = (String)lotInfoList.get(0).get("OSPINSPYN");
	    	if("Y".equals(OSPINSPYN)) {
	    		bRtn = true;
	    	} 
	    }	
		return bRtn; 
