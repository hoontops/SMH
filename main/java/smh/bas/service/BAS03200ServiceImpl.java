...
*/
@Service
public class BAS03200ServiceImpl extends AbstractNbdfService implements BAS03200Service {

    public static final String NAMESAPCE = "smh.bas.dao.BAS03200Dao";
    @Autowired
     ...
     * @remark 
     * @see smh.bas.service.BAS03200Service#selectRoutionRollLossList(com.nbdf.commons.ui.vo.UiMapDto)
     */
    ...
    public void selectRoutingQTimeProcPopup(UiMapDto dto) throws Exception {
        Map<String, Object> param = getParametersMap(dto);
        putDataSetMap(dto, generalDao.addSelect(NAMESAPCE + ".selectRoutingQTimeProcPopup", param));
    }
    ...
    public void saveRoutingWtime(UiMapDto dto) throws Exception {
        ...
        for (int i = 0, len = paramMapWTime.size(); i < len; i++) 
		{
			...
			case DataSet.ROW_TYPE_UPDATED:
				...
				paramWTime.put("PRODUCTDEFID", paramDef.get("PRODUCTDEFID"));
				paramWTime.put("PRODUCTDEFVERSION", paramDef.get("PRODUCTDEFVERSION"));
...
//				}
			case DataSet.ROW_TYPE_UPDATED:
				...
				paramAction.put("PRODUCTDEFID", paramDef.get("PRODUCTDEFID"));
				paramAction.put("PRODUCTDEFVERSION", paramDef.get("PRODUCTDEFVERSION"));
