...
import smh.mfm.service.MFM00501Service;
 ...
 */
@Controller
@RequestMapping(value = "/mfm00501")
public class MFM00501Controller extends AbstractWebController {

    @Autowired
    private MFM00501Service service;
