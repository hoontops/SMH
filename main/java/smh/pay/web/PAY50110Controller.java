...
import smh.pay.service.PAY50110Service;
...
*/
@Controller
@RequestMapping(value = "/pay50110/")
public class PAY50110Controller extends AbstractWebController {

    @Autowired
    private PAY50110Service service;
    /**
    ...
    */
    ...
    public View selectPayList(UiMapDto dto, Model model) throws Exception {
        service.selectPayList(dto);
