...
@Service
public class PAY50210ServiceImpl extends AbstractNbdfService implements PAY50210Service {

    public static final String NAMESPACE = "smh.pay.dao.PAY50210Dao";
    ...
    */
    public void salaryList(UiMapDto dto) {
        Map<String, Object> param = getParametersMap(dto);
        List<Map<String, Object>> list = generalDao.addSelect(NAMESPACE + ".salaryList",param);
