...
@Service
public class PAY50110ServiceImpl extends AbstractNbdfService implements PAY50110Service {

    public static final String NAMESPACE = "smh.pay.dao.PAY50110Dao";
    ...
    */
    public void selectPayList(UiMapDto dto) {
        Map<String, Object> param = getParametersMap(dto);
        List<Map<String, Object>> list = generalDao.addSelect(NAMESPACE + ".selectPayList",param);
