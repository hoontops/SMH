...
@Controller
@RequestMapping(value = "/pemm00040/")
public class PEMM00040Controller extends AbstractWebController {
    ...
    * @throws : Exception
     */
    @RequestMapping(value = "selectPemm00040List.scr", method = RequestMethod.GET )
    public String selectPopMemoList(HttpServletRequest request, Model model) throws Exception {
        ...
        return  DEFAULT_VIEW_FOLDER + "PEMM00040M";
    }

    /**
    *
   * @fn : selectPemm00040List
   * @brief : 함수 간략한 설명
   * @Method Name : selectPostSearch
   * @Create Date: 2015 2015. 7. 9. 오후 11:05:23
   * @Author: JinSungHa
   ...
   * @throws : Exception
    */
   @RequestMapping(value = "selectPemm00040List.scr", method = RequestMethod.POST )
   public String selectPopMemoListPost(HttpServletRequest request, Model model) throws Exception {
       ...
       return  DEFAULT_VIEW_FOLDER + "PEMM00040T";
   }

    /**
    *
   * @fn : selectPemm00050List
   * @brief : 함수 간략한 설명
   * @Method Name : selectPemm00050List
   * @Create Date: 2015 2015. 7. 9. 오후 11:05:23
   * @Author: JinSungHa
   * @param: XXXXXXXX
   * @return: XXXXX
   * @throws : Exception
    */
   @RequestMapping(value = "selectPemm00050List.scr", method = RequestMethod.GET )
   public String selectPemm00050List() throws Exception {
       return  DEFAULT_VIEW_FOLDER + "PEMM00050M";
   }

   /**
   *
  * @fn : selectPemm00060List
  * @brief : 함수 간략한 설명
  * @Method Name : selectPemm00060List
  * @Create Date: 2015 2015. 7. 9. 오후 11:05:23
  * @Author: JinSungHa
  * @param: XXXXXXXX
  * @return: XXXXX
  * @throws : Exception
   */
  @RequestMapping(value = "selectPemm00060List.scr", method = RequestMethod.GET )
  public String selectPemm00060List(HttpServletRequest request, Model model) throws Exception {
      Map<String, Object> dto = new HashMap<String, Object>();
      ...
      return  DEFAULT_VIEW_FOLDER + "PEMM00060M";
  }
 ...
 * @throws : Exception
  */
 @ResponseBody
 @RequestMapping(value = "deleteMemo.scr", method = RequestMethod.POST )
