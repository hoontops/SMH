...
import com.nbdf.cmd.cm.pesp.service.PESP01100Service;
...
/**
* @file: pesp01100Controller.java
* @Package: com.nbdf.cmd.cm.pesp.web
* @Project name: IFC MES시스템 구축
* @Type name: pesp01100Controller
* @Company: Built1
...
*/
@Controller
@RequestMapping(value = "/pesp01100")
public class PESP01100Controller extends AbstractWebController {
//
    @Autowired
    private PESP01100Service service;
