...
/**
* @file: CMSY03000ServiceImpl.java
* @Package: com.nbdf.cmd.cm.cmsy.service
* @Project name: IFC MES시스템 구축
* @Type name: CMSY03000ServiceImpl
* @Company: Built1
...
@Service
public class CMSY03000ServiceImpl extends AbstractNbdfService implements CMSY03000Service {

    public static final String NAMESPACE = "com.nbdf.cmd.cm.cmsy.dao.CMSY03000Dao";
