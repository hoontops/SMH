...
/**
* @file: CMCM01100ServiceImpl.java
* @Package: com.nbdf.cmd.cm.cmcm.service
* @Project name: IFC MES시스템 구축
* @Type name: CMCM01100ServiceImpl
* @Company: Built1
...
*/
@Service
public class CMCM01100ServiceImpl extends AbstractNbdfService implements CMCM01100Service {

    public static final String NAMESAPCE = "com.nbdf.cmd.cm.cmcm.dao.CMCM01100Dao";
     ...
     * @see com.nbdf.cmd.cm.cmcm.service.CMCM01100Service#selectGrpCd(com.nbdf.commons.ui.vo.UiMapDto)
     */
     ...
     * @remark - 상세 코드 조회
     * @see com.nbdf.cmd.cm.cmcm.service.CMCM01100Service#selectCodeSearch(com.nbdf.commons.ui.vo.UiMapDto)
     */
    ...
    public strictfp void selectCdListExcel(UiMapDto dto) throws Exception {
        Map<String, Object> param = getParametersMap(dto);
        ...
        for(int idx = 0; idx < loopCount; idx++) {
            ...
            param.put("P_END", endIndex);
                ...
                list00 = generalDao.addSelect(NAMESAPCE + ".selectCdList", param);
     ...
     * @see com.nbdf.cmd.cm.cmcm.service.CMCM01100Service#selectAll(com.nbdf.commons.ui.vo.UiMapDto)
     */
     ...
     * @see com.nbdf.cmd.cm.cmcm.service.CMCM01100Service#saveGroupCode(com.nbdf.commons.ui.vo.UiMapDto)
     */
    @Override
     ...
     * @see com.nbdf.cmd.cm.cmcm.service.CMCM01100Service#saveGridCode(com.nbdf.commons.ui.vo.UiMapDto)
     */
     ...
     * @see com.nbdf.cmd.cm.cmcm.service.CMCM01100Service#selectCmCode(com.nbdf.commons.ui.vo.UiMapDto)
     */
     ...
     * @remark - 엑셀 다운로드
     * @see com.nbdf.cmd.cm.cmcm.service.CMCM01100Service#selectExcelDn(com.nbdf.commons.ui.vo.UiMapDto)
     */
    @Override
