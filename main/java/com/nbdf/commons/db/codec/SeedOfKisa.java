...
//		KC0 = golden ratio; KCi = ROTL(KCi-1, 1) 	
	...
	// User secret key 운영 Key
	  //private static byte pbUserKey[]  = {(byte)0x26, (byte)0x3A, (byte)0xA5, (byte)0xA8, 
	  //                 (byte)0x08, (byte)0xBE, (byte)0x8B, (byte)0x2C,
	  //                  (byte)0x96, (byte)0xB5, (byte)0xE1, (byte)0xC5, 
	  //                 (byte)0xC9, (byte)0xA1, (byte)0x9F, (byte)0xFB};

	//개발 Key	
	private static byte pbUserKey[]  = {(byte)0x01, (byte)0x23, (byte)0x45, (byte)0x67, 
        (byte)0x89, (byte)0xAB, (byte)0xCD, (byte)0xEF,
        (byte)0xFE, (byte)0xDC, (byte)0xBA, (byte)0x98, 
        (byte)0x76, (byte)0x54, (byte)0x32, (byte)0x10};  
	/* 테스트 USERKEY
	private static byte pbUserKey[]  = {(byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, 
        (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00,
        (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, 
        (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00};  
	private static byte pbUserKey[]  = {(byte)0x47, (byte)0x06, (byte)0x48, (byte)0x08, (byte)0x51, (byte)0xE6, (byte)0x1B, (byte)0xE8,
        (byte)0x5D, (byte)0x74, (byte)0xBF, (byte)0xB3, (byte)0xFD, (byte)0x95, (byte)0x61, (byte)0x85};
	private static byte pbUserKey[]  = {(byte)0x00, (byte)0x01, (byte)0x02, (byte)0x03, (byte)0x04, (byte)0x05, (byte)0x06, (byte)0x07,
        (byte)0x08, (byte)0x09, (byte)0x0A, (byte)0x0B, (byte)0x0C, (byte)0x0D, (byte)0x0E, (byte)0x0F};
	
	*/
	/*
	private static byte pbUserKey[]  = {(byte)0x26, (byte)0x3A, (byte)0xA5, (byte)0xA8, (byte)0x08, (byte)0xBE, (byte)0x8B, (byte)0x2C,
        (byte)0x96, (byte)0xB5, (byte)0xE1, (byte)0xC5, (byte)0xC9, (byte)0xA1, (byte)0x9F, (byte)0xFB}; 
    */    
/**************************** Defining Endianness *****************************/
...
// reorder for little endian	  
	...
	public static String encryptAsString(String str) {
		return getString2(getEncrypt(stringToBytesASCII(str)));
	}
	public static byte[] getEncrypt(byte pbData[]){
		
		String rtn = "";

		byte pbCipher[]   = new byte[16];
		SeedRoundKey(pdwRoundKey, pbUserKey);		
		SeedEncrypt(padding(pbData), pdwRoundKey, pbCipher);
		
		for (int i=0; i<16; i++){
			//System.out.print(Integer.toHexString(0xff&pbCipher[i])+" ");
			//System.out.print("\n\n");
			
			rtn += Integer.toHexString(0xff&pbCipher[i]);
		}
		//System.out.println("getEncrypt-->"+rtn.toUpperCase().replaceAll(",", "")+"\n");	
		return pbCipher;
	}
	...
	public static String decryptAsString(String str) {
		return getDecrypt(getBytes(getComma32(str)));
	}
	
	public static String getDecrypt(byte pbCipher[]){
		String rtn = "";
		...
		for (int i=0; i<16; i++){
			rtn += convertHexToString(Integer.toHexString(0xff&pbPlain[i]));
		}
		//System.out.print("Key\t\t: ");
		//  for (int i=0; i<16; i++)	System.out.print(Integer.toHexString(0xff&pbPlain[i])+" ");
	
		//System.out.print("getDecrypt-->"+rtn+"\n");
		//return pbPlain;			
		return rtn ;
	}
	...
	public static String getString2(byte[] data) {
		String result = getString(data).replace(",","");
		return result;
	}
	...
	public static String getComma16(String data) {
		String result = "";
		int idx = 0;
		int len = 0;
		for(int i=0; i<data.length(); i++) {
			idx = i;
			len = i + 1;
			result = result + data.substring(idx, len);
			if(i<data.length()-1)
				result = result + ",";
		}
	...
	public static String getComma32(String data) {
		String result  = "";
		int idx = 0;
		int len = 0;
...
//kcv 08D7B4
	...
	{
		String ss = encryptAsString("6060453287248004");	//암호화
		System.out.println("ss-->"+ss);
		// Round keys for encryption or decryption
				int pdwRoundKey[] = new int[32];
		// input plaintext to be encrypted
				byte pbData[]     = {(byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00,
				                     (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00};
				byte pbCipher[]   = new byte[16];
				byte pbPlain[]    = new byte[16];
				//byte s0[] = getEncrypt(pbData);
							
				System.out.print("[ Test SEED reference code ]"+"\n");
				System.out.print("\n\n");
				//pbData = getBytes("000102030405060708090A0B0C0D0E0F");
				System.out.println(Arrays.toString(pbData));
		...
		// Encryption		
			  ...
			  String s = "221680440C0A933F57EA4DCEFD018CCD";
			  
		s = decryptAsString(s);	//복호화
		System.out.println("\ns-->"+s);
	}
}