...
//	arg_year = yymm.substring(0, 4);
 ...
 sb.append("<dataset seriesName='" + String.valueOf(Long.parseLong(yymm1)-2) + "년' color='8BBA00'>");
  ...
  for(int i=0; i<jsonArray.size(); i++){
		...
		sb.append("<set value='" + String.valueOf(Long.parseLong(strPlanMonth)/1000) + "' toolText = '" + String.valueOf(Long.parseLong(yymm)-2) + "년 {br}" + String.format("%,d", Long.parseLong(strPlanMonth)/1000) + " 천원' link='javascript:Search2(&quot;" + strYM + "&quot;)' />");
	} 
 
 sb.append("</dataset>");
 
 sb.append("<dataset seriesName='" + String.valueOf(Long.parseLong(yymm1)-1) + "년' >");
 ...
 for(int i=0; i<jsonArray.size(); i++){
		...
		sb.append("<set value='" + String.valueOf(Long.parseLong(strPlanMonth)/1000) + "' toolText = '" + String.valueOf(Long.parseLong(yymm)-1) + "년 {br}" + String.format("%,d", Long.parseLong(strPlanMonth)/1000) + " 천원' link='javascript:Search2(&quot;" + strYM + "&quot;)' />");
	} 

sb.append("</dataset>");

sb.append("<dataset seriesName='" + String.valueOf(Long.parseLong(yymm1)) + "년' color='0358B5' >");
...
for(int i=0; i<jsonArray.size(); i++){
		...
		sb.append("<set value='" + String.valueOf(Long.parseLong(strPlanMonth)/1000) + "' toolText = '" + String.valueOf(Long.parseLong(yymm)) + "년 {br}" + String.format("%,d", Long.parseLong(strPlanMonth)/1000) + " 천원' link='javascript:Search2(&quot;" + strYM + "&quot;)' />");
	} 
...
<script src="./js/FusionCharts.js"></script>
 ...
 <script type="text/javascript">
	 <!--
	var chart1 = new FusionCharts("MSColumn3D.swf","Business", "950", "230");
