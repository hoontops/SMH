(function()
{
    return function()
    {
        ...
        {
            this.set_name("BAS01800P1");
            this.set_titletext("마스터품목 복사");
            ...
            obj = new Edit("edtItemTo","119","34",null,"20","btnItemFr:0",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_cssclass("point");
            obj.set_text("10400009A1");
            this.divSearch.addChild(obj.name, obj);

            obj = new Button("btnItemTo",null,"34","22","20","417",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_cssclass("btn_WF_finder");
            obj.set_text("");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("BAS01800P1.xfdl","lib::lib_bas.xjs");
        this.registerScript("BAS01800P1.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 마스터품목 복사
         * 파일명 		: BAS01800P1.xfdl
        ...
        {
        	//복사전 검증함수 호출결과
        	if(trId == "copyValidationBasItemMaster"){
        		if (errCD < 0) {
        			//Custom Message를 위한 Replace
        			errMsg = errMsg.replace("ERR:","");
        			if (errMsg=="RoutingCopy"){ //이미 존재인 경우 한번 더 확인
        				var bOK = this.gfn_Message(errMsg, null, "conf", "yesno");
        				if (bOK) {
        					this.fn_copy();
        				}
        			} else {
        ...
        this.fn_openPop = function(svcId, popId)
        {
        	...
        	if(svcId == "ITEM_FR")
        	{
        		oArg.arg_searchStr = "SEARCH_KEY="+this.nfn_nvl(this.searchDiv.edtItemFr.value, "");
        	} else if(svcId == "ITEM_TO"){
        		oArg.arg_searchStr = "SEARCH_KEY="+this.nfn_nvl(this.searchDiv.edtItemTo.value, "");
        	}
        ...
        this.btnConfirm_onclick = function(obj,e)
        {
        	...
        	// ':N' 은 현재 Delete를 제외한 데이터를 Normal 상태로 보냅니다. 지정하지 않는 데이터세트는 Normal로 동작합니다
        	// -------------------------
        	var sSvcID 			= "copyValidationBasItemMaster";
        	var sController 	= "/bas01800/copyValidationBasItemMaster.do";
        	var sInDatasets 	= "INPUT=ds_copy:A";
        	var sOutDatasets 	= "";
        	var sArgs 			= "";
        	this.gfn_transaction(sSvcID, sController, sInDatasets, sOutDatasets, sArgs);
        ...
        {
        	this.fn_openPop("ITEM_FR","P00085"); //품목 조회
        };

        this.divSearch_btnItemTo_onclick = function(obj,e)
        {
        	this.fn_openPop("ITEM_TO","P00085"); //품목 조회
        };
        ...
        this.divSearch_edtItemTo_onkeydown = function(obj,e)
        {
        	if(e.keycode==13){
        		this.divSearch_btnItemTo_onclick();
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.edtItemTo.addEventHandler("onkeydown",this.divSearch_edtItemTo_onkeydown,this);
            this.divSearch.form.btnItemTo.addEventHandler("onclick",this.divSearch_btnItemTo_onclick,this);
            this.btn_close.addEventHandler("onclick",this.btn_close_onclick,this);
        };
        this.loadIncludeScript("BAS01800P1.xfdl");
