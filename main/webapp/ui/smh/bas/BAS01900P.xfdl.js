(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("BAS01900P.xfdl","lib::lib_bas.xjs");
        this.registerScript("BAS01900P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 품목선택
         * 파일명 		: BAS01900P.xfdl
        ...
        this.loadIncludeScript("BAS01900P.xfdl");
