(function()
{
    return function()
    {
        ...
        {
            this.set_name("BAS05100P");
            this.set_titletext("설비/설비단 관리_설비단ID 팝업");
            ...
            obj = new Dataset("ds_eqpList", this);
            obj._setContents("<ColumnInfo><Column id=\"EQUIPMENTID\" type=\"STRING\" size=\"256\"/><Column id=\"CHILDEQUIPMENTNAME\" type=\"STRING\" size=\"256\"/><Column id=\"CHK\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"CHILDEQUIPMENTIDNAME\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("ds_basEqpMainList", this);
            obj.set_useclientlayout("true");
            ...
            obj = new Static("sta_eqpId","0","10","99","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("설비단ID/명");
            obj.set_cssclass("sta_WF_label");
            obj.set_tooltiptext("CHILDEQUIPMENTIDNAME");
            ...
            obj = new Edit("edt_eqpId","98","10","200","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj.set_tooltiptext("CHILDEQUIPMENTID");
            this.addChild(obj.name, obj);

            obj = new Static("sta_cnt_ds_eqpList","sta_title:0","62","140","34",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            ...
            obj.set_binddataset("ds_eqpList");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"48\"/><Column size=\"150\"/><Column size=\"200\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"설비단 ID\" tooltiptext=\"CHILDEQUIPMENTID\"/><Cell col=\"3\" text=\"설비단 명\" tooltiptext=\"CHILDEQUIPMENTNAME\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"2\" text=\"bind:EQUIPMENTID\" textAlign=\"left\" displaytype=\"normal\" edittype=\"none\"/><Cell col=\"3\" text=\"bind:CHILDEQUIPMENTNAME\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.addIncludeScript("BAS05100P.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("BAS05100P.xfdl","lib::lib_mtm.xjs");
        this.registerScript("BAS05100P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.edt_eqpId.addEventHandler("onkeydown",this.divSearch01_edt_lotNo_onkeydown,this);
        ...
        this.loadIncludeScript("BAS05100P.xfdl");
