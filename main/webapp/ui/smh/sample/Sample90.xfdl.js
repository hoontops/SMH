(function()
{
    return function()
    {
        ...
        this.btn_Report_onclick = function (obj, e) {
        	...
        	strField = '[SELSC][2020/12][2020/12][][6623]'; // 리포트가 사용하는 파라미터. 테스트용 하드코딩.
        	var sRptName = "HJSTXR00090";  // HJSTXR00090.mrd // mrd 빼고 사용.
        	var sRptPath = "";             // mrd 파일을 mrd 경로 하위 경로에 사용한다면... 하위경로 작성.
            // 내부 div에 표현사... fn_WebBrowserCall 호출
        ...
        this.btn_popup_onclick2 = function (obj, e){
        	...
        	var sOption = "titletext=Report modal 실행 - "+sRptName+",modeless=false";
        	this.div_report.form.fn_WebBrowserCall(sRptPath, strField, sRptName);
        	//this.gfn_reportPopup("reportViewer", "common::com_report.xfdl", oArg, sOption);
        };
        ...
        {
        	var strField = '[696321]'; // 696321 리포트가 사용하는 파라미터. 테스트용 하드코딩.
        	var sRptName = "HJSPAYR05211bk";  // HJSTXR00090.mrd // mrd 빼고 사용.
        	var sRptPath = "";
        	this.div_report.form.fn_WebBrowserCall(sRptPath, strField, sRptName);
        };
        ...
        {
        	//693709
        	var strField = '[693709]'; // 리포트가 사용하는 파라미터. 테스트용 하드코딩.
        	var sRptName = "HJSPAYR05211";  // HJSTXR00090.mrd // mrd 빼고 사용.
        	var sRptPath = "";
        	this.div_report.form.fn_WebBrowserCall(sRptPath, strField, sRptName);
        };
