(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new EcoChart("ecochart","20","67",null,"637","48",null,null,null,null,null,this);
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("Sample43.xfdl", function() {
        ...
        this.loadIncludeScript("Sample43.xfdl");
