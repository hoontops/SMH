(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01","86.62%","92",null,"20","4.2%",null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("Female");
            obj.set_font("10pt \"Meiryo UI, malgun gothic\"");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","70.12%","92",null,"20","20.7%",null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_text("Male");
            obj.set_font("10pt \"Meiryo UI, malgun gothic\"");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_series2","83.11%","119",null,"586","1.27%",null,null,null,null,null,this);
            obj.set_taborder("26");
            ...
            obj = new Grid("grd_series1","65.63%","120",null,"586","18.75%",null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_binddataset("ds_scatter1");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"Income\"/><Cell col=\"1\" text=\"Expense\"/></Band><Band id=\"body\"><Cell text=\"bind:x\"/><Cell col=\"1\" text=\"bind:y\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static04","1.95%","10",null,"47","4.69%",null,null,null,null,null,this);
            obj.set_taborder("28");
            obj.set_text("ScatterPlot & Selection");
            obj.set_cssclass("WF_sta_Title");
            this.addChild(obj.name, obj);

            obj = new EcoChart("ecochart","3.52%","118",null,"586","36.33%",null,null,null,null,null,this);
            this.addChild(obj.name, obj);

            obj = new Static("st_male","74.02%","92",null,"20","19.82%",null,null,null,null,null,this);
            obj.set_taborder("30");
            obj.set_border("1px solid rgba(128,128,128,1)");
            obj.set_color("red");
            obj.set_textAlign("center");
            obj.set_verticalAlign("middle");
            obj.set_font("bold 10pt \"Meiryo UI, malgun gothic\"");
            this.addChild(obj.name, obj);

            obj = new Static("st_female","91.8%","92",null,"20","2.05%",null,null,null,null,null,this);
            obj.set_taborder("31");
            obj.set_border("1px solid rgba(128,128,128,1)");
            obj.set_color("red");
            obj.set_textAlign("center");
            ...
            obj = new Static("Static02","3.61%","84",null,"25","87.5%",null,null,null,null,null,this);
            obj.set_taborder("32");
            obj.set_text("Fixed Income");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit00","12.01%","84",null,"23","77.25%",null,null,null,null,null,this);
            obj.set_taborder("33");
            this.addChild(obj.name, obj);

            obj = new Static("Static03","24.02%","84",null,"25","70.21%",null,null,null,null,null,this);
            obj.set_taborder("34");
            obj.set_text("Expense");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit01","29.49%","84",null,"23","59.77%",null,null,null,null,null,this);
            obj.set_taborder("35");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("Sample46.xfdl", function() {

        var chart,xaxis,yaxis,selection,maleSeries;
        ...
        {
        	var series1_x,series1_y,series2_x,series2_y,row = -1,maxrow = 200,dsSeries = this.ds_scatter,dsSeries1 = this.ds_scatter1,dsSeries2 = this.ds_scatter2;
        	...
        	if (!this.chart)
        	{
        		var config = {
        			...
        			"selection" : {
        				"mode" : "xy",
        				// "zoom": true,
        				"events" : { // "onselecting": this.onselectingselection,
        ...
        this.onselectedselection = function (obj, e)
        {
        	...
        	var ranges = e.ranges,xaxis = ranges.xaxis,yaxis = ranges.yaxis,xFrom,xTo,yFrom,yTo,filters = "";
        ...
        this.loadIncludeScript("Sample46.xfdl");
