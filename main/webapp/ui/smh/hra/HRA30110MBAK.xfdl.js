(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"WRITER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"HJSHR_COUNSELING_SEQ\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
        ...
        // User Script
        this.registerScript("HRA30110M_copy0.xfdl", function() {
        ...
        this.fn_init = function (obj, e)
        {
        	...
        	this.deptCd = this.gf_getDeptCd();		//사용자 부서코드
        	this.deptNm = this.gf_getDeptNm();		//사용자 부서명
        	this.userAcnt = this.gf_getUserAcnt();	//사용자 계정(로그인ID)

        	this.personId = this.gf_getPersonId();  // 사용자계정(5자)
        ...
        {
         //this.div_work.Tabpage3.form.div_basicInfo.form.cal_today.set_value(this.svrdate);
        	...
        	var sArgs 			= "";
        	this.gfn_transaction(sSvcID, sController, sInDatasets, sOutDatasets, sArgs);
         /*  trace(this.ds_counselinginfo.saveXML("Dataset", "V"));*/
        ...
        // 	this.div_work.Tabpage3.form.div_basicInfo.form.edt_subject.set_readonly(false);
        // 	this.div_work.Tabpage3.form.div_basicInfo.form.txa_context.set_readonly(false);
        	...
        	//trace(this.ds_counselinginfo.getColumn(nRow,  "COUNSEL_TYPE"));
        };
        ...
        this.fn_cancle = function(obj,e)
        {
        	//데이터 미존재시 return
        	if (this.ds_counselinginfo.rowcount < 1) return;
        	this.gfn_Message("CancelConfirm", null, "info", "ok");



        	//alert("rowtype: " + this.ds_varificationLetterInfo.getRowType(this.ds_varificationLetterInfo.rowposition));

           if (this.ds_counselinginfo.getRowType(this.ds_counselinginfo.rowposition) == 2) //추가된행의 경우
            {

        		this.div_work.Tabpage3.form.div_basicInfo.form.edt_subject.set_value("");
        		this.div_work.Tabpage3.form.div_basicInfo.form.txa_context.set_value("");
        		this.div_work.Tabpage3.form.div_basicInfo.form.cbo_counseller.set_index(0);
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
            ...
            else
            {
        		...
        		else if(trId == "selectCounselingDetail")	//상세조회
        		{
        			...
        			var counselContext = this.ds_counselinginfo.getColumn(this.ds_counselinginfo.rowposition, "COUNSEL_CONTEXT" ); // 답변내용유무
        ...
        this.loadIncludeScript("HRA30110M_copy0.xfdl");
