(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_clear1_00",null,"79","60","20","214",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("초기화");
            obj.set_tooltiptext("초기화");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("HRA10610M0.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: SM 상선 myHR 고도화
         * 업무명 		: 증명서 신청
         * 파일명 		: HRA10610M0.xfdl
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_clear1_00.addEventHandler("onclick",this.fn_search_intit,this);
        };
        this.loadIncludeScript("HRA10610M0.xfdl");
