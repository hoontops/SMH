(function()
{
    return function()
    {
        ...
        {
            this.set_name("TOM00901M");
            this.set_titletext("치공구 이동 입고2");
            ...
            obj = new Static("guidetip04",null,"305","45","20","88",null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("14");
            obj.set_text("h20");
            obj.set_visible("false");
            obj.set_cssclass("guideTip");
            ...
            obj = new Button("btn_search","18","325","146","36",null,null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("15");
            ...
            obj = new Static("guidetip05","164","334","10","27",null,null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("16");
            obj.set_text("w\r\n10");
            obj.set_visible("false");
            obj.set_cssclass("guideTip");
            ...
            obj = new Button("btn_clear","174","325","102","36",null,null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("17");
            ...
            obj = new Static("sta_searchTitle","0","47","156","34",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("검색조건");
            ...
            obj = new Button("btn_xlDn_grd_head",null,"6","29","24","5",null,null,null,null,null,this.div_work.form.tabHistory.Tabpage2.form);
            ...
            obj = new Static("sta_cnt_ds_tab1","8","-3",null,"34","871",null,null,null,null,null,this.div_work.form.tabHistory.Tabpage2.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_usedecorate("true");
            ...
            obj = new Grid("grd_head","0","35",null,null,"2","0",null,null,null,null,this.div_work.form.tabHistory.Tabpage2.form);
            obj.set_taborder("2");
            ...
            obj.set_text("치공구 이동입고현황");
            obj.set_tooltiptext("TOOLHISTORY");
            this.div_work.form.tabHistory.addChild(obj.name, obj);

            obj = new Static("sta_cnt_ds_tab2","8","-3",null,"34","844",null,null,null,null,null,this.div_work.form.tabHistory.Tabpage1.form);
            obj.set_taborder("0");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_usedecorate("true");
            obj.set_padding("5px 0px 0px");
            ...
            obj = new Button("btn_xlDn_grd_result",null,"6","29","24","5",null,null,null,null,null,this.div_work.form.tabHistory.Tabpage1.form);
            obj.set_initvalueid("x");
            obj.set_taborder("1");
            obj.set_cssclass("btn_WF_grdExcelDown");
            obj.set_tooltiptext("GridExport");
            ...
            obj = new Grid("grd_result","0","35",null,null,"2","0",null,null,null,null,this.div_work.form.tabHistory.Tabpage1.form);
            obj.set_taborder("2");
            obj.set_autoenter("select");
            ...
            obj = new Button("btn_cancel",null,"16","47","24","btn_save:7",null,null,null,null,null,this.div_header.form);
            obj.set_taborder("9");
            obj.set_text("취소");
        ...
        // User Script
        this.addIncludeScript("TOM00901M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("TOM00901M.xfdl","lib::lib_tom.xjs");
        this.registerScript("TOM00901M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 치공구 현황 조회
         * 파일명 		: TOM01100M.xfdl
        ...
        this.fn_result_search = function (obj, e)
        {
        	...
        	this.ds_search.setColumn(0, "CURRENTLOGINID", 			this.tomfn_getUserId()); //사용자Id
        	this.ds_search.setColumn(0, "LANGUAGETYPE", 			this.gf_getLanguageType());
        	this.ds_search.setColumn(0, "SQL_ID", 					"selectMoveToolReceiptListByToolResultList");

        	var sSvcID 			= "selectMoveToolReceiptListByToolResultList";
        	var sController 	= "/tom00900/selectMoveToolReceiptListByToolResultList.do";
        	var sInDatasets 	= "INPUT=ds_search";
        ...
        {
        	this.fn_initBtnControl(e.postindex);
        };

        this.fn_initBtnControl = function (tabIndex){
        	if(tabIndex==0){
        		this.tabDiv.tabHistory.set_tabindex(0);
        		this.headerDiv.btn_cancel.set_enable(false);
        		this.headerDiv.btn_save.set_enable(true);
        	} else {
        		this.tabDiv.tabHistory.set_tabindex(1);
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_work.form.tabHistory.Tabpage2.form.grd_head.addEventHandler("oncloseup",this.div_work_grd_head_oncloseup,this);
            this.div_work.form.tabHistory.Tabpage2.form.grd_head.addEventHandler("onexpandup",this.div_work_grd_head_onexpandup,this);
            this.div_work.form.tabHistory.Tabpage2.form.grd_head.addEventHandler("onkeyup",this.div_work_grd_head_onkeyup,this);
            this.div_work.form.tabHistory.Tabpage1.form.grd_result.addEventHandler("oncloseup",this.div_work_grd_head_oncloseup,this);
            this.div_work.form.tabHistory.Tabpage1.form.grd_result.addEventHandler("onexpandup",this.div_work_grd_head_onexpandup,this);
            this.div_work.form.tabHistory.Tabpage1.form.grd_result.addEventHandler("onkeyup",this.div_work_grd_head_onkeyup,this);
        ...
        this.loadIncludeScript("TOM00901M.xfdl");
