(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_msg","102","111","253",null,null,"68",null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Button("btn_cancel",null,null,"60","28","95","20",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("취소");
            ...
            obj = new Static("Static16_00_00_01_00","221","258","70","20",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_cssclass("guideTip");
            obj.set_visible("false");
            obj.set_text("h20");
            ...
            obj = new Static("Static16_00_00_01_00_00","221","306","70","20",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_cssclass("guideTip");
            obj.set_visible("false");
            obj.set_text("h20");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",385,326,this,function(p){});
        ...
        // User Script
        this.registerScript("com_confirmBox.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 공통 메세지
         * 파일명 		: com_msgBox.xfdl
        ...
        this.on_initEvent = function()
        {
            ...
            this.sta_title.addEventHandler("onclick",this.Static10_onclick,this);
            this.btn_ok.addEventHandler("onclick",this.btn_ok_onclick,this);
            this.btn_cancel.addEventHandler("onclick",this.btn_cancel_onclick,this);
        };
        this.loadIncludeScript("com_confirmBox.xfdl");
