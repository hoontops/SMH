(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"LANG_CD\" type=\"STRING\" size=\"256\"/><Column id=\"LANG_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"LANG_NM\">한국어(KOR)</Col><Col id=\"LANG_CD\">ko-KR</Col></Row><Row><Col id=\"LANG_NM\">영어(ENGLISH)</Col><Col id=\"LANG_CD\">en-US</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_site", this);
            obj._setContents("<ColumnInfo><Column id=\"SITE_CD\" type=\"STRING\" size=\"256\"/><Column id=\"SITE_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"SITE_CD\">SMH</Col><Col id=\"SITE_NM\">SMH</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div_login","425","115","426","463",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_cssclass("div_login");
            this.addChild(obj.name, obj);

            obj = new Static("sta_00","27","41","120","20",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("10");
            obj.set_text("IFC-MES");
            obj.set_cssclass("sta_Login_systemName");
            this.div_login.addChild(obj.name, obj);

            obj = new Static("sta_02","162","204","102","28",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("11");
            obj.set_text("로그인");
            obj.set_cssclass("sta_Login_title");
            this.div_login.addChild(obj.name, obj);

            obj = new Static("sta_03","50","241","326","20",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("12");
            obj.set_text("로그인 후 시스템을 이용하실 수 있습니다.");
            obj.set_cssclass("sta_Login_subTitle");
            this.div_login.addChild(obj.name, obj);

            obj = new Edit("edt_userId","50","277","241","32",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("2");
            ...
            obj = new Edit("edt_password","50","314","241","32",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("3");
            obj.set_cssclass("edt_Login");
            obj.set_password("true");
            obj.set_displaynulltext("비밀번호");
            obj.set_text("a123456!");
            this.div_login.addChild(obj.name, obj);

            obj = new CheckBox("ckb_saveId","50","365","73","20",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("5");
            obj.set_text("ID Save");
            obj.set_cssclass("chk_login");
            this.div_login.addChild(obj.name, obj);

            obj = new Button("btn_login","296","277","80","70",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("4");
            obj.set_text("로그인");
            obj.set_cssclass("btn_Login");
            this.div_login.addChild(obj.name, obj);

            obj = new Button("btn_losePwd","260","365","116","20",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("7");
            obj.set_text("비밀번호 분실");
            obj.set_cssclass("btn_Login_link");
            this.div_login.addChild(obj.name, obj);

            obj = new Button("btn_apply",null,"365","80","20","171",null,null,null,null,null,this.div_login.form);
            obj.set_taborder("6");
            obj.set_text("사용신청");
            obj.set_cssclass("btn_Login_link");
            this.div_login.addChild(obj.name, obj);

            obj = new Combo("cbo_site","207","403","169","30",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("9");
            ...
            obj = new Combo("cbo_lang","50","403","152","30",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("8");
            ...
            obj = new Static("Static16_01_00_00","0","177","50","140",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("13");
            ...
            obj = new Static("Static16_01_00_00_00",null,"177","50","140","0",null,null,null,null,null,this.div_login.form);
            obj.set_taborder("14");
            obj.set_cssclass("guideTip");
            obj.set_visible("false");
            obj.set_text("w\r\n50");
            ...
            obj = new Button("btn_del","265","284","16","18",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("0");
            obj.set_cssclass("btn_WF_inputDel");
            obj.set_visible("false");
            this.div_login.addChild(obj.name, obj);

            obj = new Button("btn_del2","265","321","16","18",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("1");
            obj.set_cssclass("btn_WF_inputDel");
            obj.set_visible("false");
            this.div_login.addChild(obj.name, obj);

            obj = new Static("Static16_01_00_00_01","50","433",null,"30","50",null,null,null,null,null,this.div_login.form);
            obj.set_taborder("15");
            obj.set_cssclass("guideTip");
            obj.set_visible("false");
            obj.set_text("h\r\n30");
            ...
            obj = new Static("sta_00_00","140","80","179","49",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("16");
            obj.set_cssclass("sta_Login_ci");
            this.div_login.addChild(obj.name, obj);

            obj = new Button("btn_login00","132","0","60","35",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("17");
            obj.set_text("김희준");
            obj.set_cssclass("btn_Login");
            this.div_login.addChild(obj.name, obj);

            obj = new Button("btn_login00_00","215","0","60","35",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("18");
            obj.set_text("이우성");
            obj.set_cssclass("btn_Login");
            this.div_login.addChild(obj.name, obj);

            obj = new Button("btn_login00_01","301","0","60","35",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("19");
            obj.set_text("admin");
            obj.set_cssclass("btn_Login");
            this.div_login.addChild(obj.name, obj);

            obj = new Button("btn_login00_02","45","0","60","35",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("20");
            obj.set_text("이혜정");
            obj.set_cssclass("btn_Login");
            this.div_login.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("frmLogin_bk220223.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 로그인
         * 파일명 		: frmLogin.xfdl
        ...
        this.loadIncludeScript("frmLogin_bk220223.xfdl");
