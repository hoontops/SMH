(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edt_userId","470","161","290","48",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("2");
            ...
            obj = new Edit("edt_password","470","215","290","48",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("3");
            obj.set_cssclass("edt_Login");
            ...
            obj = new CheckBox("ckb_saveId","470","274","86","26",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("5");
            ...
            obj = new Button("btn_login","470","309","290","48",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("4");
            obj.set_text("로그인");
            obj.set_cssclass("btn_Login");
            this.div_login.addChild(obj.name, obj);

            obj = new Static("Static16_01_00_00","410","199","60","140",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("6");
            ...
            obj = new Static("Static16_01_00_00_00",null,"199","60","140","0",null,null,null,null,null,this.div_login.form);
            obj.set_taborder("7");
            obj.set_cssclass("guideTip");
            obj.set_visible("false");
            obj.set_text("w\r\n60");
            ...
            obj = new Button("btn_del","730","176","16","18",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("0");
            obj.set_cssclass("btn_WF_inputDel");
            obj.set_visible("false");
            this.div_login.addChild(obj.name, obj);

            obj = new Button("btn_del2","730","230","16","18",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("1");
            obj.set_cssclass("btn_WF_inputDel");
            obj.set_visible("false");
            this.div_login.addChild(obj.name, obj);

            obj = new Static("Static16_01_00_00_00_00",null,"0","410","73","0",null,null,null,null,null,this.div_login.form);
            obj.set_taborder("8");
            obj.set_cssclass("guideTip");
            obj.set_visible("false");
            obj.set_text("h73");
            ...
            obj = new Static("sta_00_00","545","73","144","54",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("11");
        ...
        this.fn_logins = function(){
        	...
        	this.ds_login.setColumn(0,"LANGUAGETYPE",'ko-KR');
        	//this.ds_login.setColumn(0,"SITETYPE",this.div_login.form.cbo_site.value);
        	this.ds_login.setColumn(0,"SITETYPE",'SMH');
