(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_dispatchingItem","0","10","103","20",null,null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("3");
            obj.set_text("디스패칭 항목");
            obj.set_cssclass("sta_WF_label");
            this.tab_00.Tabpage1.addChild(obj.name, obj);

            obj = new Combo("cbo_dispatchingItem","108","10","165","20",null,null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("0");
            ...
            obj = new Button("btn_clear","171","50","102","36",null,null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btn_search","15","50","146","36",null,null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("1");
            ...
            obj = new Grid("grd_dispatchingItem","0","34","479",null,null,"0",null,null,null,null,this.div_work.form);
            obj.set_taborder("0");
            obj.set_autoenter("select");
            obj.set_binddataset("ds_dispatchingItem");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"30\"/><Column size=\"120\"/><Column size=\"88\"/><Column size=\"60\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"120\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"디스패칭 항목\" cssclass=\"cell_point\"/><Cell col=\"3\" text=\"설명\"/><Cell col=\"4\" text=\"우선순위\"/><Cell col=\"5\" text=\"유효상태\" cssclass=\"cell_point\"/><Cell col=\"6\" text=\"수정자\"/><Cell col=\"7\" text=\"수정일\"/></Band><Band id=\"body\"><Cell text=\"bind:NO\"/><Cell col=\"1\" text=\"bind:CHK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"bind:DISPATCHINGITEM\" displaytype=\"combocontrol\" edittype=\"expr:expr:EDITYN==&apos;Y&apos;?&apos;combo&apos;:&apos;none&apos;\" combocodecol=\"C,DispatchingItem,,Y,Y\"/><Cell col=\"3\" text=\"bind:DESCRIPTION\" displaytype=\"text\" edittype=\"text\"/><Cell col=\"4\" text=\"bind:PRIOTY\" edittype=\"text\" displaytype=\"text\"/><Cell col=\"5\" text=\"bind:VALIDSTATE\" displaytype=\"combocontrol\" edittype=\"combo\" combocodecol=\"C,ValidState,,Y,Y\"/><Cell col=\"6\" text=\"bind:MODIFIER\"/><Cell col=\"7\" text=\"bind:MODIFIEDTIME\"/></Band></Format></Formats>");
            this.div_work.addChild(obj.name, obj);

            obj = new Button("btn_delRow_ds_priorityOfDispatching",null,"6","26","24","60",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("2");
            obj.set_cssclass("btn_WF_grdDel");
            obj.set_tooltiptext("삭제");
            this.div_work.addChild(obj.name, obj);

            obj = new Button("btn_addRow_ds_priorityOfDispatching",null,"6","26","24","90",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("1");
            obj.set_cssclass("btn_WF_grdAdd");
            obj.set_tooltiptext("추가");
            this.div_work.addChild(obj.name, obj);

            obj = new Button("btn_grdCopy01",null,"6","27","24","29",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("3");
            obj.set_cssclass("btn_WF_grdCopy");
            obj.set_tooltiptext("복사");
            this.div_work.addChild(obj.name, obj);

            obj = new Button("btn_xlDn_grd_priorityOfDispatching",null,"6","29","24","0",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_grdExcelDown");
            obj.set_tooltiptext("엑셀다운로드");
            this.div_work.addChild(obj.name, obj);

            obj = new Grid("grd_priorityOfDispatching","grd_dispatchingItem:10","35",null,null,"2","0",null,null,null,null,this.div_work.form);
            obj.set_taborder("5");
            obj.set_autoenter("select");
            obj.set_binddataset("ds_priorityOfDispatching");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"30\"/><Column size=\"60\"/><Column size=\"50\"/><Column size=\"50\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"120\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"우선순위\" cssclass=\"cell_point\"/><Cell col=\"3\" text=\"FROM\"/><Cell col=\"4\" text=\"TO\"/><Cell col=\"5\" text=\"유효상태\" cssclass=\"cell_point\"/><Cell col=\"6\" text=\"수정자\"/><Cell col=\"7\" text=\"수정일\"/></Band><Band id=\"body\"><Cell text=\"bind:NO\"/><Cell col=\"1\" text=\"bind:CHK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"bind:ITEMPRIOTY\" displaytype=\"text\" edittype=\"text\"/><Cell col=\"3\" text=\"bind:FROMVALUE\" displaytype=\"text\" edittype=\"text\"/><Cell col=\"4\" text=\"bind:TOVALUE\" displaytype=\"text\" edittype=\"text\"/><Cell col=\"5\" text=\"bind:VALIDSTATE\" displaytype=\"combocontrol\" edittype=\"combo\" combocodecol=\"C,ValidState,,Y,Y\"/><Cell col=\"6\" text=\"bind:MODIFIER\"/><Cell col=\"7\" text=\"bind:MODIFIEDTIME\"/></Band></Format></Formats>");
            this.div_work.addChild(obj.name, obj);
            ...
            obj = new Static("sta_priorityOfDispatching","sta_cnt_ds_dispatchingItem:242","0","110",null,null,"grd_priorityOfDispatching:1",null,null,null,null,this.div_work.form);
            obj.set_taborder("8");
            obj.set_text("우선순위 리스트");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_usedecorate("true");
            obj.set_fittocontents("width");
            this.div_work.addChild(obj.name, obj);

            obj = new Static("sta_cnt_ds_priorityOfDispatching","sta_priorityOfDispatching:8","-1","101","34",null,null,null,null,null,null,this.div_work.form);
            obj.set_taborder("9");
            obj.set_text("Count : <fc v=\"#f31d24\">0</fc>");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_usedecorate("true");
            ...
            obj = new Button("btn_addRow_ds_dispatchingItem","sta_cnt_ds_dispatchingItem:119","5","26","24",null,null,null,null,null,null,this.div_work.form);
            obj.set_taborder("10");
            obj.set_cssclass("btn_WF_grdAdd");
            obj.set_tooltiptext("추가");
            this.div_work.addChild(obj.name, obj);

            obj = new Button("btn_delRow_ds_dispatchingItem","btn_addRow_ds_dispatchingItem:4","5","26","24",null,null,null,null,null,null,this.div_work.form);
            obj.set_taborder("11");
            obj.set_cssclass("btn_WF_grdDel");
            obj.set_tooltiptext("삭제");
            this.div_work.addChild(obj.name, obj);

            obj = new Button("btn_grdCopy01_00","btn_delRow_ds_dispatchingItem:4","5","27","24",null,null,null,null,null,null,this.div_work.form);
            obj.set_taborder("12");
            obj.set_cssclass("btn_WF_grdCopy");
            obj.set_tooltiptext("복사");
            this.div_work.addChild(obj.name, obj);

            obj = new Button("btn_xlDn_grd_dispatchingItem","btn_grdCopy01_00:0","5","29","24",null,null,null,null,null,null,this.div_work.form);
            obj.set_taborder("13");
            obj.set_cssclass("btn_WF_grdExcelDown");
            obj.set_tooltiptext("엑셀다운로드");
            this.div_work.addChild(obj.name, obj);
            ...
            obj = new Button("btn_03",null,"16","93","24","95",null,null,null,null,null,this.div_header.form);
            obj.set_taborder("8");
        ...
        // User Script
        this.addIncludeScript("MFM00900M_OLD.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("MFM00900M_OLD.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("MFM00900M_OLD.xfdl","lib::lib_mfm.xjs");
        this.registerScript("MFM00900M_OLD.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 치공구 현황 조회
         * 파일명 		: TOM01100M.xfdl
        ...
        this.div_work_btn_addRow_ds_dispatchingItem_onclick = function(obj,e)
        {
        	...
        	this.ds_dispatchingItem.setColumn(this.ds_dispatchingItem.rowposition,"EDITYN", "N");
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.tab_00.Tabpage1.form.btn_search.addEventHandler("onclick",this.fn_search,this);
            this.div_work.form.grd_dispatchingItem.addEventHandler("oncellclick",this.div_work_grd_dispatchingItem_oncellclick,this);
            this.div_work.form.btn_addRow_ds_priorityOfDispatching.addEventHandler("onclick",this.div_work_btn_addRow_ds_priorityOfDispatching_onclick,this);
        ...
        this.loadIncludeScript("MFM00900M_OLD.xfdl");
