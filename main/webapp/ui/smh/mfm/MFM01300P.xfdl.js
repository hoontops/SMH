(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("주요 공정 실적 현황판_대/중 공정 그룹 팝업");
            ...
            obj._setContents("<ColumnInfo><Column id=\"WORKDONESEGMENTCLASSID\" type=\"STRING\" size=\"256\"/><Column id=\"WORKDONESEGMENTCLASSNAME\" type=\"STRING\" size=\"256\"/><Column id=\"P_WORKDONETOPSEGMENTCLASSID\" type=\"STRING\" size=\"256\"/><Column id=\"P_WORKDONEMIDDLESEGMENTCLASSID\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"WORKDONESEGMENTCLASSTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"ENTERPRISEID\" type=\"STRING\" size=\"256\"/><Column id=\"PLANTID\" type=\"STRING\" size=\"256\"/><Column id=\"TXTWORKDONETOPSEGMENTCLASS\" type=\"STRING\" size=\"256\"/><Column id=\"TXTWORKDONEMIDDLESEGMENTCLASS\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"150\"/><Column size=\"250\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"주요공정 그룹ID\" tooltiptext=\"WORKDONESEGMENTCLASSID\"/><Cell col=\"2\" text=\"주요공정 그룹명\" tooltiptext=\"WORKDONESEGMENTCLASSNAME\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:WORKDONESEGMENTCLASSID\" textAlign=\"left\" displaytype=\"normal\" edittype=\"none\"/><Cell col=\"2\" text=\"bind:WORKDONESEGMENTCLASSNAME\" textAlign=\"left\" calendardateformat=\"yyyy-MM-dd\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.addIncludeScript("MFM01300P.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("MFM01300P.xfdl","lib::lib_mtm.xjs");
        this.registerScript("MFM01300P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 주요 공정 실적 현황판 (대/중 팝업 - 입력창)
         * 파일명 		: MFM01300P.xfdl
         * 작성자 		: 김진현
         * 작성일 		: 2021.04.22
         *
         * 설  명		: 주요 공정 실적 현황판  표준공정(대/중 공정그룹) 팝업
         *---------------------------------------------------------------------------------------
         * 변경일		변경자		변경내역
         *---------------------------------------------------------------------------------------
         * 2021.04.22	김진현   	최초작성
        ...
        this.fn_search = function (obj, e)
        {
        	...
        	this.ds_search.setColumn(0, "WORKDONESEGMENTCLASSTYPE"		, v_type);
        	this.ds_search.setColumn(0, "ENTERPRISEID"				, v_ent);
        	this.ds_search.setColumn(0, "PLANTID"					, v_site);
        	var nText	= this.searchDiv.edt_procGrp.value;
        	switch(v_type) {
        		case "TopWorkDoneSegmentClass":		// 대공정
        			this.ds_search.setColumn(0, "TXTWORKDONETOPSEGMENTCLASS"		, nText);
        			break;
        		case "MiddleWorkDoneSegmentClass": 	// 중공정
        			this.ds_search.setColumn(0, "TXTWORKDONEMIDDLESEGMENTCLASS"		, nText);
        			break;

        		default:
        	}

        	var sSvcID 			= "selectWorkDoneSegmentListByTypeList";
        	var sController 	= "/mfm01300/selectWorkDoneSegmentListByTypeList.do";		// 다른쪽에서 생성 한것 가져다 활용(x) chk 박스 필요
        ...
        */
        ...
        this.loadIncludeScript("MFM01300P.xfdl");
