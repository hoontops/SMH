(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_productType","0","10","103","20",null,null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("5");
            obj.set_text("양산구분");
            obj.set_cssclass("sta_WF_label");
            this.tab_00.Tabpage1.addChild(obj.name, obj);

            obj = new Combo("cbo_productType","108","10","165","20",null,null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("0");
            ...
            obj = new Static("sta_product","0","35","103","20",null,null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("6");
            obj.set_text("품목코드");
            obj.set_cssclass("sta_WF_label");
            this.tab_00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("btn_clear","171","75","102","36",null,null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("4");
            ...
            obj = new Button("btn_search","15","75","146","36",null,null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("3");
            ...
            obj = new Static("Static12_00_00_00_01_00_00",null,"55","45","20","91",null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("9");
            obj.set_text("h20");
            obj.set_visible("false");
            obj.set_cssclass("guideTip");
            ...
            obj = new Static("Static12_00_00_00_00_00","161","81","10","27",null,null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("10");
            obj.set_text("w\r\n10");
            obj.set_visible("false");
            obj.set_cssclass("guideTip");
            ...
            obj = new Edit("edt_product","108","35",null,"20","37",null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("1");
            this.tab_00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("btn_product",null,"35","22","20","15",null,null,null,null,null,this.tab_00.Tabpage1.form);
            obj.set_taborder("2");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"30\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"240\"/><Column size=\"80\"/><Column size=\"120\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"우선순위\"/><Cell col=\"3\" text=\"품목코드\" cssclass=\"cell_point\"/><Cell col=\"4\" text=\"픔목명\"/><Cell col=\"5\" text=\"수정자\"/><Cell col=\"6\" text=\"수정일\"/></Band><Band id=\"body\"><Cell text=\"bind:NO\"/><Cell col=\"1\" text=\"bind:CHK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"bind:PRIORITY\" displaytype=\"text\" edittype=\"text\"/><Cell col=\"3\" text=\"bind:PRODUCTDEFID\" expandimage=\"url(&apos;theme://images/grd_expand.png&apos;)\" expandshow=\"show\" displaytype=\"text\" edittype=\"text\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:PRODUCTDEFNAME\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:MODIFIER\"/><Cell col=\"6\" text=\"bind:MODIFIEDTIME\"/></Band></Format></Formats>");
        ...
        // User Script
        this.addIncludeScript("MFM00800M_bak.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("MFM00800M_bak.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("MFM00800M_bak.xfdl","lib::lib_mfm.xjs");
        this.registerScript("MFM00800M_bak.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 치공구 현황 조회
         * 파일명 		: TOM01100M.xfdl
        ...
        this.fn_popupAfter = function(sPopupId, Variant)
        {
        	...
        	switch (sPopupId)
        	{
        		...
        		case "SCH_PRODUCT_GRID":
        			//중복검사
        			var chkCnt = this.ds_priority.getCaseCount("PRODUCTDEFID=='" + this.nfn_nvl(rtn[0], "") +"'");
        			if (chkCnt>0)
        			{
        ...
        this.on_initEvent = function()
        {
            ...
            this.tab_00.Tabpage1.form.edt_product.addEventHandler("onkeydown",this.tab_00_Tabpage1_edt_product_onkeydown,this);
            this.tab_00.Tabpage1.form.btn_product.addEventHandler("onclick",this.tab_00_Tabpage1_btn_product_onclick,this);
        ...
        this.loadIncludeScript("MFM00800M_bak.xfdl");
