(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM07700M");
            this.set_titletext("다중분할 인계");
            ...
            obj = new Static("sta_trans","51.75%","10","103","20",null,null,null,null,null,null,this.div_work.form.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("인계작업장");
            ...
            obj = new Combo("cbo_transitArea","60.35%","10","165","20",null,null,null,null,null,null,this.div_work.form.divSearch.form);
            obj.set_taborder("7");
        ...
        // User Script
        this.addIncludeScript("PCM07700M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM07700M.xfdl","lib::lib_pcm.xjs");
        this.registerScript("PCM07700M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 다중분할 인계
         * 파일명 		: PCM07700M.xfdl
        ...
        this.fn_save = function(obj,e)
        {
        	...
        	if(this.gfn_isNull(this.div_work.form.divSearch.form.cbo_transitArea.value)){
        		this.gfn_Message("SelectTransitArea", "", "warning", "ok");
        		return;
        	}
        	...
        	var strResourceid = "";
        	var strTransitArea = this.div_work.form.divSearch.form.cbo_transitArea.value;
        	if(!this.gfn_isNull(this.div_work.form.divSearch.form.cbo_transitArea.value)){
        		strResourceid = this.ds_transitArea.lookup("AREAID",strTransitArea,"RESOURCEID");
        		//strResourceid = this.div_work.form.divSearch.form.cbo_transitArea.value;
        	}
        	...
        	this.ds_send.addRow();
        	this.ds_send.setColumn(0,"TRANSITAREA",strTransitArea);
        	this.ds_send.setColumn(0,"RESOURCEID",strResourceid);
        	...
        	// -------------------------
        	var sSvcID 			= "saveMultiLotSend";
        	var sController 	= "/pcm07700/saveMultiLotSend.do";
        	var sInDatasets 	= "INPUT1=ds_lotListSave:U INPUT=ds_send";
        	var sOutDatasets 	= "";
        	var sArgs 			= "";
        	...
        	if (errCD < 0)
        	{
        		...
        		if (trId == "selectWIPMultiStateList") {
        			...
        			if (this.ds_lotInfo.getRowCount() < 1)
        			{
        				...
        				this.ds_search.setColumn(0, "PRODUCTDEFID", 	this.ds_lotInfo.getColumn(0,"PRODUCTDEFID"));
        				this.ds_search.setColumn(0, "PRODUCTDEFVERSION", 	this.ds_lotInfo.getColumn(0,"PRODUCTDEFVERSION"));
        				this.ds_search.setColumn(0, "PROCESSDEFID", 	this.ds_lotInfo.getColumn(0,"PROCESSDEFID"));
        				this.ds_search.setColumn(0, "PROCESSDEFVERSION", 	this.ds_lotInfo.getColumn(0,"PROCESSDEFVERSION"));
        				this.ds_search.setColumn(0, "PROCESSSEGMENTID", 	this.ds_lotInfo.getColumn(0,"PROCESSSEGMENTID"));
        				...
        				//this.div_work.form.divSearch.form.sta_trans.set_visible(false);
        				...
        				if((stepType+",").indexOf("WaitForSend,")>=0){
        					...
        					this.div_work.form.divSearch.form.sta_trans.set_visible(true);
        				}
        				*/

        				var sSvcID 			= "GetTransitAreaList";
        				var sController 	= "/pcm07700/GetTransitAreaList.do";
        				var sInDatasets 	= "INPUT=ds_search";
        				var sOutDatasets 	= "ds_transitArea=output";
        				var sArgs 			= "";
        				this.gfn_transaction(sSvcID, sController, sInDatasets, sOutDatasets, sArgs, "","",false);
        				var primaryAreaId = "";
        				if(this.gfn_isNull(this.ds_lotInfo.getColumn(0,"NEXTPROCESSSEGMENTID"))){
        					primaryAreaId = this.ds_lotInfo.getColumn(0,"AREAID");
        				}else{
        					for(var i=0; i<this.ds_transitArea.rowcount; i++){
        						if(this.ds_transitArea.getColumn(i,"ISPRIMARYRESOURCE")=="Y")
        							primaryAreaId = this.ds_transitArea.getColumn(0,"AREAID")
        					}
        				}
        				this.div_work.form.divSearch.form.cbo_transitArea.set_value(primaryAreaId);
        ...
        this.fn_searchWIP = function()
        {
        	...
        	this.ds_search.setColumn(0, "PLANTID", 			this.gf_getSiteType());
        	this.ds_search.setColumn(0, "LANGUAGETYPE", 	this.gf_getLanguageType());
        	this.ds_search.setColumn(0, "PROCESSSTATE", 	this.Constants.WaitForSend);

        	var sSvcID 			= "selectWIPMultiStateList";
        	var sController 	= "/pcm07700/selectWIPMultiStateList.do";
        	var sInDatasets 	= "INPUT=ds_search";
        ...
        this.fn_searchKeyInfo = function()
        {
        	...
        	var sController 	= "/pcm07700/selectCustomQuery.do";
        	var sInDatasets 	= "INPUT=ds_search";
        ...
        this.loadIncludeScript("PCM07700M.xfdl");
