(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("PCM07000T1.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM07000T1.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PCM07000T1.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		:
         * 파일명 		: PCM01500D.xfdl
        ...
        this.loadIncludeScript("PCM07000T1.xfdl");
