(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grd_AOIDefectInfo","60%","34",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Div("div_AOIDefectBtnItem","583","0",null,"34","grd_AOIDefectInfo:10",null,null,null,null,null,this);
            obj.set_taborder("8");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div_AOIDefectInfoBtnItem","1140","0","118","34",null,null,null,null,null,null,this);
            obj.set_taborder("9");
        ...
        // User Script
        this.addIncludeScript("PCM01700T02.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM01700T02.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PCM01700T02.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PCM01700T02.xfdl","lib::lib_mtm.xjs");
        this.addIncludeScript("PCM01700T02.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PCM01700T02.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 작업종료 :: AOI 불량 탭
        ...
        this.loadIncludeScript("PCM01700T02.xfdl");
