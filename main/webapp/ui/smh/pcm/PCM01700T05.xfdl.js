(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM01700T05");
            this.set_titletext("자재(작업완료)");
            ...
            obj = new Grid("grd_standardRequirementComplete","60%","34",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_autoenter("select");
            obj.set_binddataset("ds_standardRequirementInfo");
            obj.set_cssclass("grd_sub");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"110\"/><Column size=\"90\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"자재 ID\" tooltiptext=\"CONSUMABLEDEFID\"/><Cell col=\"2\" text=\"자재명\" tooltiptext=\"CONSUMABLEDEFNAME\"/><Cell col=\"3\" text=\"기준소요량\" tooltiptext=\"STANDARDREQUIREMENTQTY\"/><Cell col=\"4\" text=\"소요량\" tooltiptext=\"REQUIREMENTQTY\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:CONSUMABLEDEFID\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:CONSUMABLEDEFNAME\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:STANDARDREQUIREMENTQTY\" textAlign=\"right\" displaytype=\"mask\" maskeditformat=\"#,###,###,##0.#####\"/><Cell col=\"4\" text=\"bind:REQUIREMENTQTY\" textAlign=\"right\" displaytype=\"mask\" maskeditformat=\"#,###,###,##0.#####\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_consumableComplete","0","34",null,null,"grd_standardRequirementComplete:10","0",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_autoenter("select");
            obj.set_binddataset("ds_consumableList");
            obj.set_cssclass("grd_sub");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"150\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"100\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"자재 ID\" tooltiptext=\"CONSUMABLEDEFID\"/><Cell col=\"2\" text=\"자재명\" tooltiptext=\"CONSUMABLEDEFNAME\"/><Cell col=\"3\" text=\"자재 LOT No.\" tooltiptext=\"CONSUMABLELOTID\"/><Cell col=\"4\" text=\"재고수량\" tooltiptext=\"STOCKQTY\"/><Cell col=\"5\" text=\"가용수량\" tooltiptext=\"AVAILABLEQTY\"/><Cell col=\"6\" text=\"투입수량\" tooltiptext=\"INPUTQTY\" cssclass=\"cell_point\"/><Cell col=\"7\" text=\"불량 수량\" tooltiptext=\"DEFECTQTY\"/><Cell col=\"8\" text=\"Lot 사용수량\" tooltiptext=\"LOTUSINGQTY\"/><Cell col=\"9\" text=\"자재 불량\" tooltiptext=\"CONSUMABLEDEFECT\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:CONSUMABLEDEFID\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:CONSUMABLEDEFNAME\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:CONSUMABLELOTID\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:STOCKQTY\" textAlign=\"right\" displaytype=\"mask\" maskeditformat=\"#,###,###,##0.#####\"/><Cell col=\"5\" text=\"bind:AVAILABLEQTY\" textAlign=\"right\" displaytype=\"mask\" maskeditformat=\"#,###,###,##0.#####\"/><Cell col=\"6\" text=\"bind:INPUTQTY\" textAlign=\"right\" displaytype=\"mask\" maskeditformat=\"#,###,###,##0.#####\" edittype=\"mask\"/><Cell col=\"7\" text=\"bind:DEFECTQTY\" textAlign=\"right\" displaytype=\"mask\" maskeditformat=\"#,###,###,##0.#####\"/><Cell col=\"8\" text=\"bind:LOTUSINGQTY\" textAlign=\"right\" displaytype=\"mask\" maskeditformat=\"#,###,###,##0.#####\"/><Cell col=\"9\" text=\"bind:CONSUMABLEDEFECT\" textAlign=\"center\" displaytype=\"buttoncontrol\" edittype=\"button\" tooltiptext=\"CONSUMABLEDEFECT\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("sta_cnt_ds_consumableList","title1_01:0","0","140","34",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Static("sta_consumableLotIdComplete","sta_cnt_ds_consumableList:0","9","65","20",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("자재 LOT");
            ...
            obj = new Edit("edt_consumableLotIdComplete","sta_consumableLotIdComplete:5","9","160","20",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            this.addChild(obj.name, obj);

            obj = new Button("btn_delRow",null,"5","29","24","grd_standardRequirementComplete:10",null,null,null,null,null,this);
            obj.set_taborder("5");
        ...
        // User Script
        this.addIncludeScript("PCM01700T05.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM01700T05.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PCM01700T05.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PCM01700T05.xfdl","lib::lib_mtm.xjs");
        this.registerScript("PCM01700T05.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 인수등록 :: 자재(작업완료) 탭
         * 파일명 		: PCM01700T05.xfdl
         * 작성자 		: 김성현
         * 작성일 		: 2021.04.10
         *
         * 설  명		: 인수등록 :: 자재(작업완료) 탭
        ...
        // 				this.resultInfo.dataset = this.ds_consumableDefectList;
        				...
        				this.ds_consumableList.setColumn(nRow, "DEFECTQTY", inputDefectQty);

        				var consumableLotId  = this.nfn_nvl(this.ds_consumableList.getColumn(nRow, "CONSUMABLELOTID"), "");

        				var cRow = this.ds_consumableQty.findRow("CONSUMABLELOTID", consumableLotId);
        				var vConsumableQty = nexacro.toNumber(this.nfn_nvl(this.ds_consumableQty.getColumn( cRow, "ORGINPUTQTY"), "0"));

        				if ((inputDefectQty + vConsumableQty) > availableQty)
        				{
        					this.ds_consumableList.setColumn(nRow, "INPUTQTY"   , availableQty);
        					this.ds_consumableList.setColumn(nRow, "ORGINPUTQTY", availableQty - inputDefectQty);
        				}
        				else
        				{
        					this.ds_consumableList.setColumn(nRow, "INPUTQTY"   , inputDefectQty + vConsumableQty);
        					this.ds_consumableList.setColumn(nRow, "ORGINPUTQTY", vConsumableQty);
        				}
        			}
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
        	...
        	switch(trId) {
        		case "selectConsumableListByProcessWorkCompleteAndByProcess":
        			...
        			for(var i = 0; i < this.ds_consumableList.getRowCount(); i++)
        			{
        				var consumableLotId = this.nfn_nvl(this.ds_consumableList.getColumn(0, "CONSUMABLELOTID"), "");

        				var cRow = this.ds_consumableQty.findRow("CONSUMABLELOTID", consumableLot);
        				var orginputQty = nexacro.toNumber(this.nfn_nvl(this.ds_consumableList.getColumn(i, "ORGINPUTQTY"), "0"));
        		...
        		case "getConsumableLotByProcess":
        			...
        			{
        				var lotType = this.nfn_nvl(this.ds_lotInfoData.getColumn(0, "LOTTYPE"), "");
        				...
        				if (inputQty <= 0)
        				{
        					...
        					this.gfn_Message("ConsumableLotIsAlreadyUsingInLot", [Eco.number.getMaskFormatString(stockQty, "#,##0.#####"), Eco.number.getMaskFormatString(lotUsingQty, "#,##0.#####")], "warning", "ok");
        					return;
        				}
        		...
        		case "getPriorityConsumableLotByProcess":
        			...
        			for(var i=0; i<this.ds_consumableDistinctList.getRowCount(); i++)
        			{
        				...
        				this.ds_inputQtyList.setColumn(nRow, "INPUTQTY", this.ds_consumableList.getSum("ORGINPUTQTY"));

        				trace("this.ds_consumableList.getRowCount() 1>>" + this.ds_consumableList.getRowCount());
        				trace("this.ds_consumableList.getSum() >>" + this.ds_consumableList.getSum("ORGINPUTQTY"));
        			...
        			for(var i = 0; i < this.ds_inputQtyList.getRowCount(); i++)
        			{
        				...
        				if(key == value_Key)
        				{
        					...
        					{
        						this.ds_consumableListTemp.setColumn(0, "INPUTQTY"   , 0);
        						this.ds_consumableListTemp.setColumn(0, "ORGINPUTQTY", 0);
        					}
        					else
        					{
        			...
        			var cnt = this.ds_consumableListTemp.getRowCount();  // GetConsumableLotByProcess 와   SelectConsumableListByProcessWorkComplete 를 비교
        			for(var i = 0; i < cnt; i++)
        			{
        				var nRow = this.ds_consumableList.addRow();
        				this.ds_consumableList.copyRow(nRow, this.ds_consumableListTemp, i);

        				var consumableLot = this.nfn_nvl(this.ds_consumableListTemp.getColumn(i, "CONSUMABLELOTID"), "");

        				var cRow = this.ds_consumableQty.findRow("CONSUMABLELOTID", consumableLot);
        				var orginputQty = nexacro.toNumber(this.nfn_nvl(this.ds_consumableListTemp.getColumn(i, "ORGINPUTQTY"), "0"));
        			...
        			if (this.ds_alternativeList.getRowCount() > 0)
        			{
        				...
        				for(var i = 0; i < this.ds_inputQtyList.rowcount; i++)
        				{
        					...
        					if(key == value_Key)
        					{
        						...
        						if ((reqQty - value_Value) < 0)
        						{
        							this.ds_alternativeList.setColumn(0, "INPUTQTY"   , 0);
        							this.ds_alternativeList.setColumn(0, "ORGINPUTQTY", 0);
        						}
        						else
        						{
        							...
        							if (vInputQty > (reqQty - value_Value))
        							{
        								...
        								this.ds_alternativeList.setColumn(0, "ORGINPUTQTY", (reqQty - value_Value));
        							}
        						}
        				...
        				for(var i = 0; i < nCnt; i++)
        				{
        					...
        					var consumableLot = this.nfn_nvl(this.ds_alternativeList.getColumn(i, "CONSUMABLELOTID"), "");

        					var cRow = this.ds_consumableQty.findRow("CONSUMABLELOTID", consumableLot);
        					var orginputQty = nexacro.toNumber(this.nfn_nvl(this.ds_alternativeList.getColumn(i, "ORGINPUTQTY"), "0"));
        ...
        this.edt_consumableLotIdComplete_onkeydown = function(obj,e)
        {
        	if(e.keycode == 13 || e.keycode == 9)
        	{
        		if (!this.checkAlreadyInputLot(this.edt_consumableLotIdComplete.value, "CONSUMABLELOTID"))
        		{
        			this.edt_consumableLotIdComplete.set_value("");
        			return;
        		}
        		...
        		this.ds_param.setColumn(0, "CONSUMABLELOTID", this.edt_consumableLotIdComplete.value);
        ...
        this.ds_consumableList_oncolumnchanged = function(obj,e)
        {
        	if (e.columnid == "INPUTQTY")
        	{
        		...
        		if (inputQty > (stockQty - lotUsingQty))
        		{
        			...
        			this.gfn_Message("InputQtyGreaterThanAvailableQty", [Eco.number.getMaskFormatString(stockQty - lotUsingQty, "#,##0.#####")], "warning", "ok");
        			obj.setColumn(e.row, "INPUTQTY", stockQty - lotUsingQty);
        			return;
        		}
        ...
        this.grd_consumableComplete_onlbuttondown = function(obj,e)
        {
        	...
        	if (this.nfn_isEqualCol(obj, e.col, "CONSUMABLEDEFECT"))
        	{
        		this.mfn_OpenConsumableDefectPopup();
        	}
        };


        this.mfn_OpenConsumableDefectPopup = function ()
        {
        	var nRow = this.ds_consumableList.rowcount == 1 ? 0 : this.ds_consumableList_rowposition;

        	var consumableLotId  = this.nfn_nvl(this.ds_consumableList.getColumn(nRow, "CONSUMABLELOTID"), "");
        	var stockQty 		 = nexacro.toNumber(this.nfn_nvl(this.ds_consumableList.getColumn(nRow, "STOCKQTY"), "0"));
        	var availableQty     = nexacro.toNumber(this.nfn_nvl(this.ds_consumableList.getColumn(nRow, "AVAILABLEQTY"), "0"));
        	var inputQty 		 = nexacro.toNumber(this.nfn_nvl(this.ds_consumableList.getColumn(nRow, "INPUTQTY"), "0"));
        	var originalInputQty = nexacro.toNumber(this.nfn_nvl(this.ds_consumableList.getColumn(nRow, "ORGINPUTQTY"), "0"));
        	var defectQty 		 = nexacro.toNumber(this.nfn_nvl(this.ds_consumableList.getColumn(nRow, "DEFECTQTY"), "0"));
        	...
        	this.gfn_openPopup(popupId,"pcm::PCM01700P6.xfdl",oArg,"width=556,height=174");
        ...
        this.on_initEvent = function()
        {
            ...
            this.grd_consumableComplete.addEventHandler("onlbuttondown",this.grd_consumableComplete_onlbuttondown,this);
            this.edt_consumableLotIdComplete.addEventHandler("onkeydown",this.edt_consumableLotIdComplete_onkeydown,this);
        ...
        this.loadIncludeScript("PCM01700T05.xfdl");
