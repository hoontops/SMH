(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM01500P");
            this.set_titletext("PCM 파일 다운로드");
            ...
            obj = new Div("div_file","1.87%","5",null,"244","1.56%",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_url("common::com_file_b4.xfdl");
            obj.set_border("0px solid rgba(128,128,128,1)");
            this.addChild(obj.name, obj);

            obj = new Button("btn_sel",null,"256","40","21","-131",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("확인");
            ...
            obj = new Static("Static13","1.56%","241",null,"15","1.56%",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("15");
            obj.set_visible("false");
            ...
            obj = new Static("Static04","0.00%","0",null,"284","97.98%",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("15");
            obj.set_visible("false");
            ...
            obj = new Static("Static03","98.29%","0",null,"284","0.00%",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("15");
            obj.set_visible("false");
            obj.set_background("gold");
            ...
            obj = new Button("btn_confirm",null,"256","60","21","btn_close:10",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("확인");
        ...
        // User Script
        this.registerScript("PCM01500P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 파일 업로드 관리
         * 파일명 		: cmsa01200P.xfdl
        ...
        */
        ...
        this.loadIncludeScript("PCM01500P.xfdl");
