(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM01700M");
            this.set_titletext("인수 등록");
            ...
            obj.set_cssclass("grd_sub");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"30\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"80\"/><Column size=\"100\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"설비코드\" tooltiptext=\"EQUIPMENTID\"/><Cell col=\"3\" text=\"설비명\" tooltiptext=\"EQUIPMENTNAME\"/><Cell col=\"4\" text=\"Lot 수\" tooltiptext=\"LOTCNT\"/><Cell col=\"5\" text=\"설비 상태\" tooltiptext=\"EQUIPMENTSTATE\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:CHK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"bind:EQUIPMENTID\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:EQUIPMENTNAME\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:LOTCNT\" textAlign=\"right\" displaytype=\"mask\" maskeditformat=\"#,###,###,##0.#####\"/><Cell col=\"5\" text=\"bind:STATE\" textAlign=\"center\" displaytype=\"normal\" combodataset=\"ds_status\" combocodecol=\"STATEID\" combodatacol=\"STATENAME\"/></Band></Format></Formats>");
            this.div_work.form.tab.tpgEquipmentUseStatus.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("PCM01700M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM01700M.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PCM01700M.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PCM01700M.xfdl","lib::lib_mtm.xjs");
        this.addIncludeScript("PCM01700M.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PCM01700M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 인수등록
         * 파일명 		: PCM01700M.xfdl
        ...
        */
        		...
        		trace("==============this.ds_dtStaying.getColumn(0, ISLOCKING)================>"+this.nfn_nvl(this.ds_dtStaying.getColumn(0, "ISLOCKING"), ""));
        			if (this.ds_dtStaying.getColumn(0, "ISLOCKING") == "Y"){
        				// 채공팝업
        ...
        //			if(this.ds_lotInfo.getColumn(0, "LOTSTATE") == "InTransit" && this.ds_lotInfo.getColumn(0, "OWNTYPE") != "InHouseOSP")
        			...
        			trace("this.fn_checkRCLot(this.ds_lotInfo)-->"+this.fn_checkRCLot(this.ds_lotInfo));
        ...
        */
        ...
        this.loadIncludeScript("PCM01700M.xfdl");
