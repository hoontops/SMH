(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"30\"/><Column size=\"60\"/><Column size=\"150\"/><Column size=\"300\"/><Column size=\"150\"/><Column size=\"140\"/><Column size=\"60\"/><Column size=\"140\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"공정수순\" tooltiptext=\"USERSEQUENCE\"/><Cell col=\"3\" text=\"공정명\" tooltiptext=\"PROCESSSEGMENTNAME\"/><Cell col=\"4\" text=\"입력공정\" tooltiptext=\"WRITEPROCESSSEGMENT\"/><Cell col=\"5\" text=\"작업장\" tooltiptext=\"AREANAME\"/><Cell col=\"6\" text=\"메시지 유형\" tooltiptext=\"MESSAGETYPE\"/><Cell col=\"7\" text=\"등록자\" tooltiptext=\"WRITER\"/><Cell col=\"8\" text=\"등록일\" tooltiptext=\"WRITEDATE\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"bind:USERSEQUENCE\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:PROCESSSEGMENTNAME\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:WRITEPROCESSSEGMENT\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:AREANAME\" textAlign=\"left\"/><Cell col=\"6\" text=\"bind:MESSAGETYPE\" textAlign=\"center\"/><Cell col=\"7\" text=\"bind:WRITER\" displaytype=\"mask\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" textAlign=\"center\"/><Cell col=\"8\" text=\"bind:WRITEDATE\" textAlign=\"center\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_cnt_ds_messageInfo","title1_01:0","0","140","34",null,null,null,null,null,null,this);
            obj.set_taborder("3");
        ...
        // User Script
        this.addIncludeScript("PCM01700T12.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM01700T12.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PCM01700T12.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PCM01700T12.xfdl","lib::lib_mtm.xjs");
        this.registerScript("PCM01700T12.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 인수등록 :: 전달사항 탭
         * 파일명 		: PCM01700T12.xfdl
         * 작성자 		: 김성현
         * 작성일 		: 2021.04.10
         *
         * 설  명		: 인수등록 :: 전달사항 탭
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
        	...
        	switch(trId) {
        		case "selectLotHistoryMessage":
        			console.log(this.ds_messageInfo.saveXML());
        			...
        			if (this.ds_messageInfo.getRowCount() > 0)
        			{
        				...
        				if (!isRealAllMessage)
        				{
        					...
        					this.ds_lotMessageInfo.copyData(this.ds_lotInfoData);
        ...
        this.fn_search = function ()
         {
        	...
        	this.ds_messageParam.setColumn(0, "LOTID", this.parent.parent.parent.parent.parent.div_work.form.div_search.form.edt_lotId.value);
        	this.ds_messageParam.setColumn(0, "PRODUCTDEFID", this.nfn_nvl(this.parent.parent.parent.parent.parent.ds_lotInfo.getColumn(0, "PRODUCTDEFID"), ""));
        	this.ds_messageParam.setColumn(0, "PRODUCTDEFVERSION", this.nfn_nvl(this.parent.parent.parent.parent.parent.ds_lotInfo.getColumn(0, "PRODUCTDEFVERSION"), ""));
        	this.ds_messageParam.setColumn(0, "PROCESSSEGMENTID", this.nfn_nvl(this.parent.parent.parent.parent.parent.ds_lotInfo.getColumn(0, "PROCESSSEGMENTID"), ""));
        	this.ds_messageParam.setColumn(0, "PROCESSSEGMENTVERSION", this.nfn_nvl(this.parent.parent.parent.parent.parent.ds_lotInfo.getColumn(0, "PROCESSSEGMENTVERSION"), ""));
        ...
        this.loadIncludeScript("PCM01700T12.xfdl");
