(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM01900T02");
            this.set_titletext("AOI 불량");
            ...
            obj = new Div("div_AOIDefectBtnItem","583","0",null,"34","40.86%",null,null,null,null,null,this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div_aoi","59.94%","0",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_url("dfm::DFM00100D.xfdl");
            this.addChild(obj.name, obj);

            obj = new Button("btn_AOIDefectMapLink",null,"6","86","24","5",null,null,null,null,null,this);
            obj.set_taborder("6");
        ...
        // User Script
        this.addIncludeScript("PCM01900T02.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM01900T02.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PCM01900T02.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PCM01900T02.xfdl","lib::lib_mtm.xjs");
        this.addIncludeScript("PCM01900T02.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PCM01900T02.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 작업종료 :: AOI 불량 탭
        ...
        this.getAOIDefectDataSource = function()
        {
        	for(var i = 0; i < this.ds_defectList.getRowCount(); i++)
        	{
        		...
        		//2021-06-18 불량코드+층별 불량수량이 LOT의 양품수량을 초과할 수 없음
        ...
        this.ds_defectList_oncolumnchanged = function(obj,e)
        {
        	...
        	{
        		if(e.newvalue=="005"){
        			var pcsQty = obj.getColumn(e.row, "PCSQTY");
        			obj.setColumn(e.row, "ANALYSISQTY", pcsQty);
        		} else {
        			obj.setColumn(e.row, "ANALYSISQTY", 0);
        		}

        		if(e.oldvalue != e.newvalue){
        			obj.setColumn(e.row, "DEFECTCODE", null);
        			obj.setColumn(e.row, "DEFECTCODENAME", null);
        		}
        ...
        // Lot Defect Map 조회화면으로 이동
        	...
        	var productDefName 		= this.nfn_nvl(this.ds_lotInfoData.getColumn(0, "PRODUCTDEFNAME"), "");
        	...
        	this.ds_param.setColumn(0, "PRODUCTDEFNAME", productDefName);
        ...
        this.loadIncludeScript("PCM01900T02.xfdl");
