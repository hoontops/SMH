(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM07600M");
            this.set_titletext("포장실적등록(BOE)");
            ...
            obj = new Static("sta_chkGoodQty","8.50%","134","72","20",null,null,null,null,null,null,this.div_work.form);
            obj.set_taborder("25");
            obj.set_text("합계");
            obj.set_cssclass("sta_WF_label");
            ...
            obj = new Static("sta_paperType","20.28%","134","80","20",null,null,null,null,null,null,this.div_work.form);
            obj.set_taborder("29");
            obj.set_text("용지타입");
            obj.set_cssclass("sta_WF_label");
            obj.set_tooltiptext("paperType");
            this.div_work.addChild(obj.name, obj);

            obj = new MaskEdit("msk_chkGoodQty","sta_chkGoodQty:10","134",null,"20","sta_paperType:10",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("26");
            obj.set_format("#,##0");
            obj.set_enable("false");
            obj.set_readonly("true");
            ...
            obj = new Static("sta_paperColor","32.12%","134","80","20",null,null,null,null,null,null,this.div_work.form);
            obj.set_taborder("32");
            obj.set_text("용지색상");
            obj.set_cssclass("sta_WF_label");
            obj.set_tooltiptext("paperColor");
            this.div_work.addChild(obj.name, obj);

            obj = new Combo("cbo_paperType","sta_paperType:8","134",null,"20","sta_paperColor:10",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("30");
            obj.set_codecolumn("C,paperType,,Y,Y");
            obj.set_text("전체");
            obj.set_value("");
            obj.set_index("-1");
            this.div_work.addChild(obj.name, obj);

            obj = new Static("sta_printPosition","44.51%","134","80","20",null,null,null,null,null,null,this.div_work.form);
            obj.set_taborder("33");
            obj.set_text("인쇄위치");
            obj.set_cssclass("sta_WF_label");
            obj.set_tooltiptext("printPosition");
            this.div_work.addChild(obj.name, obj);

            obj = new Combo("cbo_paperColor","sta_paperColor:10","134",null,"20","sta_printPosition:10",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("31");
            obj.set_codecolumn("C,paperColor,,Y,Y");
            obj.set_text("전체");
            obj.set_value("");
            obj.set_index("-1");
            this.div_work.addChild(obj.name, obj);

            obj = new Combo("cbo_printPosition","sta_printPosition:10","134","5.83%","20",null,null,null,null,null,null,this.div_work.form);
            obj.set_taborder("34");
            obj.set_codecolumn("C,printPosition,,Y,Y");
            obj.set_text("전체");
            obj.set_value("");
            obj.set_index("-1");
            this.div_work.addChild(obj.name, obj);

            obj = new Static("sta_inspectNum","cbo_printPosition:10","134","110","20",null,null,null,null,null,null,this.div_work.form);
            obj.set_taborder("35");
            obj.set_text("검사번호");
            obj.set_cssclass("sta_WF_label");
        ...
        // User Script
        this.addIncludeScript("PCM07600M.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PCM07600M.xfdl","lib::lib_mtm.xjs");
        this.registerScript("PCM07600M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 포장실적등록(BOE)
         * 파일명 		: PCM07600M.xfdl
        ...
        this.fn_save = function (obj, e)
        {
        	...
        	*/
        	...
        	//trace("필수 조건 확인(line) : "+strLine);
        	//trace("필수 조건 확인(main) : "+strMst);
        	...
        	*/
        	...
        	{
        		//cell
        		//var nGoodIdx = this.div_work.form.grd_line.getBindCellIndex("body","GOODQTY");
        		//var nGoodTitle = this.div_work.form.grd_line.getCellProperty("head",nGoodIdx,"text");
        		var nGoodTitle = "Line";
        		//var nQtyIdx = this.div_work.form.grd_lot.getBindCellIndex("body","QUANTITY");
        		//var nQtyTitle = this.div_work.form.grd_lot.getCellProperty("head",nQtyIdx,"text");
        		var nQtyTitle = "Lot";
        	...
        	if (errCD != 0)
        	{
        		if (trId == "savePackLabel")
        		{
        			...
        			// 21.05.10 3개짜리
        				...
        				//trace(" ====> : "+msgArray[0]+" || "+[msgArray[1]+" || "+msgArray[2]]);
        	...
        	switch(trId) {
        		...
        		******************************************************/
        		...
        		case "selectXoutPackInfoList": 						//[검사번호롤 - X_OUT 정보 조회 -> 포장 사양 정보 조회]  (21.06.10)
        			...
        			//trace(" === [1] === : "+this.ds_xoutPackInfo.saveXML());
        			//trace(" === [2] === : "+this.ds_xoutLotChk.saveXML());
            ...
            switch(sPopupId)
        	{
        		...
        		case "PACK_DTL" :
        			...
        			*/
        			...
        			this.ds_main.setColumn(nPos, "CUSTOMERPRODNAME", rtn[3]);		// 김정욱과장님 표시필요 없음	(21.04.16)
        		...
        		// XOUT_CUST_MODEL_NM
        		case "XOUT_CUST_MODEL_NM" :			// x out에 따른 포장기준정보 선택 팝업 후
        ...
        this.fn_openPop = function(svcId, popId, pArg)
        {
        	...
        	else if(popId=="P00249"){ //포장검사자 조회 (21.04.24) - 포장관리자만  (161 -> 249)
         ...
         * RD report 호출
         */
        this.fn_setRdReport = function (nName, nHdrId, nLineId, nHdrOneMain, nSrcNm, nPrintPosParam)
        {

        	// 넘길 파라미터 값 설정
        	var nParam = "";		//보통 HdrId, LineId
        	if(nName == 'pack06' || nName == 'pack05' || nName == 'pack09')		// 외부/내부/송화단
        	{
        	...
        	{
        		nParam = "'"+nHdrOneMain+"'";				// 불필요 ' 제거 21.04.20 (해당건은 필요함...)
        		//nParam = nHdrOneMain;				// 불필요 ' 제거 21.04.20
        	}
        	// 인쇄 위치 추가 nPrintPosParam
        	if(!this.gfn_isNull(nPrintPosParam))
        	{
        		nParam = nParam +"|"+ nPrintPosParam;
        	}
        	// 인쇄 위치.. 추가 부분
        	...
        	this.v_printValue = nName;			// 21.04.15 버튼명을 담는다(프린트 횟수때 사용)
        ...
        *******************************************************************************/
        ...
        this.div_work_div_search_btn_comp_onclick = function(obj,e)
        {
        	...
        	sArgs += this.gfn_setParam("PRGMNAME", 'Boe'); // 사양정보에 등록된 프로그램명
        ...
        this.dynamic_btn_onclick = function(obj,e)
        {
        	...
        	var nPrintPosParam	= "";		// 인쇄위치

        	// 용지타입
        	var nPaperType 	= this.div_work.form.cbo_paperType.value;
        	// 용지색상
        	var nPaperColor = this.div_work.form.cbo_paperColor.value;
        	// 인쇄 위치
        	var nPrintPos 	= this.div_work.form.cbo_printPosition.value;
        	/*****************************************
        	 * BOE의 경우 소스명 설정 해줘야됨.
        	 ******************************************/
        	if(nName == 'pack05' || nName == 'pack09')		// 외부라벨의 경우 체크 확인 , 송화단 출력
        	{
        		//trace(" (콤보값) ---> : "+nPaperType+" || "+nPaperColor+" || "+nPrintPos);
        		if(nPaperType == "P")	// A4인 경우 소스명 변경
        		{
        			nSrcNm 			= nPaperColor;
        			nPrintPosParam 	= nPrintPos;
        		}
        		//trace(" (소스) ---> : "+nSrcNm+" || "+nPrintPosParam);
        		// 외부 라벨의 경우 (체크 된 것만)
        	...
        	// rd 출력 부분
        	this.fn_setRdReport(nName, nHdrId, nLineId, nHdrOneMain, nSrcNm, nPrintPosParam);		// 인쇄 위치 추가
        ...
        this.div_work_grd_main_onexpanddown = function(obj,e)
        {
        	...
        	{
        		var sArgs = {};
        		this.fn_openPop("GRD_USER","P00249", sArgs);		// 포장 검사자  (21.04.24) - 포장관리자만  (161 -> 249)

        	}
        	if(e.cell == nPackingNameIdx)		// 21.04.13 포장작업자
        	{
        		var sArgs = {};
        		this.fn_openPop("GRD_PACK_USER","P00249", sArgs);		// 포장 검사자  (21.04.24) - 포장관리자만  (161 -> 249)
        ...
        */
        ...
        this.ds_main_cancolumnchange = function(obj,e)
        {
        	...
        	{
        		// 21.05.22
        		if(e.columnid == 'CHK')  this.ds_main.set_updatecontrol(true); //(21.06.05 오류 수정) //this.ds_line.set_updatecontrol(false);
        	}
        };
        /*
        ...
        **************************************************************************/
        ...
        /*
         * 인수된 LOT 중 검사번호가 존재 하는 것 조회 팝업(21.07.06)
         */
        ...
        this.loadIncludeScript("PCM07600M.xfdl");
