(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM03300M");
            this.set_titletext("일괄 작업시작");
            ...
            obj._setContents("<ColumnInfo><Column id=\"ENTERPRISEID\" type=\"STRING\" size=\"256\"/><Column id=\"PLANTID\" type=\"STRING\" size=\"256\"/><Column id=\"AREAID\" type=\"STRING\" size=\"256\"/><Column id=\"AREANAME\" type=\"STRING\" size=\"256\"/><Column id=\"LANGUAGETYPE\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDEFID\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDEFVERSION\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDEFNAME\" type=\"STRING\" size=\"256\"/><Column id=\"LOTID\" type=\"STRING\" size=\"256\"/><Column id=\"P_LOTID\" type=\"STRING\" size=\"256\"/><Column id=\"PROCESSSEGMENTID\" type=\"STRING\" size=\"256\"/><Column id=\"PROCESSSEGMENTNAME\" type=\"STRING\" size=\"256\"/><Column id=\"RESOURCEID\" type=\"STRING\" size=\"256\"/><Column id=\"STATE\" type=\"STRING\" size=\"256\"/><Column id=\"CONTROLTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"SPECCLASSID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">WaitForReceive</Col><Col id=\"NAME\">인수대기</Col></Row><Row><Col id=\"CODE\">Wait</Col><Col id=\"NAME\">인수</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_clear","171","205","102","36",null,null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btn_search","15","205","146","36",null,null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("1");
            ...
            obj = new Static("guidetip04",null,"185","45","20","91",null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("6");
            obj.set_text("h20");
            obj.set_visible("false");
            obj.set_cssclass("guideTip");
            ...
            obj = new Static("guidetip05","161","214","10","27",null,null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("7");
            obj.set_text("w\r\n10");
            obj.set_visible("false");
            obj.set_cssclass("guideTip");
            ...
            obj = new Combo("cbo_state","108","135",null,"20","15",null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("30");
            ...
            obj = new Static("guidetip03_00_00_00_00_00",null,"130","45","5","91",null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("31");
            obj.set_text("h5");
            obj.set_visible("false");
            obj.set_cssclass("guideTip");
            ...
            obj = new Static("staPROCESS00","0","135","103","20",null,null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("32");
            obj.set_text("상태");
            obj.set_cssclass("sta_WF_label_point");
            obj.set_tooltiptext("STATUS");
            this.tab_search.Tabpage1.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" displaytype=\"normal\" edittype=\"none\"/><Cell col=\"2\" text=\"설비ID\" tooltiptext=\"EQUIPMENTID\"/><Cell col=\"3\" text=\"설비명\" tooltiptext=\"EQUIPMENTNAME\"/><Cell col=\"4\" text=\"Lot 수\" tooltiptext=\"LOTCNT\"/><Cell col=\"5\" text=\"상태\" tooltiptext=\"STATE\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" edittype=\"checkbox\" displaytype=\"checkboxcontrol\" text=\"bind:CHK\"/><Cell col=\"2\" text=\"bind:EQUIPMENTID\" textAlign=\"left\" edittype=\"none\"/><Cell col=\"3\" text=\"bind:EQUIPMENTNAME\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:LOTCNT\" textAlign=\"right\"/><Cell col=\"5\" text=\"bind:STATE\"/></Band></Format></Formats>");
            ...
            obj = new BindItem("item10","tab_search.Tabpage1.form.cbo_state","value","ds_search","STATE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("PCM03300M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM03300M.xfdl","pcm::pcmCommon.xjs");
        this.addIncludeScript("PCM03300M.xfdl","lib::lib_tom.xjs");
        this.registerScript("PCM03300M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 일괄 작업시작
         * 파일명 		: PCM03300M.xfdl
         ...
         this.fn_init = function (obj, e)
        {
        	...
        	this.ds_search.setColumn(0, "STATE", "Wait");
        };
        ...
        this.fn_search = function (obj, e)
        {
        	...
        	var strColIdList = "edt_AREAID,edt_item,edt_process_id,cbo_state";
        	var strColNmList = "AREA,ITEMID,PROCESSSEGMENT,STATUS";
        ...
        this.fn_searchLotList = function()
        {
        	...
        	var sSvcID 			= "selectBatchTrackIn";
        	var sController 	= "/pcm03300/selectBatchTrackIn.do";
        ...
        this.fn_searchEquipment = function()
        {
        	...
        	var sSvcID 			= "selectEquipment";
        	var sController 	= "/pcm03300/selectOtherInfo.do";
        	var sInDatasets 	= "INPUT=ds_search";
        	var sOutDatasets  	= "ds_equipmentInfo=output3";
        	var sArgs 		  	= "";
        ...
        */
        ...
        this.fn_save = function (obj, e)
        {
        	...
        	//설비 필수값 체크
        	if(this.ds_equipmentInfo.getCaseCount("CHK=='1'") < 1){
        	...
        	for(var i=0; i<this.ds_equipmentInfo.rowcount; i++){
        		var chk	= this.ds_equipmentInfo.getColumn(i, "CHK");
        		if(chk=="1"){
        			equipmentId += ","+ this.ds_equipmentInfo.getColumn(i, "EQUIPMENTID");
        		}
        	}
        	...
        	this.ds_dataInfo.setColumn(0, "WORKERS", 			worker);
        	this.ds_dataInfo.setColumn(0, "LOTIDS", 			lotIds.substr(1));
        	this.ds_dataInfo.setColumn(0, "EQUIPMENTID", 		equipmentId.substr(1));
        	this.ds_dataInfo.setColumn(0, "COMMENT", 			comment);
        	this.ds_dataInfo.setColumn(0, "PROCESSSEGMENTID",	processSegmentId);

        	var sSvcID 			= "saveLotBatchTrackIn";
        	var sController 	= "/pcm03300/saveLotBatchTrackIn.do";
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
        	if (errCD < 0)
        	{
        		...
        		if(trId == "selectBatchTrackIn"){	/* Step1 : LOT 조회 */
        		...
        		} else if(trId == "selectEquipment"){
        			this.fn_searchOthers();
        		} else if(trId == "saveLotBatchTrackIn"){
        ...
        this.div_work_grd_lot_oncellclick = function(obj,e)
        {
        	if(e.row== e.oldrow)return;
        	this.fn_searchOthers();
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_work.form.grd_lot.addEventHandler("oncellclick",this.div_work_grd_lot_oncellclick,this);
        ...
        this.loadIncludeScript("PCM03300M.xfdl");
