(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM03200M");
            this.set_titletext("일괄 인수 등록");
            ...
            obj._setContents("<ColumnInfo><Column id=\"ENTERPRISEID\" type=\"STRING\" size=\"256\"/><Column id=\"PLANTID\" type=\"STRING\" size=\"256\"/><Column id=\"AREAID\" type=\"STRING\" size=\"256\"/><Column id=\"AREANAME\" type=\"STRING\" size=\"256\"/><Column id=\"LANGUAGETYPE\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDEFID\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDEFVERSION\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDEFNAME\" type=\"STRING\" size=\"256\"/><Column id=\"LOTID\" type=\"STRING\" size=\"256\"/><Column id=\"P_LOTID\" type=\"STRING\" size=\"256\"/><Column id=\"CONTROLTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"SPECCLASSID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"PLANTID\" type=\"STRING\" size=\"256\"/><Column id=\"WORKER\" type=\"STRING\" size=\"256\"/><Column id=\"LOTID\" type=\"STRING\" size=\"256\"/><Column id=\"PROCESSPATHID\" type=\"STRING\" size=\"256\"/><Column id=\"PROCESSSEGMENTID\" type=\"STRING\" size=\"256\"/><Column id=\"DEFECTUNIT\" type=\"STRING\" size=\"256\"/><Column id=\"GOODQTY\" type=\"STRING\" size=\"256\"/><Column id=\"GOODPNLQTY\" type=\"STRING\" size=\"256\"/><Column id=\"DEFECTQTY\" type=\"STRING\" size=\"256\"/><Column id=\"DEFECTPNLQTY\" type=\"STRING\" size=\"256\"/><Column id=\"COMMENT\" type=\"STRING\" size=\"256\"/><Column id=\"EQUIPMENTID\" type=\"STRING\" size=\"256\"/><Column id=\"ISBATCH\" type=\"STRING\" size=\"256\"/><Column id=\"VERSION\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staLOTID","0","60","103","20",null,null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("8");
            obj.set_text("Lot No.");
            ...
            obj = new Edit("edt_LOTID","108","60",null,"20","15",null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("10");
            this.tab_search.Tabpage1.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_AREAID_cd","108","168",null,"20","37",null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("16");
            obj.set_visible("false");
            obj.set_value("작업장ID");
            obj.set_text("작업장ID");
            ...
            obj = new Edit("edt_PRODUCTDEFID_cd","108","198",null,"20","37",null,null,null,null,null,this.tab_search.Tabpage1.form);
            obj.set_taborder("17");
            obj.set_visible("false");
            this.tab_search.Tabpage1.addChild(obj.name, obj);
            ...
            obj = new Button("btn_worker","226","5","22","20",null,null,null,null,null,null,this.div_work.form.Div01.form);
            obj.set_taborder("3");
            obj.set_cssclass("btn_WF_finder");
            this.div_work.form.Div01.addChild(obj.name, obj);

            obj = new Static("label10","btn_worker:0","0","84","30",null,null,null,null,null,null,this.div_work.form.Div01.form);
            obj.set_taborder("1");
            obj.set_text("특이사항");
            ...
            obj = new Static("label01","5","5","85","20",null,null,null,null,null,null,this.div_work.form.Div01.form);
            obj.set_taborder("4");
            obj.set_text("작업자");
            ...
            obj = new Edit("edt_worker","label01:5","5","131","20",null,null,null,null,null,null,this.div_work.form.Div01.form);
            obj.set_taborder("2");
            this.div_work.form.Div01.addChild(obj.name, obj);
            ...
            obj = new Tab("tab","0","Div01:5",null,null,"0","20",null,null,null,null,this.div_work.form);
            obj.set_taborder("2");
            obj.set_tabindex("0");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"설비ID\" tooltiptext=\"EQUIPMENTID\"/><Cell col=\"2\" text=\"설비명\" tooltiptext=\"EQUIPMENTNAME\"/><Cell col=\"3\" text=\"Lot 수\" tooltiptext=\"LOTCNT\"/><Cell col=\"4\" text=\"상태\" tooltiptext=\"STATE\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:EQUIPMENTID\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:EQUIPMENTNAME\" textAlign=\"left\"/><Cell col=\"3\"/><Cell col=\"4\"/></Band></Format></Formats>");
        ...
        // User Script
        this.addIncludeScript("PCM03200M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM03200M.xfdl","pcm::pcmCommon.xjs");
        this.addIncludeScript("PCM03200M.xfdl","lib::lib_tom.xjs");
        this.registerScript("PCM03200M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 일괄 인수 등록
         * 파일명 		: PCM03200M.xfdl
         ...
         this.fn_init = function (obj, e)
        {
        	...
        	this.div_work.form.Div01.form.edt_worker.set_value(this.gf_getUserNm());
        	this.div_work.form.Div01.form.edt_worker_id.set_value(this.gf_getUserId());
        ...
        this.fn_searchLotList = function()
        {
        	...
        	var sSvcID 			= "selectBatchAccept";
        	var sController 	= "/pcm03200/selectBatchAccept.do";
        ...
        this.fn_searchOthers = function()
        {
        	...
        	for(var i=0; i<this.ds_lotList.rowcount; i++){
        		...
        		if(chk=="1"){
        			...
        			segmentId = this.ds_lotList.getColumn(i, "PROCESSSEGMENTID");
        			continue;
        		}
        	}

        	if(this.g_processSegmentId != segmentId){
        		this.g_processSegmentId = segmentId;
        		...
        		var sController 	= "/pcm03200/selectOtherInfo.do";
        		var sInDatasets 	= "INPUT=ds_search";
        ...
        */
        ...
        this.fn_save = function (obj, e)
        {
        	...
        	var worker 	= this.div_work.form.Div01.form.edt_worker_id.value;
        	...
        	//작업자 필수
        	if(this.nfn_isNull(worker)) {
        		this.gfn_Message("WorkerIsRequired", "", "warning", "ok");
        		return;
        	}
        	...
        	this.ds_dataInfo.setColumn(0, "LOTID", 			lotIds.substr(1));
        	this.ds_dataInfo.setColumn(0, "DEFECTQTY", 		0);
        	this.ds_dataInfo.setColumn(0, "COMMENT", 		comment);
        	this.ds_dataInfo.setColumn(0, "ISBATCH", 		"Y");
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
        	if (errCD < 0)
        	{
        		...
        		if(trId == "selectBatchAccept"){	/* Step1 : LOT 조회 */
        ...
        this.fn_openPop = function(svcId, popId, pArg)
        {
        	...
        	if(svcId =="SCH_ITEM"){
        		...
        		var processDefId = this.tab_search.Tabpage1.form.edt_PRODUCTDEFID.value
        ...
        this.fn_popupAfter = function(sPopupId, Variant)
        {
        	...
        	if(sPopupId == "SEARCH_WorkerByProcess"){
        		this.div_work.form.Div01.form.edt_worker.set_value(rtn[1]);
        		this.div_work.form.Div01.form.edt_worker_id.set_value(rtn[0]);
        	}
        };
         ...
         * 8. 이벤트
         ***************************************************************************/
        this.ds_lotList_cancolumnchange = function(obj,e)
        {
        	if(e.columnid=="CHK"){
        		var processSegmentId	= obj.getColumn(e.row, "PROCESSSEGMENTID");
        		var chkCnt = obj.getCaseCount("CHK=='1' && PROCESSSEGMENTID !='"+ processSegmentId +"'");
        		if(chkCnt>0){
        			// 다른 공정은 선택할 수 없습니다.
        ...
        this.ds_lotList_oncolumnchanged = function(obj,e)
        {
        ...
        this.div_work_tab_Tabpage1_grd_lot_onheadclick = function(obj,e)
        {
        	...
        	if(e.col==1){ //CHK
        		var chk = obj.getCellProperty("head", e.cell, "text");
        		var processSegmentId	= this.ds_lotList.getColumn(0, "PROCESSSEGMENTID");
        		if(chk!="1"){
        			var chkCnt = this.ds_lotList.getCaseCount("PROCESSSEGMENTID !='"+ processSegmentId +"'");
        			if(chkCnt>0){
        				// 다른 공정은 선택할 수 없습니다.
        				this.gfn_Message("MixSelectProcesssegmentname", null, "warning", "ok");
        				return false;
        		...
        		for(var i=0; i<this.ds_lotList.rowcount;i++){
        			this.ds_lotList.setColumn(i, "CHK", chk=="1" ? null : "1");
        		}

        		obj.setCellProperty("head", e.cell, "text", chk=="1" ? null : "1");
        	}
        	return true;
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_work.form.Div01.form.btn_worker.addEventHandler("onclick",this.btn_workerSrh_onclick,this);
            this.div_work.form.Div01.form.edt_worker.addEventHandler("onkeydown",this.edt_worker_onkeydown,this);
            ...
            this.ds_lotList.addEventHandler("cancolumnchange",this.ds_lotList_cancolumnchange,this);
            this.ds_lotList.addEventHandler("oncolumnchanged",this.ds_lotList_oncolumnchanged,this);
        ...
        this.loadIncludeScript("PCM03200M.xfdl");
