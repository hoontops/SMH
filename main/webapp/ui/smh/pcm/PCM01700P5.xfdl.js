(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_title","1.67%","4",null,"21","41.67%",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("타이틀명");
            ...
            obj = new Combo("cbo_srh","3","6","130","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            ...
            obj = new Edit("edt_srh","136","6","190","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("0");
            obj.set_font("9pt \"Dotum\"");
            ...
            obj = new Grid("grd_result","6","95",null,null,"10","75",null,null,null,null,this);
            obj.set_taborder("4");
        ...
        // User Script
        this.registerScript("PCM01700P5.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 공통팝업
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
        	...
        	else
        	{
        		...
        		else if (trId == "selectCmdPopupPlsList")
        		{
        			...
        			if (this.parent.arg_type=="AA" || this.parent.arg_type=="BA" || this.parent.arg_type=="CA")
        			{
        				//검색조건 값 있을 경우 자동조회
        		...
        		else if (trId == "selectList")
        		{
        			...
        			if(this.ds_result.rowcount==1) this.grd_result_oncelldblclick();
        			// }
        		}
        ...
        ***************************************************************************/
        ...
        this.loadIncludeScript("PCM01700P5.xfdl");
