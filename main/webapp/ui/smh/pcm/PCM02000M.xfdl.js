(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM02000M");
            this.set_titletext("작업완료 취소");
        ...
        // User Script
        this.addIncludeScript("PCM02000M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM02000M.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PCM02000M.xfdl", function() {
        ...
        this.fn_LotCanCelList = function()
        {
        	...
        	this.ds_search.setColumn(sRow, "PROCESSSTATE", "WaitForSend");
        	this.ds_search.setColumn(sRow, "PREVPROCESSSTATE", "Run");
        	this.ds_search.setColumn(sRow, "TRANSITTYPE", "TrackOutCancel");


        	var sSvcID 			= "selectLotListForWorkEndCancel";
        	var sController 	= "/pcm02000/selectLotListForWorkEndCancel.do";
        ...
        this.fn_save = function(obj,e)
        {
        	...
        	// -------------------------
        	var sSvcID 			= "savePcmLotWorkEndCancel";
        	var sController 	= "/pcm02000/savePcmLotWorkEndCancel.do";
        	var sInDatasets 	= "ds_pcmLotCancel=ds_pcmLotCancel:U ds_comment=ds_comment:U";
        	var sOutDatasets 	= "";
        	var sArgs 			= "";
        	this.gfn_transaction(sSvcID, sController, sInDatasets, sOutDatasets, sArgs);
        };
        ...
        this.loadIncludeScript("PCM02000M.xfdl");
