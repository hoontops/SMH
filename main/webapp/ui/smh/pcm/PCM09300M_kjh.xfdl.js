(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CLOSEDATE\" type=\"STRING\" size=\"256\"/><Column id=\"CONSUMABLEDEFID\" type=\"STRING\" size=\"256\"/><Column id=\"CONSUMABLEDEFVERSION\" type=\"STRING\" size=\"256\"/><Column id=\"CONSUMABLEDEFNAME\" type=\"STRING\" size=\"256\"/><Column id=\"UNIT\" type=\"STRING\" size=\"256\"/><Column id=\"USEDLOTID\" type=\"STRING\" size=\"256\"/><Column id=\"USEDPRODUCTDEFID\" type=\"STRING\" size=\"256\"/><Column id=\"USEDPRODUCTDEFNAME\" type=\"STRING\" size=\"256\"/><Column id=\"CONSUMABLELOTID\" type=\"STRING\" size=\"256\"/><Column id=\"INQTY\" type=\"STRING\" size=\"256\"/><Column id=\"CONSUMABLELOTQTY\" type=\"STRING\" size=\"256\"/><Column id=\"CONSUMEDQTY\" type=\"STRING\" size=\"256\"/><Column id=\"REQUESTNO\" type=\"STRING\" size=\"256\"/><Column id=\"TRANSACTIONCODEID\" type=\"STRING\" size=\"256\"/><Column id=\"TRANSACTIONCODE\" type=\"STRING\" size=\"256\"/><Column id=\"AREAID\" type=\"STRING\" size=\"256\"/><Column id=\"AREANAME\" type=\"STRING\" size=\"256\"/><Column id=\"WAREHOUSEID\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"P_INBOUNDDATE_PERIODFR\" type=\"STRING\" size=\"256\"/><Column id=\"P_INBOUNDDATE_PERIODTO\" type=\"STRING\" size=\"256\"/><Column id=\"USERID\" type=\"STRING\" size=\"256\"/><Column id=\"P_AREAID\" type=\"STRING\" size=\"256\"/><Column id=\"P_CONSUMABLEDEFID\" type=\"STRING\" size=\"256\"/><Column id=\"P_CONSUMENAME\" type=\"STRING\" size=\"256\"/><Column id=\"P_PLANTID\" type=\"STRING\" size=\"256\"/><Column id=\"P_MATERIALTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"P_TRANSACTIONCODE\" type=\"STRING\" size=\"256\"/><Column id=\"P_CONSUMABLELOT\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_site","0","60","103","20",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("3");
            obj.set_text("Site");
            ...
            obj = new Combo("cbo_site","108","60","165","20",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("0");
            ...
            obj = new Button("btn_searchClear","171","226","102","36",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btn_search","15","226","146","36",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("1");
            ...
            obj = new Static("Static12_00_00_00_01_00_00",null,"206","45","20","91",null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("8");
            obj.set_text("h20");
            obj.set_visible("false");
            obj.set_cssclass("guideTip");
            ...
            obj = new Combo("cbo_periodType","13","35","94","20",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("11");
            ...
            obj = new Calendar("cal_endDt","108","35",null,"20","15",null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("12");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_value("20210104");
            this.tab_search.tab_page.addChild(obj.name, obj);

            obj = new Calendar("cal_startDt","108","10",null,"20","15",null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("13");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_value("20210104");
            this.tab_search.tab_page.addChild(obj.name, obj);

            obj = new Static("sta_areaName","0","85","103","20",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("14");
            obj.set_text("작업장");
            obj.set_cssclass("sta_WF_label");
            ...
            obj = new Edit("edt_areaName","108","85",null,"20","37",null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("15");
            this.tab_search.tab_page.addChild(obj.name, obj);

            obj = new Static("sta_consumableDftId","0","110","103","20",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("16");
            obj.set_text("자재코드");
            obj.set_cssclass("sta_WF_label");
            ...
            obj = new Edit("edt_consumableDftId","108","110",null,"20","37",null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("17");
            this.tab_search.tab_page.addChild(obj.name, obj);

            obj = new Button("btn_areaName",null,"85","22","20","15",null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("18");
            obj.set_cssclass("btn_WF_finder");
            this.tab_search.tab_page.addChild(obj.name, obj);

            obj = new Button("btn_consumableDftId",null,"110","22","20","15",null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("19");
            obj.set_cssclass("btn_WF_finder");
            this.tab_search.tab_page.addChild(obj.name, obj);

            obj = new Static("sta_materialType","0","165","103","20",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("20");
            obj.set_text("자재구분");
            obj.set_cssclass("sta_WF_label");
            ...
            obj = new Combo("cbo_materialType","108","165","165","20",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("21");
            obj.set_codecolumn("C,MaterialType,ALL,Y,A");
            this.tab_search.tab_page.addChild(obj.name, obj);

            obj = new Static("sta_consumableLot","0","190","103","20",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("22");
            obj.set_text("자재 LOT 코드");
            obj.set_cssclass("sta_WF_label");
            obj.set_tooltiptext("055648C6043F4087B45C7A894C8A34BE");
            this.tab_search.tab_page.addChild(obj.name, obj);

            obj = new Edit("edt_consumableLot","108","190","165","20",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("23");
            this.tab_search.tab_page.addChild(obj.name, obj);

            obj = new Edit("edt_mtrNm","108","137","165","20",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("24");
            this.tab_search.tab_page.addChild(obj.name, obj);

            obj = new Static("sta_mtrNm","0","137","103","20",null,null,null,null,null,null,this.tab_search.tab_page.form);
            obj.set_taborder("25");
            obj.set_text("자재명");
            obj.set_cssclass("sta_WF_label");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"130\"/><Column size=\"100\"/><Column size=\"50\"/><Column size=\"200\"/><Column size=\"50\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"150\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"처리일자\" tooltiptext=\"CLOSEDATE\"/><Cell col=\"2\" text=\"자재 ID\"/><Cell col=\"3\" text=\"자재버전\"/><Cell col=\"4\" text=\"자재명\"/><Cell col=\"5\" text=\"단위\"/><Cell col=\"6\" text=\"자재 LOT No\"/><Cell col=\"7\" text=\"사용된 Lot No\"/><Cell col=\"8\" text=\"사용된 품목코드\"/><Cell col=\"9\" text=\"사용된 품목명\"/><Cell col=\"10\" text=\"인수수량\"/><Cell col=\"11\" text=\"소모 수량\"/><Cell col=\"12\" text=\"현재 수량\"/><Cell col=\"13\" text=\"거래유형코드\"/><Cell col=\"14\" text=\"창고ID\"/><Cell col=\"15\" text=\"작업장\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:CLOSEDATE\"/><Cell col=\"2\" text=\"bind:CONSUMABLEDEFID\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:CONSUMABLEDEFVERSION\"/><Cell col=\"4\" text=\"bind:CONSUMABLEDEFNAME\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:UNIT\"/><Cell col=\"6\" text=\"bind:CONSUMABLELOTID\"/><Cell col=\"7\" text=\"bind:USEDLOTID\" textAlign=\"center\"/><Cell col=\"8\" text=\"bind:USEDPRODUCTDEFID\" textAlign=\"left\"/><Cell col=\"9\" text=\"bind:USEDPRODUCTDEFNAME\" textAlign=\"left\"/><Cell col=\"10\" text=\"bind:INQTY\" textAlign=\"right\" displaytype=\"mask\" maskeditformat=\"#,##0.##\"/><Cell col=\"11\" text=\"bind:CONSUMEDQTY\" textAlign=\"right\" displaytype=\"mask\" maskeditformat=\"#,##0.##\"/><Cell col=\"12\" text=\"bind:CONSUMABLELOTQTY\" textAlign=\"right\" displaytype=\"mask\" edittype=\"none\" maskeditformat=\"#,##0.##\"/><Cell col=\"13\" text=\"bind:TRANSACTIONCODE\" textAlign=\"left\"/><Cell col=\"14\" text=\"bind:WAREHOUSEID\" textAlign=\"left\"/><Cell col=\"15\" text=\"bind:AREANAME\" textAlign=\"left\"/></Band></Format></Formats>");
        ...
        // User Script
        this.addIncludeScript("PCM09300M_kjh.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PCM09300M_kjh.xfdl","lib::lib_mtm.xjs");
        this.registerScript("PCM09300M_kjh.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 자재사용이력
         * 파일명 		: PCM09300M.xfdl
         ...
         * 작업장 팝업 클릭시
         */
        this.tab_search_tab_page_btn_areaName_onclick = function(obj,e)
        {
        	var sArgs = {};
        ...
        this.on_initEvent = function()
        {
            ...
            this.tab_search.tab_page.form.btn_areaName.addEventHandler("onclick",this.tab_search_tab_page_btn_areaName_onclick,this);
        ...
        this.loadIncludeScript("PCM09300M_kjh.xfdl");
