(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM02600M");
            this.set_titletext("작업시작 취소");
        ...
        // User Script
        this.addIncludeScript("PCM02600M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM02600M.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PCM02600M.xfdl", function() {
        ...
        this.loadIncludeScript("PCM02600M.xfdl");
