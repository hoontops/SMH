(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM01700P1");
            this.set_titletext("채공 사유 입력");
            if (Form == this.constructor)
            {
                this._setFormPosition(556,409);
            }
            ...
            obj = new Grid("grd_staying","20","94","516","90",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_binddataset("ds_dtStaying");
            obj.set_autoenter("select");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"120\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"채공기준 시간\" tooltiptext=\"STDSTAYINGTIME\"/><Cell col=\"1\" text=\"현상태 채공\" tooltiptext=\"STATEDELAYTIME\"/><Cell col=\"2\" text=\"이전스탭 완료시간\" tooltiptext=\"PRVSTEPCOMPTIME\"/><Cell col=\"3\" text=\"현재시간\" tooltiptext=\"NOWTIME\"/></Band><Band id=\"body\"><Cell text=\"bind:STAYINGLOCKSTD\"/><Cell col=\"1\" text=\"bind:CURRENTSTATESTAYINGTIMECNV\"/><Cell col=\"2\" text=\"bind:CHECKTIME\"/><Cell col=\"3\" text=\"bind:CUR_TIME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Div("div_00","20","20","516","45",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("div_00");
            obj.set_cssclass("div_guide");
            this.addChild(obj.name, obj);

            obj = new Static("sta_title","20","12","476","20",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("0");
            ...
            obj = new Static("title2","20","65","38","34",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("목록");
            ...
            obj = new Div("div_save","20","199","516","152",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_cssclass("div_WF_detail");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("sta_delayCode","0","10","100","20",null,null,null,null,null,null,this.div_save.form);
            obj.set_taborder("0");
            obj.set_text("체공사유");
            obj.set_cssclass("sta_WF_detailLabel2");
            this.div_save.addChild(obj.name, obj);

            obj = new Static("sta_comment","0","35","100","20",null,null,null,null,null,null,this.div_save.form);
            obj.set_taborder("1");
            obj.set_text("특이사항");
            obj.set_cssclass("sta_WF_detailLabel2");
            this.div_save.addChild(obj.name, obj);

            obj = new Combo("cbo_delayCode","105","10","200","20",null,null,null,null,null,null,this.div_save.form);
            obj.set_taborder("2");
            ...
            obj = new TextArea("txt_comment","105","35","399","105",null,null,null,null,null,null,this.div_save.form);
            obj.set_taborder("3");
            this.div_save.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",556,409,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("PCM01700P1.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM01700P1.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PCM01700P1.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PCM01700P1.xfdl","lib::lib_mtm.xjs");
        this.registerScript("PCM01700P1.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 공통팝업
         * 파일명 		: PCM01700P1.xfdl
        ...
        this.loadIncludeScript("PCM01700P1.xfdl");
