(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM09700M");
            this.set_titletext("다중분할 작업완료");
            ...
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"AREAID\" type=\"STRING\" size=\"256\"/><Column id=\"AREANAME\" type=\"STRING\" size=\"256\"/><Column id=\"LOTID\" type=\"STRING\" size=\"256\"/><Column id=\"PROCESSSTATE\" type=\"STRING\" size=\"256\"/><Column id=\"ENTERPRISEID\" type=\"STRING\" size=\"256\"/><Column id=\"PLANTID\" type=\"STRING\" size=\"256\"/><Column id=\"LANGUAGETYPE\" type=\"STRING\" size=\"256\"/><Column id=\"VERSION\" type=\"STRING\" size=\"256\"/><Column id=\"SQL_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MIDDLESEGMENTCLASSID\" type=\"STRING\" size=\"256\"/><Column id=\"ISMODIFY\" type=\"STRING\" size=\"256\"/><Column id=\"TRANSITAREA\" type=\"STRING\" size=\"256\"/><Column id=\"RESOURCEID\" type=\"STRING\" size=\"256\"/><Column id=\"EQUIPMENTTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"DETAILEQUIPMENTTYPE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"LOTID\" type=\"STRING\" size=\"256\"/><Column id=\"EQUIPMENTLIST\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"TRANSITAREA\" type=\"STRING\" size=\"256\"/><Column id=\"RESOURCEID\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("ds_defectG", this);
            obj._setContents("<ColumnInfo><Column id=\"LOTID\" type=\"STRING\" size=\"256\"/><Column id=\"DEFECTQTY\" type=\"BIGDECIMAL\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("label01","26.04%","10","80","20",null,null,null,null,null,null,this.div_work.form.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("Lot No.");
            obj.set_cssclass("sta_WF_label_point");
            ...
            obj = new Edit("edt_lotId","label01:10","10","17.36%","20",null,null,null,null,null,null,this.div_work.form.divSearch.form);
            obj.set_taborder("4");
            ...
            obj = new Static("title1_01","0","0","80","34",null,null,null,null,null,null,this.div_work.form.tab.Tabpage5.form);
            obj.set_taborder("0");
            obj.set_text("설비");
            ...
            obj = new Grid("grdInspectionList","0","34",null,null,"0","0",null,null,null,null,this.div_work.form.tab.Tabpage1.form);
            obj.set_taborder("0");
            obj.set_autoenter("select");
            ...
            obj = new Button("btnAddRow_ds_InspectionList",null,"6","26","24","26",null,null,null,null,null,this.div_work.form.tab.Tabpage1.form);
            obj.set_taborder("2");
            obj.set_cssclass("btn_WF_grdAdd");
            obj.set_tooltiptext("추가");
            this.div_work.form.tab.Tabpage1.addChild(obj.name, obj);

            obj = new Button("btn_customdelRow",null,"6","26","24","0",null,null,null,null,null,this.div_work.form.tab.Tabpage1.form);
            obj.set_taborder("3");
        ...
        // User Script
        this.addIncludeScript("PCM09700M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM09700M.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PCM09700M.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PCM09700M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 다중분할 작업완료
         * 파일명 		: PCM07700M.xfdl
        ...
        this.fn_save = function(obj,e)
        {
        	...
        	this.ds_body.addRow();
        	this.ds_body.setColumn(0,"EQUIPMENTLIST",equipmentId);
        	...
        	// -------------------------
        	var sSvcID 			= "saveMultiLotWorkEnd";
        	var sController 	= "/pcm09700/saveMultiLotWorkEnd.do";
        	var sInDatasets 	= "body=ds_body lotlist=ds_lotListSave:U defectList=ds_InspectionList defectLot=ds_defectLot";
        	var sOutDatasets 	= "";
        	var sArgs 			= "";
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
        	if (errCD < 0)
        	{
        		...
        		if (trId == "selectWIPMultiStateList") {
        			...
        			this.ds_lotList.setColumn(0,"CHK","1");
        			...
        			if (this.ds_lotInfo.getRowCount() < 1)
        			{
        				...
        				var sController 	= "/pcm09700/GetEquipmentByArea.do";
        		...
        		} else if(trId =="saveMultiLotWorkEnd"){
        			...
        			this.pdv_ReasonProcessSegment.trackPopup(this.nLeft, this.nTop,  this.pdv_ReasonProcessSegment.width, this.pdv_ReasonProcessSegment.height, "fn_Callback_pdv_ReasonProcessSegment");
        				...
        				// 데이터가 하나면 자동 체크
        				if(this.ds_equipment.rowcount==1){
        					this.ds_equipment.setColumn(0,"CHK","1");
        				}
        		}
        ...
        this.fn_searchWIP = function()
        {
        	...
        	this.ds_search.setColumn(0, "PLANTID", 			this.gf_getSiteType());
        	this.ds_search.setColumn(0, "LANGUAGETYPE", 	this.gf_getLanguageType());
        	this.ds_search.setColumn(0, "PROCESSSTATE", 	this.Constants.Run);

        	var sSvcID 			= "selectWIPMultiStateList";
        	var sController 	= "/pcm09700/selectWIPMultiStateList.do";
        	var sInDatasets 	= "INPUT=ds_search";
        ...
        this.fn_searchKeyInfo = function()
        {
        	...
        	var sController 	= "/pcm09700/selectCustomQuery.do";
        	var sInDatasets 	= "INPUT=ds_search";
        ...
        {
        	if(e.columnid=="QTY"){
        		for(var i=0; this.obj.rowcount; i++){
        			if(this.ds_defectG.findRow("LOTID",obj.getColumn(e.row,"LOTID"))<0){
        				var nRow = this.ds_defectG.addRow();
        				this.ds_defectG.setColumn(nRow,"LOTID",obj.getColumn(e.row,"LOTID"));
        				var defectQty = nexacro.toNumber(this.nfn_nvl(this.ds_InspectionList.getCaseSum("LOTID=='"+obj.getColumn(e.row,"LOTID")+"'","QTY"),0));
        				this.ds_defectG.setColumn(nRow,"DEFECTQTY",defectQty);
        			}
        		}

        		// Lot 수량과 Defect SUM Qty 비교
        		var defectQty = nexacro.toNumber(this.nfn_nvl(obj.getCaseSum("LOTID=='"+obj.getColumn(e.row,"LOTID")+"'","QTY"),0));
        		if(this.ds_lotList.findRowExpr("LOTID=='"+obj.getColumn(e.row,"LOTID")+"' && QTY<"+defectQty)>=0){
        			obj.setColumn(e.row,"QTY","");
        			obj.setColumn(e.row,"PNLQTY","");
        			obj.setColumn(e.row,"DEFECTRATE","");
        			// 불량 수량은 Lot 수량보다 많을 수 없습니다. {0}
        			this.gfn_Message("LotQtyLargerThanDefectQty", null, "info", "ok");
        		}
        		for(var i=0; this.ds_defectG.rowcount; i++){
        			var nRow = this.ds_lotList.findRow("LOTID",this.ds_defectG.getColumn(i,"LOTID"));
        			this.ds_lotList.setColumn(nRow,"DEFECTQTY",this.ds_defectG.getColumn(i,"DEFECTQTY"));
        		}
        	}
        };
        ...
        this.grdInspectionList_onexpandup = function(obj,e)
        {
        	...
        	this.nLeft = system.screenToClientX(nexacro.getApplication().mainframe, nLeft);
        	this.nTop = system.screenToClientY(nexacro.getApplication().mainframe, nTop);
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_work.form.tab.Tabpage1.form.grdInspectionList.addEventHandler("onkeydown",this.div_work_tab_main_tpgDefect_grdInspectionList_onkeydown,this);
            ...
            this.ds_defectLot.addEventHandler("oncolumnchanged",this.ds_defect_oncolumnchanged,this);
            this.ds_InspectionList.addEventHandler("oncolumnchanged",this.ds_InspectionList_oncolumnchanged,this);
        };
        this.loadIncludeScript("PCM09700M.xfdl");
