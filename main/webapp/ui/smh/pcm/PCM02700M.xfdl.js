(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("PCM02700M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM02700M.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PCM02700M.xfdl", function() {
        ...
        this.fn_LotCanCelList = function()
        {
           ...
           // this.ds_search.clearData();
        	...
        	var sController 	= "/pcm02700/selectLotListForSendCancel.do";
        ...
        this.loadIncludeScript("PCM02700M.xfdl");
