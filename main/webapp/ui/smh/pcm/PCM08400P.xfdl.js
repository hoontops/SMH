(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("포장실적조회_포장관리 품목코드조회 팝업");
            ...
            obj._setContents("<ColumnInfo><Column id=\"PRODUCTDEFID\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDEFNAME\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDEFVERSION\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDEFTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDEFTYPE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTIONTYPE\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTIONTYPE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"UNIT\" type=\"STRING\" size=\"256\"/><Column id=\"UNIT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDEF\" type=\"STRING\" size=\"256\"/><Column id=\"CHK\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"TXTPRODUCTDEFNAME\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTDIVISION\" type=\"STRING\" size=\"256\"/><Column id=\"PRODUCTIONTYPE\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_type","309","10","80","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("제품구분");
            ...
            obj = new Combo("cbo_type","391","10","200","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_enable("true");
            ...
            obj = new Static("sta_itemCodeNm","0","10","99","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new Edit("edt_itemCodeNm","109","10","200","20",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Grid("grd_itemList","20","96",null,"336","20",null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_autoenter("select");
            obj.set_binddataset("ds_itemList");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"48\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"100\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"2\" text=\"품목코드\" tooltiptext=\"ITEMID\"/><Cell col=\"3\" text=\"품목명\" tooltiptext=\"ITEMNAME\"/><Cell col=\"4\" text=\"Rev\" tooltiptext=\"PRODUCTDEFVERSION\"/><Cell col=\"5\" text=\"품목유형구분\" tooltiptext=\"PRODUCTDEFTYPE\"/><Cell col=\"6\" text=\"생산구분\" tooltiptext=\"PRODUCTIONTYPENAME\"/><Cell col=\"7\" text=\"단위\" tooltiptext=\"UNIT\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"2\" text=\"bind:PRODUCTDEFID\" textAlign=\"left\" displaytype=\"normal\" edittype=\"none\"/><Cell col=\"3\" text=\"bind:PRODUCTDEFNAME\" textAlign=\"left\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"4\" text=\"bind:PRODUCTDEFVERSION\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:PRODUCTDEFTYPE_NM\" textAlign=\"left\"/><Cell col=\"6\" text=\"bind:PRODUCTIONTYPE_NM\" textAlign=\"left\"/><Cell col=\"7\" text=\"bind:UNIT_NM\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.addIncludeScript("PCM08400P.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PCM08400P.xfdl","lib::lib_mtm.xjs");
        this.registerScript("PCM08400P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 품목코드 조회(포장실적조회)
         * 파일명 		: PCM08400P.xfdl
        ...
        this.fn_search = function (obj, e)
        {
        	...
        	var sController 	= "/pcm08400/selectProductDefinitionList.do";		// 다른쪽에서 생성 한것 가져다 활용(x) chk 박스 필요
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
        	...
        	switch(trId) {
        		case "selectTypeList":				//[조회조건] 제품구분 Callback
        			this.searchDiv.cbo_type.set_value("Product");
        			break;
        		case "selectProductDefinitionList":	//[메인조회] 품목코드 list
        ...
        this.loadIncludeScript("PCM08400P.xfdl");
