(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("PCM04400M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM04400M.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PCM04400M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: LOT 불량처리
         * 파일명 		: PCM04400M.xfdl
        ...
        */
        ...
        trace('fn_callBack trId ?' + trId);
...

        	{
        		...
        		case "selectWIPList" :
        		{
        			this.ds_search.setColumn(0,"SEGMENT_DEFECTCODE","");
        			this.ds_search.setColumn(0,"SEGMENT_DEFECTNAME","");
        			break;
        		}
        		default:
        		}
        ...
        this.mfn_OpenDefectPopup = function ()
        {
        	...
        	var defectID = this.pfn_allTrim(this.ds_DefectList.getColumn(nRow,"DEFECTCODE"));
        	var qcSegmentID = this.pfn_allTrim(this.ds_DefectList.getColumn(nRow,"QCSEGMENTID"));
        	...
        	oArg.arg_searchStr = this.nfn_isNull(defectID) ? "" : "DEFECTCODENAME=" + defectID + "|QCSEGMENTIDNAME="+qcSegmentID;
        ...
        this.ds_TargetAll_onrowsetchanged = function(obj,e)
        {
        	if(e.reason == Dataset.REASON_DELETE && this.ds_TargetAll.rowcount == 0){
        		this.ds_search.setColumn(0,"SEGMENT_DEFECTCODE","");
        		this.ds_search.setColumn(0,"SEGMENT_DEFECTNAME","");
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.ds_TargetAll.addEventHandler("onrowsetchanged",this.ds_TargetAll_onrowsetchanged,this);
        ...
        this.loadIncludeScript("PCM04400M.xfdl");
