(function()
{
    return function()
    {
        ...
        {
            this.set_name("PCM01700T11");
            this.set_titletext("설비가동현황");
            ...
            obj._setContents("<ColumnInfo><Column id=\"STATEMODELID\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("PCM01700T11.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PCM01700T11.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PCM01700T11.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PCM01700T11.xfdl","lib::lib_mtm.xjs");
        this.registerScript("PCM01700T11.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 인수등록 :: 설비가동현황 탭
         * 파일명 		: PCM01700T11.xfdl
         * 작성자 		: 김성현
         * 작성일 		: 2021.04.10
         *
         * 설  명		: 인수등록 :: 설비가동현황 탭
        ...
        this.fn_initCombo = function ()
        {
        	...
        	this.ds_search.setColumn(0, "STATEMODELID", "EquipmentState");

        	// 품목유형코드 콤보 정보 조회
        	var sSvcID 			= "getState";
        	var sController 	= "/pcm01700/getState.do";
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
        	...
        	switch(trId) {
        	    case "getState":
        			...
        			var sSvcID = "selectEquipmentByArea";
        			var sController = "/pcm01700/selectEquipmentByArea.do";
        ...
        this.fn_search = function ()
         ...
         this.getCheckedEquipmentIdUseStatus = function ()
        {
        	var result = "";
        ...
        this.loadIncludeScript("PCM01700T11.xfdl");
