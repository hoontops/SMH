(function()
{
    return function()
    {
        ...
        {
            this.set_name("PDA00800M");
            this.set_titletext("인계취소");
            ...
            obj = new Static("sta_title00_00","15","142","111","39",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("품목코드");
            ...
            obj = new Static("sta_title00_00_00","15","182","111","39",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("품목명");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            ...
            obj = new Static("sta_title00_00_00_00","15","222","111","39",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("공정명");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            ...
            obj = new Static("sta_title00_00_00_00_00","15","262","111","39",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("자원");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            ...
            obj = new Button("btn_save","265","468","122","56",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("취소처리");
            ...
            obj = new Button("btn_clear","121","468","122","56",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Static("sta_title00_00_00_00_00_01","15","303","111","39",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("수량");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            ...
            obj = new Edit("edt_PNLQTY","145","303","85","39",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_enable("false");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            this.addChild(obj.name, obj);

            obj = new Static("sta_01","238","303","49","39",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_text("PNL");
            obj.set_font("normal 15pt/normal \"Arial\"");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_PCSQTY",null,"303","85","39","90",null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_enable("false");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            this.addChild(obj.name, obj);

            obj = new Static("sta_01_00",null,"303","49","39","33",null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("PCS");
            obj.set_font("normal 15pt/normal \"Arial\"");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_title00_00_00_00_00_02","15","343","111","39",null,null,null,null,null,null,this);
            obj.set_taborder("32");
            obj.set_text("현 상태");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            ...
            obj = new Static("sta_title00_00_00_00_01","15","382","111","39",null,null,null,null,null,null,this);
            obj.set_taborder("30");
            obj.set_text("이전공정");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            ...
            obj = new Edit("edt_PREVPROCESSSEGMENTNAME","145","382",null,"39","30",null,null,null,null,null,this);
            obj.set_taborder("31");
            obj.set_enable("false");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            this.addChild(obj.name, obj);

            obj = new Static("sta_title00_00_00_00_00_03","15","422","111","39",null,null,null,null,null,null,this);
            obj.set_taborder("32");
            obj.set_text("이전자원");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            ...
            obj = new Edit("edt_PREVRESOURCENAME","145","422",null,"39","30",null,null,null,null,null,this);
            obj.set_taborder("33");
            obj.set_enable("false");
            obj.set_font("normal 700 15pt/normal \"Arial\"");
            obj.set_visible("false");
            ...
            obj = new Combo("cbo_WipProcessState","145","343",null,"37","30",null,null,null,null,null,this);
            obj.set_taborder("33");
            ...
            obj = new BindItem("item5","edt_PREVPROCESSSEGMENTNAME","value","ds_lotInfo","PREVPROCESSSEGMENTNAME");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","edt_PREVRESOURCENAME","value","ds_lotInfo","RESOURCENAME");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("PDA00600M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PDA00600M.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PDA00600M.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PDA00600M.xfdl","lib::lib_mtm.xjs");
        this.addIncludeScript("PDA00600M.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PDA00600M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 인계취소
         * 파일명 		: PDA00600M.xfdl
        ...
        this.fn_search = function (obj, e)
        {
           ...
           // this.ds_search.clearData();
        	...
        	this.ds_search.setColumn(sRow, "PROCESSSTATE", "WaitForReceive");
        	this.ds_search.setColumn(sRow, "PREVPROCESSSTATE", "WaitForSend");
        	this.ds_search.setColumn(sRow, "TRANSITTYPE", "TransitCancel");
        	this.ds_search.setColumn(sRow, "USERID" , nexacro.getApplication().gds_userInfo.getColumn(0,"gv_userAcnt"));


        	var sSvcID 			= "selectLotListForSendCancel";
        	var sController 	= "/pda00600/selectLotListForSendCancel.do";
        ...
        this.fn_save = function (obj, e)
        {
        	...
        	// -------------------------
        	var sSvcID 			= "savePcmSendCancelLot";
        	var sController 	= "/pcm02700/savePcmSendCancelLot.do";
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
        	...
        	switch(trId) {
        		case "selectLotListForSendCancel":
        ...
        this.loadIncludeScript("PDA00600M.xfdl");
