(function()
{
    return function()
    {
        ...
        {
            this.set_name("PDA00900M");
            this.set_titletext("완료취소");
        ...
        // User Script
        this.addIncludeScript("PDA00900M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PDA00900M.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PDA00900M.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PDA00900M.xfdl","lib::lib_mtm.xjs");
        this.addIncludeScript("PDA00900M.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PDA00900M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 작업완료취소
         * 파일명 		: PDA00900M.xfdl
        ...
        this.fn_search = function (obj, e)
        {
           ...
           // this.ds_search.clearData();
        	...
        	var sController 	= "/pda00600/selectLotListForWorkEndCancel.do";
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
        	...
        	switch(trId) {
        		case "selectLotListForWorkEndCancel":
        ...
        this.btn_msg_onclick = function(obj,e)
        {
        	if(this.ds_lotInfo.rowcount==0) return;
        	bMsgShow = true;
        	var left = nexacro.toNumber(obj.left) + 100;
        ...
        this.loadIncludeScript("PDA00900M.xfdl");
