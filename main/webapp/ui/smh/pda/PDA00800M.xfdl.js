(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("PDA00800M.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PDA00800M.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PDA00800M.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PDA00800M.xfdl","lib::lib_mtm.xjs");
        this.addIncludeScript("PDA00800M.xfdl","pcm::pcmCommon.xjs");
        this.registerScript("PDA00800M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 작업시작취소
         * 파일명 		: PDA00800M.xfdl
        ...
        this.loadIncludeScript("PDA00800M.xfdl");
