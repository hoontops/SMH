(function()
{
    return function()
    {
        ...
        {
            this.set_name("PDA00202P");
            this.set_titletext("자원정보 조회");
            if (Form == this.constructor)
            {
                this._setFormPosition(450,170);
            }
            ...
            obj = new Button("btn_confirm",null,null,"80","38","99","10",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("확인");
            obj.set_cssclass("btn_pop_yes");
            this.addChild(obj.name, obj);

            obj = new Button("btn_close",null,null,"80","38","13","10",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("취소");
            ...
            obj = new Div("div_title","0","20",null,"55","0",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("div_00");
            obj.set_cssclass("div_guide");
            this.addChild(obj.name, obj);

            obj = new Static("sta_title","10","0",null,null,"0","0",null,null,null,null,this.div_title.form);
            obj.set_taborder("0");
            ...
            obj = new Static("sta__resource","0","10","90","20",null,null,null,null,null,null,this.div_main.form);
            obj.set_taborder("0");
            obj.set_text("자원");
            ...
            obj = new Combo("cbo_resource","105","5","210","30",null,null,null,null,null,null,this.div_main.form);
            obj.set_taborder("1");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",450,170,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("PDA00202P.xfdl","lib::lib_bas.xjs");
        this.addIncludeScript("PDA00202P.xfdl","lib::lib_pcm.xjs");
        this.addIncludeScript("PDA00202P.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("PDA00202P.xfdl","lib::lib_mtm.xjs");
        this.registerScript("PDA00202P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 자원정보
         * 파일명 		: PCM01700P2.xfdl
        ...
        this.loadIncludeScript("PDA00202P.xfdl");
