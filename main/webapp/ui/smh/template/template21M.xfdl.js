(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("조회영역+Div url 연결");
            ...
            obj = new Static("Static01","0","47","202","34",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("검색조건");
            ...
            obj = new Div("div_work","300","47","958","700",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_url("template::template21D1.xfdl");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        {
            this._addPreloadList("fdl","template::template21D1.xfdl");
        };
        ...
        this.loadIncludeScript("template21M.xfdl");
