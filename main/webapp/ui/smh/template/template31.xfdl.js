(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("조회조건+그리드T+sub탭M+sun탭B");
            ...
            obj = new Tab("tab_00","0","36.43%",null,null,"0","233",null,null,null,null,this.div_work.form);
            obj.set_taborder("2");
            obj.set_tabindex("0");
            this.div_work.addChild(obj.name, obj);
            ...
            obj = new Grid("grd_01","0","34",null,"146","0",null,null,null,null,null,this.div_work.form.tab_00.Tabpage1.form);
            obj.set_taborder("0");
            ...
            obj = new Button("btn_grdUp00",null,"6","29","24","0",null,null,null,null,null,this.div_work.form.tab_00.Tabpage1.form);
            obj.set_taborder("2");
            obj.set_cssclass("btn_WF_grdExcelUp");
            obj.set_tooltiptext("엑셀업로드");
            this.div_work.form.tab_00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("btn_grdDown",null,"6","29","24","29",null,null,null,null,null,this.div_work.form.tab_00.Tabpage1.form);
            obj.set_taborder("3");
            obj.set_cssclass("btn_WF_grdExcelDown");
            obj.set_tooltiptext("엑셀다운로드");
            this.div_work.form.tab_00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("btn_grdCopy",null,"6","29","24","58",null,null,null,null,null,this.div_work.form.tab_00.Tabpage1.form);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_grdCopy");
            obj.set_tooltiptext("복사");
            this.div_work.form.tab_00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("btn_grdDel",null,"6","29","24","87",null,null,null,null,null,this.div_work.form.tab_00.Tabpage1.form);
            obj.set_taborder("5");
            obj.set_cssclass("btn_WF_grdDel");
            obj.set_tooltiptext("삭제");
            this.div_work.form.tab_00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("btn_grdAdd",null,"6","29","24","116",null,null,null,null,null,this.div_work.form.tab_00.Tabpage1.form);
            obj.set_taborder("6");
            ...
            obj = new Tab("tab_00_00","0","66.29%",null,null,"0","7",null,null,null,null,this.div_work.form);
            obj.set_taborder("3");
            obj.set_tabindex("0");
            this.div_work.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage1",this.div_work.form.tab_00_00);
            obj.set_text("대제자원");
            this.div_work.form.tab_00_00.addChild(obj.name, obj);

            obj = new Grid("grd_01","0","34",null,null,"0","0",null,null,null,null,this.div_work.form.tab_00_00.Tabpage1.form);
            obj.set_taborder("0");
            obj.set_autoenter("select");
            obj.set_binddataset("ds_grd02");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"85\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"판정등급\"/><Cell col=\"2\" text=\"조치등급\"/><Cell col=\"3\" text=\"NG조건\"/><Cell col=\"4\" text=\"수량/불량율 구분\"/><Cell col=\"5\" text=\"범위\" cssclass=\"cell_end\"/></Band><Band id=\"body\"><Cell text=\"bind:No\"/><Cell col=\"1\" text=\"bind:판정등급\"/><Cell col=\"2\" text=\"bind:조치등급\"/><Cell col=\"3\" text=\"bind:NG조건\"/><Cell col=\"4\" text=\"bind:수량불량율구분\"/><Cell col=\"5\" text=\"bind:범위\"/></Band></Format></Formats>");
            this.div_work.form.tab_00_00.Tabpage1.addChild(obj.name, obj);

            obj = new Static("title1_01","0","0","66","34",null,null,null,null,null,null,this.div_work.form.tab_00_00.Tabpage1.form);
            obj.set_taborder("1");
            obj.set_text("기본정보");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_usedecorate("true");
            ...
            obj = new Button("btn_grdUp00",null,null,"29","24","0","175",null,null,null,null,this.div_work.form.tab_00_00.Tabpage1.form);
            obj.set_taborder("2");
            obj.set_cssclass("btn_WF_grdExcelUp");
            obj.set_tooltiptext("엑셀업로드");
            this.div_work.form.tab_00_00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("btn_grdDown",null,null,"29","24","29","175",null,null,null,null,this.div_work.form.tab_00_00.Tabpage1.form);
            obj.set_taborder("3");
            obj.set_cssclass("btn_WF_grdExcelDown");
            obj.set_tooltiptext("엑셀다운로드");
            this.div_work.form.tab_00_00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("btn_grdCopy",null,null,"29","24","58","175",null,null,null,null,this.div_work.form.tab_00_00.Tabpage1.form);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_grdCopy");
            obj.set_tooltiptext("복사");
            this.div_work.form.tab_00_00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("btn_grdDel",null,null,"29","24","87","175",null,null,null,null,this.div_work.form.tab_00_00.Tabpage1.form);
            obj.set_taborder("5");
            obj.set_cssclass("btn_WF_grdDel");
            obj.set_tooltiptext("삭제");
            this.div_work.form.tab_00_00.Tabpage1.addChild(obj.name, obj);

            obj = new Button("btn_grdAdd",null,null,"29","24","116","175",null,null,null,null,this.div_work.form.tab_00_00.Tabpage1.form);
            obj.set_taborder("6");
            obj.set_cssclass("btn_WF_grdAdd");
            obj.set_tooltiptext("추가");
            this.div_work.form.tab_00_00.Tabpage1.addChild(obj.name, obj);

            obj = new Tabpage("Tabpage2",this.div_work.form.tab_00_00);
            obj.set_text("설비 지정");
            this.div_work.form.tab_00_00.addChild(obj.name, obj);

            obj = new Static("title1","0","0","139","34",null,null,null,null,null,null,this.div_work.form.tab_00_00.Tabpage2.form);
            obj.set_taborder("0");
            obj.set_text("검사이력 리스트 <fc v=\"#f31d24\">2</fc><fc v=\"#999999\">건</fc>");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_usedecorate("true");
            obj.set_fittocontents("width");
            this.div_work.form.tab_00_00.Tabpage2.addChild(obj.name, obj);

            obj = new Grid("grd_01","0","34",null,null,"0","0",null,null,null,null,this.div_work.form.tab_00_00.Tabpage2.form);
            obj.set_taborder("1");
            obj.set_autoenter("select");
            obj.set_binddataset("ds_grd04");
            obj.set_autofittype("col");
            ...
            obj = new Button("btn_grdDel",null,"6","29","24","58",null,null,null,null,null,this.div_work.form.tab_00_00.Tabpage2.form);
            obj.set_taborder("3");
            obj.set_cssclass("btn_WF_grdDel");
            obj.set_tooltiptext("삭제");
            this.div_work.form.tab_00_00.Tabpage2.addChild(obj.name, obj);

            obj = new Button("btn_grdAdd",null,"6","29","24","btn_grdDel:0",null,null,null,null,null,this.div_work.form.tab_00_00.Tabpage2.form);
            obj.set_taborder("2");
            obj.set_cssclass("btn_WF_grdAdd");
            obj.set_tooltiptext("추가");
            this.div_work.form.tab_00_00.Tabpage2.addChild(obj.name, obj);

            obj = new Button("btn_grdDown",null,"6","29","24","29",null,null,null,null,null,this.div_work.form.tab_00_00.Tabpage2.form);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_grdExcelDown");
            obj.set_tooltiptext("엑셀다운로드");
            this.div_work.form.tab_00_00.Tabpage2.addChild(obj.name, obj);

            obj = new Button("btn_grdUp00",null,"6","29","24","0",null,null,null,null,null,this.div_work.form.tab_00_00.Tabpage2.form);
            obj.set_taborder("5");
            obj.set_cssclass("btn_WF_grdExcelUp");
            obj.set_tooltiptext("엑셀업로드");
            this.div_work.form.tab_00_00.Tabpage2.addChild(obj.name, obj);

            obj = new Button("btn_grdUp00",null,"6","29","24","0",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_grdExcelUp");
            obj.set_tooltiptext("엑셀업로드");
            this.div_work.addChild(obj.name, obj);
            ...
            obj = new Button("btn_00_00",null,"16","100","24","btn_new:0",null,null,null,null,null,this.div_header.form);
            obj.set_taborder("11");
        ...
        this.loadIncludeScript("template31.xfdl");
