(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("template01_220111_bk.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: SM 상선 고도화
         * 업무명 		: 업무화면 이름...
         * 파일명 		: cmsa00300.xfdl
        ...
        this.divSrch_btn_search_onclick = function(obj,e)
        {
        trace('debug test');
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSrch.form.btn_search.addEventHandler("onclick",this.divSrch_btn_search_onclick,this);
            this.divSrch.form.cbo_period.addEventHandler("onitemchanged",this.tab_search_Tabpage1_cbo_period_onitemchanged,this);
        };
        this.loadIncludeScript("template01_220111_bk.xfdl");
