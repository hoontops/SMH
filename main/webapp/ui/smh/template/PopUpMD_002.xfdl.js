(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01","15","18","413","15",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("타이틀 명");
            obj.set_cssclass("sta_WF_popTitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static02","15","33","510","15",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("15");
            obj.set_visible("false");
            obj.set_background("lightseagreen");
            ...
            obj = new Static("Static05","15","46","197","20",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("소 타이틀");
            obj.set_cssclass("sta_WF_SubTitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static12","15","62","126","10",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("10");
            obj.set_visible("false");
            obj.set_background("lightseagreen");
            ...
            obj = new Static("Static06","15","176","510","10",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("10");
            obj.set_visible("false");
            obj.set_background("lightseagreen");
            ...
            obj = new Static("Static07","31","186","45","21",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("항목");
            ...
            obj = new Edit("Edit00","71","186","180","21",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_font("9pt \"Dotum\"");
            this.addChild(obj.name, obj);

            obj = new Static("Static08","15","207","510","10",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("10");
            obj.set_visible("false");
            obj.set_background("lightseagreen");
            ...
            obj = new GroupBox("GroupBox00","15","211","510","44",null,null,null,null,null,null,this);
            obj.set_text("텍스트");
            obj.set_taborder("14");
            obj.set_font("9pt \"Dotum\"");
            this.addChild(obj.name, obj);

            obj = new Radio("Radio00","37","229","269","18",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            ...
            obj = new Static("Static09","15","255","510","10",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("10");
            obj.set_visible("false");
            obj.set_background("lightseagreen");
            ...
            obj = new Tab("Tab00","14","265","511","101",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_tabindex("0");
            ...
            obj = new Static("Static11","15","402","510","12",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("12");
            obj.set_visible("false");
            obj.set_background("lightseagreen");
            ...
            obj = new Static("Static13","14","366","511","15",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("15");
            obj.set_visible("false");
            obj.set_background("lightseagreen");
            ...
            obj = new Div("Div00","15","72","510","104",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_cssclass("div_WF_SearchBg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static71","104","46","12","21",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_text("*");
            ...
            obj = new Static("Static64","99","46","211","21",null,null,null,null,null,null,this);
            obj.set_taborder("26");
            obj.set_text("(  필수 입력 항목)");
            obj.set_font("9pt \"Dotum\"");
            this.addChild(obj.name, obj);

            obj = new Button("Button18","369","381","58","21",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_text("저장");
            ...
            obj = new Button("Button79","430","381","52","21",null,null,null,null,null,null,this);
            obj.set_taborder("28");
            obj.set_text("초기화");
            obj.set_cssclass("btn_WF_basic");
            this.addChild(obj.name, obj);

            obj = new Button("Button78","485","381","40","21",null,null,null,null,null,null,this);
            obj.set_taborder("29");
            obj.set_text("취소");
            obj.set_cssclass("btn_WF_basic");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static73","90","44","10","22",null,null,null,null,null,null,this);
            obj.set_taborder("31");
            obj.set_text("10");
            obj.set_visible("false");
            obj.set_background("gold");
        ...
        this.loadIncludeScript("PopUpMD_002.xfdl");
