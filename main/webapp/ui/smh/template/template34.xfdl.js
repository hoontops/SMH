(function()
{
    return function()
    {
        ...
        {
            this.set_name("template34");
            this.set_titletext("조회조건+DetailT+그리드B");
            ...
            obj = new Button("btnDel",null,"72","26","24","29",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_grdDel");
            obj.set_tooltiptext("삭제");
            this.div_work.addChild(obj.name, obj);

            obj = new Button("btnAdd",null,"72","26","24","btnDel:0",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("3");
        ...
        this.loadIncludeScript("template34.xfdl");
