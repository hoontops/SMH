(function()
{
    return function()
    {
        ...
        {
            this.set_name("BAS04300D2");
            this.set_titletext("규격측정(계측값)");
            ...
            obj = new Static("sta_title1","0","66","117","34",null,null,null,null,null,null,this);
            obj.set_taborder("1");
        ...
        this.loadIncludeScript("template21D2.xfdl");
