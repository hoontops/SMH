(function()
{
    return function()  
	{
        ...
        this.on_initApplication = function()
        {
            ...
            // frame
            var mainframe = this.createMainFrame("mainframe","0","0","1278","890",null,null,this);
            mainframe.set_showtitlebar("true");
            mainframe.set_showstatusbar("false");
            mainframe.set_titletext("SM상선 my HR");
        ...
        this.mainframe_createBodyFrame = function()
        {
            ...
            var frame4 = new VFrameSet("VFrameSet0",null,null,null,null,null,null,frame2);
            frame4.set_separatesize("30,0,*");
            frame2.addChild(frame4.name, frame4);

            var frame5 = new ChildFrame("WorkTopFrame",null,null,null,null,null,null,"frame::frmMdi.xfdl",frame4);
            ...
            var frame6 = new ChildFrame("WorkFrame",null,null,null,null,null,null,"cmd::CMD10200M.xfdl",frame4);
            frame6.set_showtitlebar("false");
            frame4.addChild(frame6.name, frame6);
            frame6.set_formurl("cmd::CMD10200M.xfdl");


            var frame7 = new FrameSet("FrameSet0",null,null,null,null,null,null,frame4);
            frame4.addChild(frame7.name, frame7);

            var frame8 = new ChildFrame("commFrame",null,null,null,null,null,null,"frame::frmMain.xfdl",frame0);
            frame8.set_showcascadetitletext("true");
            frame8.set_showtitlebar("false");
            frame0.addChild(frame8.name, frame8);
            frame8.set_formurl("frame::frmMain.xfdl");


            var frame9 = new ChildFrame("commLogin",null,null,null,null,null,null,"frame::frmLogin.xfdl",frame0);
            frame9.set_showtitlebar("false");
            frame9.set_dragmovetype("none");
            frame0.addChild(frame9.name, frame9);
            frame9.set_formurl("frame::frmLogin.xfdl");


            var frame10 = new ChildFrame("bottomFrame",null,null,null,null,null,null,"frame::frmBottom.xfdl",frame0);
            frame10.set_showtitlebar("false");
            frame10.set_dragmovetype("none");
            frame0.addChild(frame10.name, frame10);
            frame10.set_formurl("frame::frmBottom.xfdl");
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.mainframe.VFrameSet.HFrameSet0.addEventHandler("onsize",this.mainframe_VFrameSet_HFrameSet0_onsize,this);
        };
        
        // script Compiler
        this.registerScript("App_Desktop.xadl", function() {
        this.gv_appBodyFrameSet = undefined; //VFrameSEt 프레임
        ...
        this.mainframe_VFrameSet_HFrameSet0_onsize = function(obj,e)
        {
