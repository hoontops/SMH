(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"APPRAISAL_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"APPRAISAL_YEAR\" type=\"STRING\" size=\"256\"/><Column id=\"APPRAISAL_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"HJSPFM_APPRAISAL_MASTER_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"ASSESSMENT_STATUS\" type=\"STRING\" size=\"256\"/><Column id=\"HJSPFM_PER_OBJECT_MASTER_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"PARTICIPANT_ID_1\" type=\"STRING\" size=\"256\"/><Column id=\"CONV_MGR_NOTICE2\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("APR20610M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	:
         * 업무명 		: 업적평가-1차평가
         * 파일명 		: APR20610M.xfdl
        ...
        *******************************************************************************/
        this.fn_initInfo = function ()
        {
        	...
        	this.ds_search.setColumn(0, "ASSESSMENT_STATUS", "100");
        }
        			...
        			case "selectCheckAppraisalPeriod" :
         			{
        				...
        				for(var i = 0; i < this.ds_appraisalPeriodResult.rowcount; i++)
        				{
        					...
        					this.ds_submit.setColumn(row, "ASSESSMENT_STATUS", "110");
        					this.ds_submit.setColumn(row, "APPRAISAL_STATUS", "110");
        ...
        *******************************************************************************/
        this.fn_submit = function ()
        {
        	...
        	for(var i = 0; i < this.ds_targetReviewList.rowcount; i++)
        	{
        		if(this.ds_targetReviewList.getColumn(i,"CHK")=="1")
        		{
        			...
        			this.ds_appraisalPeriod.setColumn(row, "CONV_MGR_NOTICE2", this.ds_targetReviewList.getColumn(i, "CONV_MGR_NOTICE2"));
        		}
        	}
        	...
        	for(var i = 0; i < this.ds_appraisalPeriod.rowcount; i++)
        	{
        		...
        		{
        			if(this.ds_appraisalPeriod.getColumn(i, "ASSESSMENT_STATUS") != "100")
        			{
        				//평가단계별 상태(ASSESSMENT_STATUS) 파트장 평가완료가 아닙니다..
        				this.gfn_Message("CheckPerformanceAprStatus1st", null, "info","ok");
        				return;
        			}
        		}

        		if(!this.nfn_isNull(this.ds_appraisalPeriod.getColumn(i, "PARTICIPANT_ID_1"))
        		&& this.nfn_isNull(this.ds_appraisalPeriod.getColumn(i, "CONV_MGR_NOTICE2")))
        		{
        			//1st Appraisal의 Overall Ration 등급을 입력하지 않았습니다.
        			this.gfn_Message("CheckPerformanceAprRating1st", null, "info","ok");
        			return;
        		}
        	}

        	//제출 후 1차평가자 평가 수정이 불가능합니다. 1차 평가를 완료하시겠습니까?
        	var bOK = this.gfn_Message("CheckPerformanceAprSubmit1st", null, "conf", "yesno");
        	if (bOK == false) return;
        ...
        this.div_work_grd_targetReviewList_oncellclick = function(obj,e)
        {
        	if(this.ds_targetReviewList.getRowCount() > 0 && e.cell != 0)
        	{
        		...
        		this.gfn_showPage('apr::APR20620M.xfdl', 'sendDetailData');
        ...
        this.loadIncludeScript("APR20610M.xfdl");
