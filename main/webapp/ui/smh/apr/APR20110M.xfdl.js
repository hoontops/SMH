(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"HJSPFM_APPRAISAL_MASTER_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"HJSPFM_PER_OBJECT_MASTER_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"ASSESSMENT_STATUS\" type=\"STRING\" size=\"256\"/><Column id=\"APPRAISAL_STATUS\" type=\"STRING\" size=\"256\"/><Column id=\"CORRECTION_CHECK\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_clear",null,"132","60","20","76",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("초기화");
        ...
        // User Script
        this.registerScript("APR20110M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	:
         * 업무명 		: 업적평가-목표리뷰(Part)
         * 파일명 		: APR20110M.xfdl
        ...
        *******************************************************************************/
        this.fn_initInfo = function ()
        {
        	...
        	this.ds_search.setColumn(0, "ASSESSMENT_STATUS", "030");
        }
        			...
        			case "selectCheckAppraisalPeriod" :
         			{
        				...
        				for(var i = 0; i < this.ds_appraisalPeriodResult.rowcount; i++)
        				{
        					...
        					this.ds_submit.setColumn(row, "ASSESSMENT_STATUS", "040");
        					this.ds_submit.setColumn(row, "APPRAISAL_STATUS", "040");
        ...
        *******************************************************************************/
        ...
        this.div_work_grd_qamQcinspectorhistory_oncellclick = function(obj,e)
        {
        	if(this.ds_targetReviewList.getRowCount() > 0 && e.cell != 0)
        	{
        		...
        		this.gfn_showPage('apr::APR20120M.xfdl', 'sendDetailData');
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_work.form.grd_targetReviewList.addEventHandler("oncellclick",this.div_work_grd_qamQcinspectorhistory_oncellclick,this);
