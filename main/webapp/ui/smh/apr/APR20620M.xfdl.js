(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("cbo_overallRating","129","83","124","20",null,null,null,null,null,null,this.div_work.form.div_subTitle00.form);
            obj.set_taborder("6");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"80\"/><Column size=\"180\"/><Column size=\"180\"/><Column size=\"40\"/><Column size=\"125\"/><Column size=\"125\"/><Column size=\"125\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"55\"/><Row size=\"55\"/><Row size=\"26\" band=\"summ\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"Type\" tooltiptext=\"Type\" displaytype=\"normal\"/><Cell col=\"1\" text=\"Objectives\" tooltiptext=\"Objectives\" displaytype=\"normal\"/><Cell col=\"2\" text=\"Detail Responsibilities\" tooltiptext=\"Detail Responsibilities\" displaytype=\"normal\"/><Cell col=\"3\" text=\"Target/Planned Completion (Date)\" tooltiptext=\"Target/Planned Completion (Date)\" displaytype=\"normal\"/><Cell col=\"4\" rowspan=\"2\" text=\"Weight&#13;&#10;(%)\" tooltiptext=\"Weight (%)\" displaytype=\"normal\"/><Cell col=\"5\" rowspan=\"2\" text=\"Self-Comments\" tooltiptext=\"Self-Comments\" displaytype=\"normal\"/><Cell col=\"6\" rowspan=\"2\" text=\"Part-Comments\"/><Cell col=\"7\" rowspan=\"2\" text=\"1st-Comments\" tooltiptext=\"1st-Comments\"/><Cell row=\"1\" col=\"1\" text=\"KPIs\" tooltiptext=\"KPIs\" displaytype=\"normal\"/><Cell row=\"1\" col=\"2\" text=\"Detail Accomplishments\" tooltiptext=\"Detail Accomplishments\" displaytype=\"normal\"/><Cell row=\"1\" col=\"3\" displaytype=\"normal\" text=\"Achieved/Actual Completion (Date)\" tooltiptext=\"Achieved/Actual Completion (Date)\"/></Band><Band id=\"body\"><Cell rowspan=\"2\" displaytype=\"combotext\" text=\"bind:EVALUATION_TYPE\" combocodecol=\"C,EvaluationType,,Y,N\"/><Cell col=\"1\" text=\"bind:OBJECTIVES\"/><Cell col=\"2\" text=\"bind:OBJECTIVE_DETAILS\" textAlign=\"left\" edittype=\"readonly\" displaytype=\"text\"/><Cell col=\"3\" text=\"bind:TARGET_STATUS_DATE\" textAlign=\"left\" edittype=\"readonly\" displaytype=\"text\"/><Cell col=\"4\" rowspan=\"2\" text=\"bind:WEIGHT\"/><Cell col=\"5\" rowspan=\"2\" text=\"bind:SELF_APPRAISAL_COMMENTS\" textAlign=\"left\" edittype=\"readonly\" displaytype=\"text\"/><Cell col=\"6\" rowspan=\"2\" text=\"bind:APPRAISAL_COMMENTS1\" textAlign=\"left\" edittype=\"readonly\" displaytype=\"text\"/><Cell col=\"7\" rowspan=\"2\" displaytype=\"textareacontrol\" edittype=\"textarea\" text=\"bind:APPRAISAL_COMMENTS2\" textareaacceptsenter=\"true\"/><Cell row=\"1\" col=\"1\" text=\"bind:KPI_NAME\"/><Cell row=\"1\" col=\"2\" text=\"bind:ACHIEVEMENTS_DETAILS\" textAlign=\"left\" edittype=\"readonly\" displaytype=\"text\"/><Cell row=\"1\" col=\"3\" text=\"bind:ACHIEVEMENT_STATUS_DATE\" textAlign=\"left\" edittype=\"readonly\" displaytype=\"text\"/></Band><Band id=\"summary\"><Cell colspan=\"4\" text=\"Sums\" tooltiptext=\"Sums\" textAlign=\"center\"/><Cell col=\"4\" displaytype=\"number\" expr=\"dataset.getSum(&quot;WEIGHT&quot;) \"/><Cell col=\"5\"/><Cell col=\"6\"/><Cell col=\"7\"/></Band></Format></Formats>");
            this.div_work.addChild(obj.name, obj);
            ...
            obj = new BindItem("item7","div_work.form.div_subTitle00.form.edt_00","value","ds_evaluationHeader","CONV_MGR_NOTICE1");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","div_work.form.div_subTitle00.form.txa_00","value","ds_evaluationHeader","PARTICIPANT_ACHITED_COMMENT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","div_work.form.div_subTitle00.form.cbo_overallRating","value","ds_evaluationHeader","CONV_MGR_SCORE2");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","div_work.form.div_subTitle00.form.txa_00_00","value","ds_evaluationHeader","APPRAISAL_1ST_ACHITED_COMMENT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("APR20620M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	:
         * 업무명 		: 업적평가-1차평가
         * 파일명 		: APR20620M.xfdl
        ...
        *******************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_work.form.div_subTitle00.form.cbo_overallRating.addEventHandler("onitemclick",this.div_work_div_subTitle00_cbo_overallRating_onitemclick,this);
