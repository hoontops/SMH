(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"150\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell/><Cell col=\"1\" text=\"Appraisal Period\" tooltiptext=\"Appraisal Period\"/><Cell col=\"2\" text=\"Department\" tooltiptext=\"Department\"/><Cell col=\"3\" text=\"Grade\" tooltiptext=\"Grade\"/><Cell col=\"4\" text=\"Job\" tooltiptext=\"Job\"/><Cell col=\"5\" text=\"Name\" tooltiptext=\"Name\"/><Cell col=\"6\" text=\"1st Appraiser\" tooltiptext=\"1st Appraiser\"/><Cell col=\"7\" text=\"2nd Appraiser\" tooltiptext=\"2nd Appraiser\"/><Cell col=\"8\" text=\"Status\" tooltiptext=\"Status\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:APPRAISAL_PERIOD\"/><Cell col=\"2\" text=\"bind:ORG_NAME\"/><Cell col=\"3\" text=\"bind:GRADE_NAME\"/><Cell col=\"4\" text=\"bind:JOB_NAME\"/><Cell col=\"5\" text=\"bind:APPRAISEE_NAME\"/><Cell col=\"6\" text=\"bind:APPRAISER_1ST_NAME\"/><Cell col=\"7\" text=\"bind:APPRAISER_2ND_NAME\"/><Cell col=\"8\" text=\"bind:ASSESSMENT_STATUS_DESC\"/></Band></Format></Formats>");
        ...
        // User Script
        this.registerScript("APR20210M.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	:
         * 업무명 		: 업적평가-파트장 평가
         * 파일명 		: APR20210M.xfdl
        ...
        *******************************************************************************/
        this.fn_initInfo = function ()
        {
        	...
        	this.ds_search.setColumn(0, "ASSESSMENT_STATUS", "090");
        }
        			...
        			case "selectCheckAppraisalPeriod" :
         			{
        				...
        				for(var i = 0; i < this.ds_appraisalPeriodResult.rowcount; i++)
        				{
        					...
        					this.ds_submit.setColumn(row, "APPRAISAL_STATUS", "100");
        ...
        *******************************************************************************/
        this.fn_submit = function ()
        {
        	...
        	for(var i = 0; i < this.ds_targetReviewList.rowcount; i++)
        	{
        		if(this.ds_targetReviewList.getColumn(i,"CHK")=="1")
        		{
        			...
        			this.ds_appraisalPeriod.setColumn(row, "CONV_MGR_NOTICE1", this.ds_targetReviewList.getColumn(i, "CONV_MGR_NOTICE1"));
        		}
        	}
        	...
        	{
        		if(this.ds_appraisalPeriod.getColumn(i, "ASSESSMENT_STATUS") != "090")
        		{
        			//평가 상태가 SELFAPP 가 아닙니다.
        			this.gfn_Message("CheckPerformanceAprStatusPar", null, "info","ok");
        			return;
        		}
        		if(!this.nfn_isNull(this.ds_appraisalPeriod.getColumn(i, "PARTICIPANT_ID_1"))
        		&& this.nfn_isNull(this.ds_appraisalPeriod.getColumn(i, "CONV_MGR_NOTICE1")))
        		{
        			//파트장의 Part Appraiser Overall Rating이 입력되지 않았습니다.
        			this.gfn_Message("CheckPerformanceAprRatingPar", null, "info","ok");
        			return;
        		}
        	}
        ...
        this.div_work_grd_targetReviewList_oncellclick = function(obj,e)
        {
        	if(this.ds_targetReviewList.getRowCount() > 0 && e.cell != 0)
        	{
        		...
        		this.gfn_showPage('apr::APR20220M.xfdl', 'sendDetailData');
        ...
        this.loadIncludeScript("APR20210M.xfdl");
