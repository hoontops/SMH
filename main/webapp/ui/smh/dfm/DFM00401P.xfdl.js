(function()
{
    return function()
    {
        ...
        {
            this.set_name("DFM00401P");
            this.set_titletext("Layer별 불량 현황 - 품목코드 Popup");
            this.set_cssclass("form_PopupBg");
            if (Form == this.constructor)
            {
                this._setFormPosition(650,490);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_prodIdList", this);
            obj._setContents("<ColumnInfo><Column id=\"P_PRODUCTDEFID\" type=\"STRING\" size=\"256\"/><Column id=\"P_PRODUCTDEFNAME\" type=\"STRING\" size=\"256\"/><Column id=\"P_PERIOD_PERIODFR\" type=\"STRING\" size=\"256\"/><Column id=\"P_PERIOD_PERIODTO\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Button("btn_search",null,null,"47","24","40","13",null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            ...
            obj = new Button("btn_reset_search",null,null,"24","24","10","13",null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            ...
            obj = new Static("sta_cnt_ds_prodIdList","sta_title:0","106","140","34",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            ...
            obj.set_binddataset("ds_prodIdList");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"150\"/><Column size=\"250\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"품목코드\"/><Cell col=\"2\" text=\"품목명\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:P_PRODUCTDEFID\" textAlign=\"left\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"2\" text=\"bind:P_PRODUCTDEFNAME\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("sta_popupTitle","3.08%","0","245","34",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("품목 리스트");
            obj.set_cssclass("sta_WF_subTitle");
            obj.set_usedecorate("true");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",650,490,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("DFM00401P.xfdl","lib::lib_tom.xjs");
        this.addIncludeScript("DFM00401P.xfdl","lib::lib_mtm.xjs");
        this.registerScript("DFM00401P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
        ...
        this.loadIncludeScript("DFM00401P.xfdl");
