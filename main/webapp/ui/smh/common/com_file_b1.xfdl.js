(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"345\"/><Column size=\"0\"/><Column size=\"1\"/><Column size=\"0\"/><Column size=\"0\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"NO\"/><Cell col=\"1\" text=\"파일명\"/><Cell col=\"2\" text=\"input Time\"/><Cell col=\"3\" text=\"파일크기(KB)\"/><Cell col=\"4\" text=\"저장경로\"/><Cell col=\"5\" text=\"저장파일명\"/></Band><Band id=\"body\"><Cell text=\"expr:rowidx + 1\"/><Cell col=\"1\" text=\"bind:OC_FILE_NM\"/><Cell col=\"2\" text=\"bind:inputTime\"/><Cell col=\"3\" text=\"expr:comp.parent.gfn_isNull(FILE_SIZE) ? &quot;&quot;:nexacro.round( (FILE_SIZE / 1024), 2 )+&quot; KB&quot;\" textAlign=\"right\"/><Cell col=\"4\" text=\"bind:SVR_SAVE_COURS\"/><Cell col=\"5\" text=\"bind:ATCH_FILE_GUID\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("st_FileSize",null,"6","72","24","375",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("0KB");
            ...
            obj = new Div("div_fup",null,"6","123","24","262",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_border("0px solid rgba(193,193,193,1)");
            this.addChild(obj.name, obj);

            obj = new FileUpload("fup_AttachedFile","36","0",null,"24","17",null,null,null,null,null,this.div_fup.form);
            obj.set_taborder("0");
            obj.set_itemcount("1");
        ...
        // User Script
        this.registerScript("com_file_b1.xfdl", function() {
        /***********************************************************************
        ...
        this.fn_delete = function (obj, e)
        {
        	...
        	var sOutDatasets = "";
        	var sArgs = "";
        	sArgs += this.gfn_setParam("JOB_SYS_CD", this.jobSysCd);
        ...
        this.fup_AttachedFile_onitemchanged = function (obj,e)
        {
        	...
        	if (nCnt > 0)
        	{
        		...
        		this.gfn_Message("InValidData007", "File Name", "error", "ok");	//저장할 데이터가 이미 존재합니다.({0})
        	...
        	if (!this.gfn_isNull(this.parent.fv_nFileCnt))
        	{
        		if (this.parent.fv_nFileCnt <= this.ds_file.rowcount)
        		{
        			...
        			this.gfn_Message("CannotUploadCnt", this.parent.fv_nFileCnt, "info", "ok");
        ...
        /*
        	...
        	var sFileName = sFilePath.substring(dirExpt);
        */
        ...
        */
        	...
        	{
        		var upUrl = this.fv_upUrl + "/comm/uploadFile/" + this.parent.parent.arg_jobSysCd + "/" + this.subDir + ".do";
        ...
        this.div_fup_fup_AttachedFile_onsuccess = function (obj,e)
        {
        	...
        	{
        		trace("업로드 실패");
        		this.parent.SUCC_YN = "N";
        	}
        	else
        	{
        		trace("업로드 성공");
        		this.parent.SUCC_YN = "Y";
        ...
        this.grd_list_oncelldblclick = function (obj, e)
        {
        	...
        	/*
        	 ...
        	 var dnUrl = this.fv_upUrl+"/comm/downFile/"+atchFileGuid+"/"+this.parent.parent.arg_jobSysCd+".do";
        ...
        this.btn_delete_onclick = function (obj, e)
        {
        	...
        	var rtVal = this.gfn_confirm("삭제 할까요?", "conf");
        	if (rtVal == false)
        	{
        		return;
        	}
        ...
        this.fn_addUploadFile = function (fupList, dsFile, args)
        {
        	...
        	// trace(fupList.value);
        	// for(var i=0; i < fupList.itemcount; i = i+1)
        	// {
        ...
        this.loadIncludeScript("com_file_b1.xfdl");
