(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_formTitle","10","6",null,"40","30",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("화면명");
            obj.set_cssclass("sta_POP_title");
            this.addChild(obj.name, obj);

            obj = new Div("div_form","10","56",null,null,"5","10",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_border("0px solid rgba(128,128,128,1)");
            obj.set_font("9pt \"Dotum\"");
            this.addChild(obj.name, obj);

            obj = new Button("btn_close",null,"0","35","35","1",null,null,null,null,null,this);
            obj.set_taborder("0");
