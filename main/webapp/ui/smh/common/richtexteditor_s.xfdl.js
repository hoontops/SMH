(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_color","16","736","397","194",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.getSetter("scrollbars").set("none");
            obj.set_visible("false");
            obj.set_url("common::richtexteditor_colorpicker_s.xfdl");
            obj.set_text("");
            obj.set_formscrolltype("none");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_preview","210","0","102","21",null,null,null,null,null,null,this.div_mode.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btn_dragResizeContent","307","531","87","12",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_text("btn_00");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","common::richtexteditor_colorpicker_s.xfdl");
        };
        
        // User Script
        this.addIncludeScript("richtexteditor_s.xfdl","lib::lib_base.xjs");
        this.addIncludeScript("richtexteditor_s.xfdl","lib::lib_array.xjs");
        this.addIncludeScript("richtexteditor_s.xfdl","lib::lib_color.xjs");
        this.registerScript("richtexteditor_s.xfdl", function() {
        ...
        var initConfig = {
        	editor : {
        		// editor.html 의 경로+ "/drens/RichTextEditor/editor.html"
        		url : nexacro.getEnvironment().services["svcurl"].url + "/smh/richtexteditor/editor.html",
        	...
        	image : {
        		...
        		uploadUrl : "/comm/uploadImg.do",

        		// 이미지 파일 삭제 url 로 host 를 제외한 경로 지정.
        		deleteUrl : "/comm/deleteImg.do",

        		// 본문에 추가될 url 로 host 를 제외한 경로 지정.
        		//src : "/upload/",
        		src : "/comm/downFIleFullSaveCours.do",
        ...
        ******************************************************************************/
        ...
        this.RichTextEditor_ontimer = function(obj, e)
        {
        	...
        	if (id == 1000)
        	{
        		if(this.gfn_isNull(this.parent.parent.parent.contents)) this.setTimer( 1000, 50000000000);
        		if(!this.gfn_isNull(this.parent.parent.parent.contents)){
        			this.setContent(this.parent.parent.parent.contents)
        			this.setTimer( 1000, 50000000000);
        		}
        	}
        	*/
        }
        ...
        ******************************************************************************/
        ...
        this.setContentHeight = function()
        {
        	...
        	if (initConfig.editor.allowResize)
        	{
        		...
        		stDragResizeContent.init(name, 0, 0, 0, 0, null, null);
        		caller.addChild(name, stDragResizeContent);
        		stDragResizeContent.set_background("red");
        		stDragResizeContent.set_opacity(0);	// ie 예외처리
        ...
        ******************************************************************************/
        ...
        this.fileUpTrans_onsuccess = function(obj,e)
        {
        	...
        	if ( ds )
        	{
        		...
        		var src = initConfig.image.host + initConfig.image.src + "?fullSaveCours="+saveFileName;
        ...
        ******************************************************************************/
        ...
        this.addImageThumbnail = function(fileName, saveFileName, fileSize)
        {
            ...
            imgSrc = "URL('"+initConfig.image.host + initConfig.image.src + "?fullSaveCours="+saveFileName+"')";
        	...
        	imgDiv.show();
        	imgDiv._src = initConfig.image.host + initConfig.image.src + "?fullSaveCours="+saveFileName;
        ...
        */
        ...
        this.fn_enable = function(bVal)
        {
        	this.set_enable(bVal);
        	var w = this.web_editor;

        	/* HTML body division 으로 수정불가 처리 */
        	if( !this.isValidObject("div_editor_cover") )
        	{
        		var objDiv = new Div();
        		objDiv.init("div_editor_cover", w.getOffsetLeft(), w.getOffsetTop(), w.getOffsetWidth()-20, w.getOffsetHeight(), null, null );
        		this.addChild("div_editor_cover", objDiv);
        		objDiv.show();
        	}

        	this.components["div_editor_cover"].set_visible(!bVal);

        }

        //content 높이 설정
        this.fn_setEditorContentHeight = function(nHeight)
        {
        	initConfig.editor.contentHeight = nHeight;
        }


        //thumbnail 안보이기
        this.fn_hiddenThumbnail = function()
        {
        	this.st_thumbnailInfo.set_height(0);
        	this.st_thumbnailInfo.style.set_border("0 solid transparent");
        	this.st_thumbnail.set_height(0);
        	this.st_thumbnail.style.set_border("0 solid transparent");
        	this.div_thumbnail.set_height(0);
        }
        this.div_mode_btn_preview_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_mode.form.btn_preview.addEventHandler("onclick",this.div_mode_btn_preview_onclick,this);
        ...
        this.loadIncludeScript("richtexteditor_s.xfdl");
