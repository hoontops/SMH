(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_fup",null,"6","184","24","205",null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new FileUpload("fup_AttachedFile","112","0",null,"24","1",null,null,null,null,null,this.div_fup.form);
            obj.set_taborder("0");
            obj.set_itemcount("1");
            ...
            obj = new Button("btn_fileDel",null,"6","70","24","118",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("파일삭제");
            ...
            obj = new Button("btn_upload03",null,"6","82","24","289",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("파일업로드");
            obj.set_cssclass("btn_WF_grdCom");
        ...
        // User Script
        this.registerScript("com_file_b4.xfdl", function() {
        /***********************************************************************
        ...
        this.fn_callBack = function (trId, errCD, errMsg)
        {
        	...
        	else
        	{
        		if (trId == "selectAtchFileList")
        		{
        			//this.fileChanged = "N";
        			if(this.sel=="Y"){
        				trace("count-->"+this.ds_file.rowcount);
        				this.parent.parent.parent.form.btn_close_onclick();
        			}
        		}
        ...
        this.fn_upload = function (sPath)
        {
        	...
        	*/
        	...
        	if (this.gfn_isNull(sPath))
        	{
        		this.gfn_alert("경로가 지정되지 않은 첨부파일은 업/다운로드 할 수 없습니다.");//msg.err.nofilepath
        		return  false;
        ...
        this.loadIncludeScript("com_file_b4.xfdl");
