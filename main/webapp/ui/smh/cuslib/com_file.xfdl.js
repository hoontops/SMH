(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grd_list","0","26",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Button("btn_fileDel",null,"0","69","21","0",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("파일삭제");
            obj.set_cssclass("btn_DR_GridMinus");
            this.addChild(obj.name, obj);

            obj = new Div("div_fup",null,"0","105","21","67",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_background("transparent");
            obj.set_border("0px none aquamarine");
            this.addChild(obj.name, obj);

            obj = new FileUpload("fup_AttachedFile","0",null,"99","21",null,"0",null,null,null,null,this.div_fup.form);
            obj.set_taborder("0");
            obj.set_itemcount("1");
            obj.set_index("0");
            this.div_fup.addChild(obj.name, obj);

            obj = new FileDownload("FileDownload00","1","1","100","24",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("FileDownload00");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("st_FileSize",null,"0","73","21","181",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("0KB");
            obj.set_visible("false");
            obj.set_background("transparent");
            ...
            obj = new Static("Static04",null,"21","170","5","0",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("5");
            obj.set_visible("false");
            ...
            obj = new Static("Static00",null,"21","129","5","61",null,null,null,null,null,this);
            obj.set_taborder("8");
        ...
        {
        	var file_excludes = [".do", ".jsp", ".class", ".js", ".asp", ".php", ".cgi", ".exe", ".sh", ".html", ".htm", ".dll", ".cmd", ".bat", ".jar", ".com"];
        ...
        this.div_fup_fup_AttachedFile_onsuccess = function (obj, e)
        {
        	...
        	this.parent.fn_callBack("completeFileUpload", e.errorcode, e.errormsg);
        };
        ...
        {
        	// if(this.parent.fv_nFileDn)
        	// {
        	/*
        	 var hlpIp = this.ds_file.getColumn(e.row, "ATCH_FILE_ID");
        	 var dnUrl = this.fv_upUrl+"/comm/dnFile/"+hlpIp +"/CMM" + ".do";
        	 */
