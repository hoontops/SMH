(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"chk\" type=\"STRING\" size=\"1\"/><Column id=\"code\" type=\"STRING\" size=\"256\"/><Column id=\"value\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj.set_taborder("1");
            obj.set_background("url(\'image::cmb_WF_Drop_N.png\') no-repeat center center");
            ...
            obj = new Button("btn_all_check","5","5","64","19",null,null,null,null,null,null,this.pdiv_data.form);
            obj.set_taborder("1");
            obj.set_text("전체선택");
            obj.set_cssclass("btn_WF_basic");
            this.pdiv_data.addChild(obj.name, obj);

            obj = new Button("btn_select_data",null,"5","40","19","5",null,null,null,null,null,this.pdiv_data.form);
            obj.set_taborder("2");
            obj.set_text("확인");
            obj.set_cssclass("btn_WF_basic");
            this.pdiv_data.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"20\"/><Column size=\"152\"/></Columns><Rows><Row size=\"21\"/></Rows><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:chk\" textAlign=\"center\" verticalAlign=\"middle\" padding=\"0px -10px 0px -10px\" border=\"1px none rgba(128,128,128,1)\"/><Cell col=\"1\" text=\"bind:value\" border=\"1px none rgba(128,128,128,1)\"/></Band></Format></Formats>");
            this.pdiv_data.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("com_multiCombo.xfdl", function() {
        /***************************************************************************************
         * 시스템명	 	: IFC MES시스템
         * 업무명 		: UI공통개발
        ...
        this.loadIncludeScript("com_multiCombo.xfdl");
