(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            obj.set_url("common::com_file_b1.xfdl");
        ...
        {
            this._addPreloadList("fdl","common::com_file_b1.xfdl");
        };
        
        // User Script
        this.registerScript("CMSA01200P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 파일 업로드 관리
         * 파일명 		: cmsa01200P.xfdl
        ...
        this.loadIncludeScript("CMSA01200P.xfdl");
