(function()
{
    return function()
    {
        ...
        {
            this.set_name("CMSA01300P");
            this.set_titletext("파일다운로드");
            this.set_cssclass("form_PopupBg");
            this.set_scrolltype("none");
            if (Form == this.constructor)
            {
                this._setFormPosition(450,291);
            }
            ...
            obj.set_taborder("0");
            obj.set_url("common::com_file_down_b1.xfdl");
            ...
            obj = new Button("btn_close00",null,"0","31","25","0",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",450,291,this,function(p){});
        ...
        {
            this._addPreloadList("fdl","common::com_file_down_b1.xfdl");
        };
        
        // User Script
        this.registerScript("CMSA01300P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: 대륜E&S 빌링시스템
         * 업무명 		: 파일 업로드 관리
         * 파일명 		: cmsa01200P.xfdl
        ...
        this.loadIncludeScript("CMSA01300P.xfdl");
