(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_title","1.67%","4",null,"31","47.50%",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("타이틀명");
            ...
            obj = new Div("div_search","7","51",null,"54","10",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Combo("cbo_srh","3","13","130","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            ...
            obj = new Edit("edt_srh","136","13","190","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("0");
            obj.set_font("9pt \"Dotum\"");
            ...
            obj = new Button("btn_search",null,"6","77","41","1",null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            obj.set_text("조회");
            ...
            obj = new Grid("grd_result","6","115",null,null,"10","75",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_binddataset("ds_result");
            obj.set_autoenter("select");
            obj.set_cellsizingtype("col");
            obj.set_cssclass("grd_sub");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"49\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"No\" font=\"normal 13px/normal &quot;Arial&quot;\"/></Band><Band id=\"body\"><Cell edittype=\"none\" text=\"expr:currow+1\" autosizecol=\"default\" textAlign=\"center\" font=\"normal 13px/normal &quot;Arial&quot;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn_x",null,null,"66","41","10","2",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("취소");
            ...
            obj = new Button("btn_sel",null,null,"66","41","81","2",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("확인");
            ...
            obj = new Static("Static08","2.50%","105",null,"10","4.67%",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("10");
            obj.set_visible("false");
            ...
            obj = new Static("Static16","149",null,"313","10",null,"65",null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("10");
            obj.set_visible("false");
            obj.set_background("lightseagreen");
            ...
            obj = new Static("Static18","149",null,"313","20",null,"45",null,null,null,null,this);
            obj.set_taborder("9");
            ...
            obj = new Static("Static17","149",null,"313","10",null,"35",null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("10");
            obj.set_visible("false");
            obj.set_background("lightseagreen");
            ...
            obj = new Div("div_page","17.50%",null,null,"20","0.83%","45",null,null,null,null,this);
            obj.set_taborder("11");
            ...
            obj = new Button("btn_close00",null,"0","45","35","0",null,null,null,null,null,this);
            obj.set_taborder("12");
        ...
        // User Script
        this.registerScript("CMSA00120P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 공통팝업
        ...
        var lv_height = 30;
        var lv_font = 'normal bold 12pt/normal "Arial"';
        // paging end
        /**************************************************************************
         * 3. FORM 정의
         ***************************************************************************/
        ...
        */
        ...
        this.fn_setLine = function ()
        {
        	...
        	for (var i = 0; i < this.ds_popupPls.rowcount; i++)
        	{
        		...
        		this.grd_result.setCellProperty('Head', nCol, "font", 'normal 700 13pt/normal "Arial"');
        		...
        		this.grd_result.setCellProperty('Body', nCol, "font", 'normal 700 13pt/normal "Arial"');
        ...
        this.fn_setSrhFixing = function ()
        {
        	...
        	{
        		cntObj++;
        		if(cntObj > 2 && cntObj % 2 == 1){
        			left = 3;
        			top = top + lv_height + 6;
        			this.div_search.set_height(nexacro.toNumber(this.div_search.height) +  lv_height + 6);
        			this.grd_result.set_top(nexacro.toNumber(this.grd_result.top) +  lv_height + 6);
        		}
        		if(this.ds_srhCndClum.getColumn(i,"SRH_CLUM_TY")=="COMBO"){
        			...
        			var objStatic = new Static(staId, left, top, this.nfn_getByteB(text)*asize+2, lv_height, null, null);
        			this.div_search.addChild(staId, objStatic);
        			objStatic.set_fittocontents("width");
        			objStatic.set_text(text);
        			objStatic.set_font(lv_font);

        			objStatic.show();
        			lv_divSearchWidth = lv_divSearchWidth + nexacro.toNumber(objStatic.width);

        			left = left +  nexacro.toNumber(objStatic.width) + 4;
        			var objCombo = new Combo("cbo_"+this.ds_srhCndClum.getColumn(i,"SRH_CLUM_ENG_NM"), left, top, 110, lv_height, null, null);
        			...
        			lv_divSearchWidth = lv_divSearchWidth + nexacro.toNumber(objStatic.width);
        			left = left +  nexacro.toNumber(objStatic.width) + 4;
        			var objEdit = new Edit("edt_"+this.ds_srhCndClum.getColumn(i,"SRH_CLUM_ENG_NM"), left, top, 110, lv_height, null, null);
        			this.div_search.addChild("edt_"+this.ds_srhCndClum.getColumn(i,"SRH_CLUM_ENG_NM"), objEdit);
        			objEdit.set_font(lv_font);
        			objEdit.show();
        			...
        			left = left +  nexacro.toNumber(objStatic.width) + 4;
        			var objCalendar = new Calendar("cal_"+this.ds_srhCndClum.getColumn(i,"SRH_CLUM_ENG_NM"), left, top, 110, lv_height, null, null);
        			this.div_search.addChild("cal_"+this.ds_srhCndClum.getColumn(i,"SRH_CLUM_ENG_NM"), objCalendar);
        			objCalendar.set_font(lv_font);
        			objCalendar.show();
        			...
        			if(this.gfn_isNull(text)) text = this.ds_srhCndClum.getColumn(i,"SRH_CLUM_KOREAN_NM");
        			var staId = "Static"+Math.random();
        			var objStatic = new Static(staId, left, top, this.nfn_getByteB(text)*6+2, lv_height, null, null);
        			this.div_search.addChild(staId, objStatic);
        			objStatic.set_fittocontents("width");
        			objStatic.set_text(text);
        			objStatic.set_font(lv_font);
        			...
        			lv_divSearchWidth = lv_divSearchWidth + nexacro.toNumber(objStatic.width);
        			left = left +  nexacro.toNumber(objStatic.width) + 4;
        			var objEdit = new Edit("edt_"+this.ds_srhCndClum.getColumn(i,"SRH_CLUM_ENG_NM"), left, top, 99, lv_height, null, null);
        			this.div_search.addChild("edt_"+this.ds_srhCndClum.getColumn(i,"SRH_CLUM_ENG_NM"), objEdit);
        			...
        			var objButton = new Button("btn_"+this.ds_srhCndClum.getColumn(i,"SRH_CLUM_ENG_NM"), left, top, 22, lv_height, null, null);
        			...
        			var objEdit = new Edit("edt_"+this.ds_srhCndClum.getColumn(i,"SRH_CLUM_ENG_NM")+"_nm", left, top, 110, lv_height, null, null);
        ...
        this.grd_result_oncelldblclick = function (obj, e)
        {
        	...
        	if (this.gfn_isNull(lv_rtnCols))
        	{
        		...
        		{
        			if(this.gfn_isNull(this.grd_result.getCellProperty("Body", i, "text"))) continue;
        ...
        ***************************************************************************/
        ...
        this.loadIncludeScript("CMSA00120P.xfdl");
