(function()
{
    return function()
    {
        ...
        {
            this.set_name("CMSA00130P");
            this.set_titletext("공통팝업 조회");
            ...
            obj = new Button("btn_x","45.33%",null,"56","21",null,"12",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("닫기");
        ...
        // User Script
        this.registerScript("CMSA00130P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 공통팝업
        ...
        ***************************************************************************/
        ...
        this.loadIncludeScript("CMSA00130P.xfdl");
