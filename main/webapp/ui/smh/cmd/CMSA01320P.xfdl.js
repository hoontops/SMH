(function()
{
    return function()
    {
        ...
        {
            this.set_name("CMSA01320P");
            this.set_titletext("파일 다운로드[K]");
            this.set_cssclass("form_PopupBg");
            this.set_scrolltype("none");
            if (Form == this.constructor)
            {
                this._setFormPosition(600,291);
            }
            ...
            obj.set_taborder("0");
            obj.set_url("common::com_file_down_b3.xfdl");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",600,291,this,function(p){});
        ...
        {
            this._addPreloadList("fdl","common::com_file_down_b3.xfdl");
        };
        
        // User Script
        this.registerScript("CMSA01320P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	    : 대륜E&S 빌링시스템
         * 업무명 		: 파일 다운로드
         * 파일명 		: cmsa01200P.xfdl
        ...
        this.loadIncludeScript("CMSA01320P.xfdl");
