(function()
{
    return function()
    {
        ...
        {
            this.set_name("CMBM02200M");
            this.set_titletext("배치관리 권한등록");
            this.getSetter("classname").set("CMSY01200M");
            ...
            obj._setContents("<ColumnInfo><Column id=\"JOB_AUTH_ID\" type=\"STRING\" size=\"256\"/><Column id=\"AUTH_NM\" type=\"STRING\" size=\"256\"/><Column id=\"PLATFORM_FLAG\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"PLANTID\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Dataset("ds_cmdBatchCtrlAuth", this);
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"PLATFORM_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"JOB_AUTH_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BUSINESS_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"BUSINESS_TYPE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BATCH_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BATCH_NM\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"CREATED_BY\" type=\"STRING\" size=\"256\"/><Column id=\"CREATION_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"LAST_UPDATED_BY\" type=\"STRING\" size=\"256\"/><Column id=\"LAST_UPDATE_DATE\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_authNm","94","12","214","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("0");
            ...
            obj = new Static("Static34","359","12","55","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("6");
            obj.set_text("사이트");
            obj.set_cssclass("sta_WF_Label");
            ...
            obj = new Combo("cbo_plantid","420","12","128","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("7");
            ...
            obj = new Grid("grd_cmdBatchCtrlAuth","220","96",null,null,"8","0",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_binddataset("ds_cmdBatchCtrlAuth");
            obj.getSetter("useinputpanel").set("false");
            obj.set_treeinitstatus("expand,all");
            obj.set_treeusecheckbox("false");
            obj.set_autofittype("col");
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"120\"/><Column size=\"260\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"업무구분\"/><Cell col=\"1\" rowspan=\"2\" text=\"프로그램\"/><Cell col=\"2\" rowspan=\"2\" text=\"프로그램명\"/><Cell col=\"3\" text=\"사용여부\"/><Cell row=\"1\" col=\"3\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" style=\"align:center;\"/></Band><Band id=\"body\"><Cell style=\"align:center;\" text=\"bind:BUSINESS_TYPE\" combocodecol=\"C,SystemWorkType,,Y,N\" displaytype=\"combotext\" textAlign=\"left\"/><Cell col=\"1\" style=\"align:center;\" text=\"bind:BATCH_CD\" textAlign=\"left\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:BATCH_NM\" textAlign=\"left\"/><Cell col=\"3\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" style=\"align:center;\" text=\"bind:USE_YN\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item5","div_search.edt_authNm","cssclass","ds_result","POPUP_CD");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("CMBM02200M.xfdl", function() {
        /***************************************************************************************
        * 시스템명 	    : ifc mes시스템
        * 업무명 		: 배치관리 권한등록
        * 파일명 		: CMBM02200M.xfdl
        ...
        ***************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.ds_cmdBatchCtrlAuth.addEventHandler("onvaluechanged",this.ds_cmdJobAuthMenuMpng_onvaluechanged,this);
        };
        this.loadIncludeScript("CMBM02200M.xfdl");
