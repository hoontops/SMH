(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_title","102","81","423","31",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Button("btn_update",null,null,"60","21","79","13",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("수정");
            ...
            obj = new Static("sta_comments","102","116","423","179",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_InputBg");
            obj.set_border("1px solid rgba(221,221,221,1), 1px solid rgba(204,204,204,1)");
            ...
            obj = new BindItem("item2","sta_title","text","ds_cmdNotice","TITLE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item0","sta_comments","text","ds_cmdNotice","COMMENTS");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("CMSY02402P.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 공지사항
         * 파일명 		: cmsy02400.xfdl
        ...
        this.on_initEvent = function()
        {
            ...
            this.sta_title.addEventHandler("onmousemove",this.fn_jobDivTooltip,this);
            this.btn_close.addEventHandler("onclick",this.btn_close_onclick,this);
            this.btn_update.addEventHandler("onclick",this.fn_save,this);
            this.sta_comments.addEventHandler("onmousemove",this.fn_msgTextToolTip,this);
        ...
        this.loadIncludeScript("CMSY02402P.xfdl");
