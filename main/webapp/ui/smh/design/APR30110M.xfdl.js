(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("Status \'1st Appraised\'일 경우 평가 가능합니다. (\'Appraisal Period\' Click)");
            this.div_01.addChild(obj.name, obj);
            ...
            obj = new Button("btn_clear1",null,"151","60","20","76",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("초기화");
            obj.set_tooltiptext("초기화");
            this.addChild(obj.name, obj);

            obj = new Div("div_work","0","242",null,null,"10","0",null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("div_00");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"180\"/><Column size=\"80\"/><Column size=\"200\"/><Column size=\"100\"/><Column size=\"200\"/></Columns><Rows><Row size=\"24\" band=\"head\"/></Rows><Band id=\"head\"><Cell/><Cell col=\"1\" text=\"Appraisal Period\" tooltiptext=\"Appraisal Period\"/><Cell col=\"2\" text=\"Department\" tooltiptext=\"Department\"/><Cell col=\"3\" text=\"Grade\" tooltiptext=\"Grade\"/><Cell col=\"4\" text=\"Job\" tooltiptext=\"Job\"/><Cell col=\"5\" text=\"Name\" tooltiptext=\"Name\"/><Cell col=\"6\" text=\"Status\" tooltiptext=\"Status\"/></Band></Format></Formats>");
            ...
            obj = new Div("div_search","0.00%","174",null,"67","10",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("Div00");
            ...
            obj.set_textAlign("right");
            obj.set_verticalAlign("middle");
            obj.set_text("Grade From");
            obj.set_tooltiptext("Grade From");
            obj.set_usedecorate("true");
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_textAlign("right");
            obj.set_verticalAlign("middle");
            obj.set_text("Grade To");
            obj.set_tooltiptext("Grade To");
            obj.set_usedecorate("true");
            this.div_search.addChild(obj.name, obj);

            obj = new Combo("cbo_messageclassid00","385","10","124","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("7");
            obj.set_codecolumn("C,MsgGroup,ALL,Y,Y");
            obj.set_font("9pt \"Dotum\"");
            obj.set_index("-1");
            ...
            obj = new Combo("cbo_messageclassid00_00","639","10","124","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("8");
            obj.set_codecolumn("C,MsgGroup,ALL,Y,Y");
            obj.set_font("9pt \"Dotum\"");
            obj.set_index("-1");
            ...
            obj = new Combo("cbo_messageclassid01","131","35","124","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("9");
            obj.set_codecolumn("C,MsgGroup,ALL,Y,Y");
            obj.set_font("9pt \"Dotum\"");
            obj.set_index("-1");
            ...
            obj = new Combo("cbo_messageclassid00_01","385","35","124","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("10");
            obj.set_codecolumn("C,MsgGroup,ALL,Y,Y");
            obj.set_font("9pt \"Dotum\"");
            obj.set_index("-1");
            ...
            obj = new Combo("cbo_messageclassid00_00_00","639","35","124","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("11");
            obj.set_codecolumn("C,MsgGroup,ALL,Y,Y");
            obj.set_font("9pt \"Dotum\"");
            obj.set_index("-1");
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_work.form.btn_submit.addEventHandler("onclick",this.div_search_btn_clear1_onclick,this);
            ...
            this.div_search.form.cbo_messageclassid00_01.addEventHandler("onitemchanged",this.Combo01_onitemchanged,this);
            this.div_search.form.cbo_messageclassid00_01.addEventHandler("onmousemove",this.fn_msgCdCboToolTip,this);
            this.div_search.form.cbo_messageclassid00_00_00.addEventHandler("onitemchanged",this.Combo01_onitemchanged,this);
            this.div_search.form.cbo_messageclassid00_00_00.addEventHandler("onmousemove",this.fn_msgCdCboToolTip,this);
        };
        this.loadIncludeScript("APR30110M.xfdl");
