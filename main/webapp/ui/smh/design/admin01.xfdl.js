(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"120\"/><Column size=\"300\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"100\"/></Columns><Rows><Row size=\"24\" band=\"head\"/></Rows><Band id=\"head\"><Cell displaytype=\"decoratetext\" text=\"&lt;fc v=&apos;red&apos;&gt;*&lt;/fc&gt;회사ID\" tooltiptext=\"회사ID\"/><Cell col=\"1\" displaytype=\"decoratetext\" text=\"&lt;fc v=&apos;red&apos;&gt;*&lt;/fc&gt;회사명\" tooltiptext=\"회사명\"/><Cell col=\"2\" text=\"주소\" tooltiptext=\"주소\"/><Cell col=\"3\" text=\"전화번호\" tooltiptext=\"전화번호\"/><Cell col=\"4\" text=\"팩스번호\" tooltiptext=\"팩스번호\"/><Cell col=\"5\" text=\"&lt;fc v=&apos;red&apos;&gt;*&lt;/fc&gt;유효상태\" tooltiptext=\"유효상태\" displaytype=\"decoratetext\"/></Band></Format></Formats>");
            this.div_work.addChild(obj.name, obj);
        ...
        this.loadIncludeScript("admin01.xfdl");
