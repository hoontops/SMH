(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("cbo_00_00","315","10","110","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("7");
            obj.set_index("-1");
            this.div_search.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"120\"/><Column size=\"250\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"160\"/><Column size=\"98\"/></Columns><Rows><Row size=\"24\" band=\"head\"/></Rows><Band id=\"head\"><Cell displaytype=\"decoratetext\" text=\"&lt;fc v=&apos;red&apos;&gt;*&lt;/fc&gt;사이트ID\" tooltiptext=\"사이트ID\"/><Cell col=\"1\" displaytype=\"decoratetext\" text=\"&lt;fc v=&apos;red&apos;&gt;*&lt;/fc&gt;사이트명(KO)\" tooltiptext=\"사이트명(KO)\"/><Cell col=\"2\" text=\"&lt;fc v=&apos;red&apos;&gt;*&lt;/fc&gt;사이트명(EN)\" tooltiptext=\"사이트명(EN)\" displaytype=\"decoratetext\"/><Cell col=\"3\" text=\"&lt;fc v=&apos;red&apos;&gt;*&lt;/fc&gt;회사\" displaytype=\"decoratetext\" tooltiptext=\"회사\"/><Cell col=\"4\" text=\"언어\" tooltiptext=\"언어\"/><Cell col=\"5\" text=\"비고\" tooltiptext=\"비고\"/><Cell col=\"6\" text=\"&lt;fc v=&apos;red&apos;&gt;*&lt;/fc&gt;유효상태\" tooltiptext=\"유효상태\" displaytype=\"decoratetext\"/></Band></Format></Formats>");
            this.div_work.addChild(obj.name, obj);
            ...
            obj = new Button("btn_00",null,"7","60","20","198",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("5");
            obj.set_text("행추가");
            obj.set_tooltiptext("행추가");
            this.div_work.addChild(obj.name, obj);

            obj = new Button("btn_01",null,"7","60","20","132",null,null,null,null,null,this.div_work.form);
            obj.set_taborder("6");
            obj.set_text("행삭제");
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_work.form.btn_00.addEventHandler("onclick",this.div_search_btn_clear1_onclick,this);
            this.div_work.form.btn_01.addEventHandler("onclick",this.fn_save,this);
        };
        this.loadIncludeScript("admin02.xfdl");
