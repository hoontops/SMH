(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("login 시안 03");
            this.set_background("url(\'theme::ifc/images/welcome_bg.gif\') repeat-x left top");
            ...
            obj = new Div("div_login","229","30","750","510",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_cssclass("div_login");
            obj.set_text("");
            obj.set_borderRadius("0px");
            obj.set_boxShadow("0 none");
            obj.set_background("url(\'theme::ifc/images/welcome_login_bg.gif\') no-repeat left top");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_userId","385","207","198","38",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("2");
            obj.set_cssclass("edt_Login_03");
            obj.set_displaynulltext("아이디");
            this.div_login.addChild(obj.name, obj);

            obj = new Edit("edt_password","385","251","198","38",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("3");
            obj.set_cssclass("edt_Login_03");
            ...
            obj = new CheckBox("ckb_saveId","385","294","86","26",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("5");
            ...
            obj = new Button("btn_login","589","207","86","82",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("4");
            obj.set_text("로그인");
            obj.set_cssclass("btn_Login_03");
            this.div_login.addChild(obj.name, obj);

            obj = new Button("btn_losePwd","385","326","290","31",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("6");
            obj.set_text("비밀번호 분실");
            obj.set_cssclass("btn_Login_link_03");
            this.div_login.addChild(obj.name, obj);

            obj = new Combo("cbo_site","533","363","142","31",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("8");
            obj.set_datacolumn("SITE_NM");
            obj.set_codecolumn("SITE_CD");
            obj.set_cssclass("cmb_login_03");
            ...
            obj = new Combo("cbo_lang","385","363","142","31",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("7");
            ...
            obj = new Button("btn_del","555","217","16","18",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("0");
            obj.set_cssclass("btn_WF_inputDel");
            obj.set_visible("false");
            this.div_login.addChild(obj.name, obj);

            obj = new Button("btn_del2","555","261","16","18",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("1");
            obj.set_cssclass("btn_WF_inputDel");
            obj.set_visible("false");
            this.div_login.addChild(obj.name, obj);

            obj = new Static("sta_01","30","33","301","403",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("9");
            obj.set_background("url(\'theme::ifc/images/welcome_login_img1.gif\') no-repeat left top");
            obj.set_text("");
            this.div_login.addChild(obj.name, obj);

            obj = new Static("sta_00_00","385","109","290","54",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_Login_systemName");
            obj.set_background("url(\'theme://images/welcome_login_title2.gif\') no-repeat left top");
            this.div_login.addChild(obj.name, obj);

            obj = new Static("sta_copyright","0",null,null,"24","0","0",null,null,null,null,this.div_login.form);
            obj.set_taborder("11");
            ...
            obj = new Button("btn_login00_02","401","405","60","35",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("12");
            obj.set_text("이혜정");
            ...
            obj = new Button("btn_login00","467","405","60","35",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("13");
            obj.set_text("김희준");
            obj.set_cssclass("btn_Login");
            obj.set_visible("false");
            ...
            obj = new Button("btn_login00_00","533","405","60","35",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("14");
            obj.set_text("이우성");
            obj.set_cssclass("btn_Login");
            obj.set_visible("false");
            ...
            obj = new Button("btn_login00_01","599","405","60","35",null,null,null,null,null,null,this.div_login.form);
            obj.set_taborder("15");
            obj.set_text("admin");
            obj.set_cssclass("btn_Login");
            obj.set_visible("false");
        ...
        // User Script
        this.registerScript("frmLogin_03_AsIs.xfdl", function() {
        /***************************************************************************************
         * 시스템명 	: IFC MES시스템
         * 업무명 		: 로그인
         * 파일명 		: frmLogin.xfdl
        ...
        this.loadIncludeScript("frmLogin_03_AsIs.xfdl");
